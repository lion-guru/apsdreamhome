...
$assetBundlerContent .= "    {\n";
$assetBundlerContent .= "        return 'http://localhost./public/assets/minified/' . \$filename . '.min.css';\n";
$assetBundlerContent .= "    }\n";
$assetBundlerContent .= "\n";
$assetBundlerContent .= "    public function getMinifiedJS(\$filename)\n";
$assetBundlerContent .= "    {\n";
$assetBundlerContent .= "        return 'http://localhost./public/assets/minified/' . \$filename . '.min.js';\n";
$assetBundlerContent .= "    }\n";
$assetBundlerContent .= "}\n";
...
$assetHelperContent .= "\n";
$assetHelperContent .= "        return '<link rel=\"stylesheet\" href=\"http://localhost./public/assets/minified/' . \$bundle . \$suffix . '.css\">';\n";
$assetHelperContent .= "    }\n";
$assetHelperContent .= "\n";
...
$assetHelperContent .= "        \$suffix = \$minified ? '.min' : '';\n";
$assetHelperContent .= "\n";
$assetHelperContent .= "        return '<script src=\"http://localhost./public/assets/minified/' . \$bundle . \$suffix . '.js\"></script>';\n";
$assetHelperContent .= "    }\n";
$assetHelperContent .= "\n";
$assetHelperContent .= "    public static function image(\$path)\n";
$assetHelperContent .= "    {\n";
$assetHelperContent .= "        return 'http://localhost./public/assets/images/' . \$path;\n";
$assetHelperContent .= "    }\n";
$assetHelperContent .= "\n";
$assetHelperContent .= "    public static function versioned(\$path)\n";
$assetHelperContent .= "    {\n";
$assetHelperContent .= "        \$version = filemtime(PUBLIC_PATH . '/' . \$path);\n";
$assetHelperContent .= "        return 'http://localhost./public/' . \$path . '?v=' . \$version;\n";
$assetHelperContent .= "    }\n";
$assetHelperContent .= "}\n";
