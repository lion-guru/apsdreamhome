...
foreach ($templates as $name => $template) {
    ...
    if (!empty($template['header'])) {
        echo "<p><strong>Header:</strong> " . htmlspecialchars($template['header']) . "</p>";
    }
    echo "<p><strong>Body:</strong> " . htmlspecialchars(substr($template['body'], 0, 100)) . "...</p>";
    if (!empty($template['footer'])) {
        echo "<p><strong>Footer:</strong> " . htmlspecialchars($template['footer']) . "</p>";
    }
