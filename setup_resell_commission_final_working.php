...
try {
    ...
    // Sample resell properties - simplified
    ...
    // Sample property 2
    $stmt->execute([
        2, 2, 2, 'Priya Singh', 'priya@example.com', '+91-9876543220', '456 Park Road, Deoria',
        'Commercial Space in Braj Radha Nagri', 'Prime commercial space near Budhya Mata Mandir in Braj Radha Nagri. Perfect for office or retail business.',
        'commercial', 1500.00, 139.35, 0, 2, 4, 3, 'excellent',
        '456 Park Road, Braj Radha Nagri, Deoria', 'Braj Radha Nagri', 'Deoria', 'Uttar Pradesh', 26.6404, 83.5906,
        4500000.00, 5200000.00, 1, '3-7% negotiation possible',
        '24/7 Security, Parking, Power Backup, Water Supply', 'Main Road Frontage, Corner Plot, High Visibility', 'unfurnished',
        'freehold', 'immediate', 'title_deed, possession_certificate, commercial_license',
        'resell_2_1.jpg, resell_2_2.jpg', '', '', '',
        'sale', 'active', 0, 1, '2024-04-05', '2024-08-05',
        'fixed', 0.00, 100000.00, 0, 'pending',
        NULL, NULL, NULL, NULL, NULL, 1, NULL
    ]);
    
    echo "✅ 2 resell properties inserted\n";
    
    // Sample commission rules - simplified
    ...
    // Rule 2
    $stmt->execute([
        'Premium Property Commission', 'tiered', 10000001, 50000000, 'residential,commercial', 'prime_locations',
        0.00, 0.00, 'tier1: 10000001-20000000@1.5%, tier2: 20000001-35000000@1.25%, tier3: 35000001-50000000@1.0%', 'luxury_bonus: 0.25%',
        1, 2, '2024-01-01', NULL,
        18.00, 'gst: 18%, tds: 1%', 'Tiered commission for premium properties', 1, NULL
    ]);
    
    // Rule 3
    $stmt->execute([
        'Fixed Commercial Commission', 'fixed', 0, 0, 'commercial', 'all_locations',
        0.00, 50000.00, '', 'quick_sale_bonus: 10000',
        1, 3, '2024-01-01', NULL,
        18.00, 'gst: 18%', 'Fixed commission for all commercial properties', 1, NULL
    ]);
    
    echo "✅ 3 commission rules inserted\n";
