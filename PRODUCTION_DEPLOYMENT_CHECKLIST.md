...
0 * * * * /usr/bin/php /var/www/apsdreamhomefinal/scripts/production-alerts.php
```
...
php /var/www/apsdreamhomefinal/scripts/deploy-security.php

# Start monitoring
php /var/www/apsdreamhomefinal/scripts/security-monitor.php
