<?php
/**
 * APS Dream Home - Simple Database Reset
 * Drops and recreates database with proper structure
 */
...
<html>
<head>
    <title>Database Reset - APS Dream Home</title>
    <style>
...
<body>
    <div class='container'>
        <h1>🔄 APS Dream Home - Database Reset</h1>";
...
try {
    ...
    if ($conn->query($sql) === TRUE) {
        echo "<div class='success'>✅ Old database dropped successfully</div>";
    }
    ...
    echo "<div class='success'><h3>🎉 Database reset completed successfully!</h3>";
    ...
    echo "<div class='error'><h3>❌ Database Reset Failed</h3>";
