...
class MLIntegration {
    ...
    private function trainModelLocally(
        ...
        $this->asyncTaskManager->createTask(
            'Train Local Model: ' . $modelName,
            'ml_training_local',
            ['model' => $modelName, 'data' => $trainingData],
    ...
    private function trainModelDistributed(
        ...
        $this->asyncTaskManager->createTask(
            'Train Distributed Model: ' . $modelName,
            'ml_training_distributed',
            ['model' => $modelName, 'data' => $trainingData],
            AsyncTaskManager::PRIORITY_NORMAL
        );
    }
    ...
    private function simulateClassificationPrediction(array $inputData) {
        ...
        return $classes[\App\Helpers\SecurityHelper::secureArrayRand($classes)];
    }
