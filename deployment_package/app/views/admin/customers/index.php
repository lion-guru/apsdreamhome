                                            ...
                                            <td class="text-end">
                                                <div class="dropdown dropdown-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        <a class="dropdown-item" href="#" onclick="deleteCustomer(<?php echo h($customer['id']); ?>, '<?php echo h(addslashes($customer['name'])); ?>')"><i class="fas fa-trash me-2"></i> <?php echo h($mlSupport->translate('Delete')); ?></a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
