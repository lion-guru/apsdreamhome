        ...
        <div class="header-content">
            ...
            <div class="team-stats">
                <div class="stat-badge">
                    <i class="bi bi-trophy me-1"></i>{{ $teamInfo['team_rank'] }}
                </div>
                <div class="stat-badge">
                    <i class="bi bi-people me-1"></i>{{ $teamInfo['total_members'] }} members
                </div>
            </div>
        </div>
    </header>
    ...
    <main class="dashboard-content">
        ...
        <div class="overview-grid">
            ...
            <div class="overview-card members">
                ...
                <div class="overview-value">{{ number_format($teamInfo['total_members']) }}</div>
                <div class="overview-label">Total Team Members</div>
                <div class="overview-change positive">
                    <i class="bi bi-person-check"></i> {{ $teamInfo['active_members'] }} active
                </div>
            </div>
            ...
            <div class="overview-card performance">
                ...
                <div class="overview-value">{{ $teamInfo['avg_performance'] }}%</div>
            ...
            <div class="overview-card earnings">
                ...
                <div class="overview-value">₹{{ number_format($teamInfo['total_earnings'], 0) }}</div>
                <div class="overview-label">Team Earnings</div>
                <div class="overview-change positive">
                    <i class="bi bi-plus-circle"></i> From {{ $teamInfo['total_members'] }} members
                </div>
            </div>
            ...
            <div class="overview-card">
                ...
                <div class="overview-value">{{ $teamInfo['team_levels'] }}</div>
                <div class="overview-label">Network Levels</div>
                <div class="overview-change positive">
                    <i class="bi bi-chevron-double-up"></i> {{ $teamInfo['direct_reports'] }} direct reports
                </div>
            </div>
        </div>
        ...
        <div class="charts-grid">
            ...
            <div class="chart-card">
                <div class="chart-header">
                    ...
                    <span class="badge bg-primary">{{ count($performanceData['top_performers']) }} members</span>
                </div>
                <div class="mt-3">
                    @if(count($performanceData['top_performers']) > 0)
                        @foreach(array_slice($performanceData['top_performers'], 0, 5) as $performer)
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <div>
                                <div class="fw-bold small">{{ $performer['name'] }}</div>
                                <div class="text-muted small">Level {{ $performer['level'] }}</div>
                            </div>
                            <div class="text-end">
                                <div class="fw-bold text-success">₹{{ number_format($performer['earnings'], 0) }}</div>
                            </div>
                        </div>
                        @endforeach
                    @else
        ...
        <div class="actions-section">
            ...
            <div class="action-buttons">
                <a href="{{ route('team.members') }}" class="action-btn primary">
                ...
                <a href="{{ route('team.performance') }}" class="action-btn success">
                    <div class="action-icon">
                        <i class="bi bi-graph-up"></i>
                    </div>
                    <div class="action-content">
                ...
                <a href="{{ route('team.communication') }}" class="action-btn info">
                    <div class="action-icon">
                ...
                <a href="{{ route('team.export') }}" class="action-btn primary">
                    <div class="action-icon">
        ...
        <div class="incentives-section">
            ...
            @foreach($teamIncentives as $incentive)
            <div class="incentive-item {{ $incentive['status'] }}">
                <div class="incentive-header">
                    <div class="incentive-title">{{ $incentive['title'] }}</div>
                    <div class="incentive-amount">₹{{ number_format($incentive['amount'], 0) }}</div>
                </div>
