<?php
/**
 * Footer partial for modern MVC system
 */
?>
    ...
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="<?= BASE_URL ?>properties" class="text-gray-400 hover:text-white transition">Properties</a></li>
                    <li><a href="<?= BASE_URL ?>projects" class="text-gray-400 hover:text-white transition">Our Projects</a></li>
                    <li><a href="<?= BASE_URL ?>news" class="text-gray-400 hover:text-white transition">Blog & News</a></li>
                    <li><a href="<?= BASE_URL ?>about" class="text-gray-400 hover:text-white transition">About Us</a></li>
            ...
            <div>
                ...
                <form class="flex" action="<?= BASE_URL ?>newsletter/signup" method="POST">
                    <input type="hidden" name="csrf_token" value="<?= h($_SESSION['csrf_token'] ?? '') ?>">
                    <input type="email" name="email" placeholder="Your email" class="px-4 py-2 w-full rounded-l-md focus:outline-none text-gray-900" required>
        ...
        <div class="border-t border-gray-800 pt-6 mt-8">
            <div class="flex flex-col md:flex-row justify-between items-center">
                ...
                <div class="flex space-x-6 mt-4 md:mt-0">
                    <a href="<?= BASE_URL ?>privacy-policy" class="text-gray-400 hover:text-white text-sm">Privacy Policy</a>
                    <a href="<?= BASE_URL ?>legal" class="text-gray-400 hover:text-white text-sm">Legal Services</a>
                    <a href="<?= BASE_URL ?>sitemap" class="text-gray-400 hover:text-white text-sm">Sitemap</a>
                </div>
            </div>
        </div>
    </div>
