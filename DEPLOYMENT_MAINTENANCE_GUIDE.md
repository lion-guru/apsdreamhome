...
- **Database:** MySQL
- **Website URL:** `http://localhost/apsdreamhomefinal/`
- **Admin Panel:** `http://localhost/apsdreamhomefinal/admin_panel.php`
...
2. Select 'apsdreamhomefinal' database
3. Click 'Export' tab
...
define('SITE_URL', 'https://yourdomain.com/apsdreamhomefinal/');
```
