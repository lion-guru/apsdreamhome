...
<head>
    ...
    <!-- Fontfaces CSS-->
    <link rel="stylesheet" href="<?php echo get_asset_url('css/font-face.css', 'css'); ?>" rel="stylesheet" media="all">
    ...
    <link rel="stylesheet" href="<?php echo get_asset_url('css/theme.css', 'css'); ?>" rel="stylesheet" media="all">
                            ...
                            <div class="header-button">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            <img src="assets/<?php echo get_asset_url('icon/avatar-01.jpg', 'images'); ?>" alt="John Doe" />
                                        </div>
                                        <div class="content">
