...
if ($check_stmt->get_result()->num_rows > 0) {
    ...
    // Let's count the parameters: full_name, mobile, email, referral_code, sponsor_id, password
    // That's 6 parameters, so we need ssssis
    ...
    $stmt->bind_param("ssssis", $full_name, $mobile, $email, $referral_code, $sponsor_id, $hashed_password);
