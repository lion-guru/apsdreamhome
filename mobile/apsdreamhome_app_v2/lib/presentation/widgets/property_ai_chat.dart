...
class _PropertyAIChatState extends ConsumerState<PropertyAIChat> {
  ...
  void initState() {
    ...
    _messages.add({
      'role': 'assistant',
      'text':
          'Hello! I am your AI assistant for ${widget.propertyName}. Looking to buy or visit this property? I can help you with details, pricing, and booking a visit!'
    });
  }
      ...
      child: Row(
        children: [
          ...
          const Column(
            ...
            children: [
              Text('Smart Property Sales AI',
                  style: TextStyle(
                      color: Colors.white, fontWeight: FontWeight.bold)),
              Text('Powered by APS Dream Home',
    ...
    return Align(
      ...
      child: Container(
        ...
        child: Text(
          text,
          style: TextStyle(
              color: isMe ? Colors.white : Colors.white, fontSize: 14),
        ),
      ),
    );
  }
