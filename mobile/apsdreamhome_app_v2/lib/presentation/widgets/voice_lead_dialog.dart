...
class VoiceLeadDialog extends StatefulWidget {
  const VoiceLeadDialog({super.key});

  @override
  _VoiceLeadDialogState createState() => _VoiceLeadDialogState(); // ignore: library_private_types_in_public_api
}
            ...
            Container(
              ...
              child: Text(
                ...
                style: TextStyle(
                  ...
                  fontStyle: _text.startsWith('Tap')
                      ? FontStyle.italic
                      : FontStyle.normal,
                ),
              ),
