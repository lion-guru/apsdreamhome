...
class PayoutRequestDialog extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<PayoutRequestDialog> createState() =>
      _PayoutRequestDialogState();
}
  ...
  Future<void> _submitRequest() async {
    ...
    if (amount <= 0 || amount > widget.maxAmount) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
            content: Text('Invalid amount. Max allowed: ₹${widget.maxAmount}')),
      );
      return;
    }
