            ...
            if (incentives.isEmpty) {
              return const Center(
                child: EmptyStateWidget(
                  ...
                  subtitle:
                      'Reach your monthly rank targets to earn extra rewards!',
                ),
              );
            }
            ...
            return SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ...incentives.map(
                      (incentive) => _buildIncentiveCard(context, incentive)),
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              _buildMetric(
                  'Target', '₹${_formatLargeNumber(incentive.targetBusiness)}'),
              _buildMetric('Achieved',
                  '₹${_formatLargeNumber(incentive.achievedBusiness)}'),
            ],
          ),
          const SizedBox(height: 20),
  ...
  Widget _buildIncentiveCard(BuildContext context, Incentive incentive) {
    return Card(
      ...
      child: ListTile(
        ...
        subtitle:
            Text('Target: ₹${_formatLargeNumber(incentive.targetBusiness)}'),
        trailing: Column(
