...
class _InboxPageState extends ConsumerState<InboxPage> {
  ...
  Future<void> _fetchConversations() async {
    ...
    try {
      ...
      final userId = int.tryParse(currentUser.userId) ?? 0;
      if (userId == 0) return;
                      ...
                      child: ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final unread = conv['unread_count'] is int
                              ...
                              : 0;
                          final isRead = unread == 0;
                          final lastMsg = conv['content'] as String? ?? '';
                              ...
                              children: [
                                Expanded(
                                  child: Text(
                                    ...
                                    style: TextStyle(
                                      fontWeight: (conv['unread_count'] as int? ?? 0) > 0
                                          ? FontWeight.bold
                                          : FontWeight.normal,
                                      fontSize: 15,
                                    ),
                                ...
                                if ((conv['unread_count'] as int? ?? 0) > 0)
                                  Container(
