...
_$EMIAutomationConfigImpl _$$EMIAutomationConfigImplFromJson(
    ...
    _$EMIAutomationConfigImpl(
      ...
      emailConfig:
          EmailConfig.fromJson(json['emailConfig'] as Map<String, dynamic>),
      reminderRules: (json['reminderRules'] as List<dynamic>?)
      ...
      escalationRules: (json['escalationRules'] as List<dynamic>?)
              ...
              .toList() ??
          const [],
      collectionRules: (json['collectionRules'] as List<dynamic>?)
              ?.map((e) => AutomationRule.fromJson(e as Map<String, dynamic>))
              .toList() ??
          const [],
...
_$VoiceCallConfigImpl _$$VoiceCallConfigImplFromJson(
    ...
    _$VoiceCallConfigImpl(
      ...
      preferredCallHours: (json['preferredCallHours'] as List<dynamic>?)
...
_$SMSConfigImpl _$$SMSConfigImplFromJson(Map<String, dynamic> json) =>
    _$SMSConfigImpl(
      ...
      blockedHours: (json['blockedHours'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toList() ??
          const [],
    );
