...
_$DailyCallerImpl _$$DailyCallerImplFromJson(Map<String, dynamic> json) =>
    _$DailyCallerImpl(
      ...
      assignedLeadIds: (json['assignedLeadIds'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toList() ??
          const [],
      leadAssignments: (json['leadAssignments'] as List<dynamic>?)
              ?.map((e) =>
                  CallerLeadAssignment.fromJson(e as Map<String, dynamic>))
              .toList() ??
          const [],
      ...
      performanceWarnings: (json['performanceWarnings'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toList() ??
          const [],
...
_$LeadDistributionBatchImpl _$$LeadDistributionBatchImplFromJson(
    ...
    _$LeadDistributionBatchImpl(
      ...
      leadSourceIds: (json['leadSourceIds'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toList() ??
          const [],
      importedLeads: (json['importedLeads'] as List<dynamic>?)
              ?.map((e) => e as Map<String, dynamic>)
              .toList() ??
          const [],
      assignedCallerIds: (json['assignedCallerIds'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toList() ??
          const [],
      ...
      distributedLeadIds: (json['distributedLeadIds'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toList() ??
          const [],
