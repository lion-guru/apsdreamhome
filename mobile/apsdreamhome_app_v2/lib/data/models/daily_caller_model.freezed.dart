...
abstract class $DailyCallerCopyWith<$Res> {
  factory $DailyCallerCopyWith(
          DailyCaller value, $Res Function(DailyCaller) then) =
...
abstract class _$$DailyCallerImplCopyWith<$Res>
  ...
  factory _$$DailyCallerImplCopyWith(
          _$DailyCallerImpl value, $Res Function(_$DailyCallerImpl) then) =
...
class __$$DailyCallerImplCopyWithImpl<$Res>
  ...
  __$$DailyCallerImplCopyWithImpl(
      _$DailyCallerImpl _value, $Res Function(_$DailyCallerImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$DailyCallerImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
// Admin Notes
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.currentMonthTalkTimeMinutes,
                    currentMonthTalkTimeMinutes) ||
                other.currentMonthTalkTimeMinutes ==
                    currentMonthTalkTimeMinutes) &&
            const DeepCollectionEquality()
                .equals(other._assignedLeadIds, _assignedLeadIds) &&
            const DeepCollectionEquality()
                .equals(other._leadAssignments, _leadAssignments) &&
            ...
            const DeepCollectionEquality()
                .equals(other._performanceWarnings, _performanceWarnings) &&
  ...
  Map<String, dynamic> toJson() {
    return _$$DailyCallerImplToJson(
      this,
    );
  }
}
...
abstract class _DailyCaller extends DailyCaller {
  const factory _DailyCaller(
      ...
      required final DateTime updatedAt}) = _$DailyCallerImpl;
...
// Performance Tracking
  ...
  List<MonthlyPerformance>
      get monthlyReports; // Current Month Stats (Auto-calculated)
  @override
...
abstract class $DailyCallReportCopyWith<$Res> {
  factory $DailyCallReportCopyWith(
          DailyCallReport value, $Res Function(DailyCallReport) then) =
...
abstract class _$$DailyCallReportImplCopyWith<$Res>
    implements $DailyCallReportCopyWith<$Res> {
  factory _$$DailyCallReportImplCopyWith(_$DailyCallReportImpl value,
...
class __$$DailyCallReportImplCopyWithImpl<$Res>
  ...
  __$$DailyCallReportImplCopyWithImpl(
      _$DailyCallReportImpl _value, $Res Function(_$DailyCallReportImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$DailyCallReportImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
// Pending, Submitted, Verified
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._callDetails, _callDetails) &&
            (identical(other.status, status) || other.status == status) &&
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$$DailyCallReportImplToJson(
      this,
    );
  }
}
...
abstract class _DailyCallReport implements DailyCallReport {
  const factory _DailyCallReport(
      ...
      final String? supervisorNotes,
      final DateTime? submittedAt,
      final DateTime? verifiedAt}) = _$DailyCallReportImpl;
...
// Call recording
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, leadId, leadName, leadPhone,
      callTime, outcome, talkTimeSeconds, notes, recordingUrl, location);
...
abstract class _CallDetail implements CallDetail {
  const factory _CallDetail(
      ...
      final String? notes,
      final String? recordingUrl,
      @GeoPointJsonConverter() final GeoPoint? location}) = _$CallDetailImpl;
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.targetAchievementPercentage,
...
abstract class _MonthlyPerformance implements MonthlyPerformance {
  const factory _MonthlyPerformance(
      ...
      final DateTime? paidAt}) = _$MonthlyPerformanceImpl;
...
abstract class $CallerLeadAssignmentCopyWith<$Res> {
  factory $CallerLeadAssignmentCopyWith(CallerLeadAssignment value,
...
abstract class _$$CallerLeadAssignmentImplCopyWith<$Res>
    implements $CallerLeadAssignmentCopyWith<$Res> {
  factory _$$CallerLeadAssignmentImplCopyWith(_$CallerLeadAssignmentImpl value,
...
class __$$CallerLeadAssignmentImplCopyWithImpl<$Res>
  ...
  __$$CallerLeadAssignmentImplCopyWithImpl(_$CallerLeadAssignmentImpl _value,
  ...
  $Res call({
    ...
    return _then(_$CallerLeadAssignmentImpl(
      leadId: null == leadId
          ? _value.leadId
          : leadId // ignore: cast_nullable_to_non_nullable
              as String,
...
// High, Medium, Low
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$$CallerLeadAssignmentImplToJson(
      this,
    );
  }
}
...
abstract class _CallerLeadAssignment implements CallerLeadAssignment {
  const factory _CallerLeadAssignment(
      ...
      final bool isCompleted,
      final DateTime? completedAt,
      final String? outcome}) = _$CallerLeadAssignmentImpl;
...
abstract class $LeadDistributionBatchCopyWith<$Res> {
  factory $LeadDistributionBatchCopyWith(LeadDistributionBatch value,
...
class __$$LeadDistributionBatchImplCopyWithImpl<$Res>
    extends _$LeadDistributionBatchCopyWithImpl<$Res,
        _$LeadDistributionBatchImpl>
    implements _$$LeadDistributionBatchImplCopyWith<$Res> {
  __$$LeadDistributionBatchImplCopyWithImpl(_$LeadDistributionBatchImpl _value,
  ...
  $Res call({
    ...
    return _then(_$LeadDistributionBatchImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
// Results
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._leadSourceIds, _leadSourceIds) &&
            const DeepCollectionEquality()
                .equals(other._importedLeads, _importedLeads) &&
            const DeepCollectionEquality()
                .equals(other._assignedCallerIds, _assignedCallerIds) &&
            ...
            const DeepCollectionEquality()
                .equals(other._distributedLeadIds, _distributedLeadIds) &&
  ...
  _$$LeadDistributionBatchImplCopyWith<_$LeadDistributionBatchImpl>
      get copyWith => __$$LeadDistributionBatchImplCopyWithImpl<
          _$LeadDistributionBatchImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$LeadDistributionBatchImplToJson(
      this,
    );
  }
}
...
abstract class _LeadDistributionBatch implements LeadDistributionBatch {
  const factory _LeadDistributionBatch(
      ...
      final int totalLeads}) = _$LeadDistributionBatchImpl;
