...
_$PropertyListingImpl _$$PropertyListingImplFromJson(
    ...
    _$PropertyListingImpl(
      ...
      negotiable:
          $enumDecodeNullable(_$PriceNegotiableEnumMap, json['negotiable']),
      ...
      listingPlan:
          $enumDecodeNullable(_$ListingPlanEnumMap, json['listingPlan']),
      ...
      interestedBuyers: (json['interestedBuyers'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toList() ??
          const [],
