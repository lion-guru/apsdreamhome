...
try {
    ...
    $samplePlans = [
        [
            'Standard EMI Plan',
            'emi',
            20.00, // down_payment_percentage
            8.50, // interest_rate
            2.00, // processing_fee
            12, // tenure_months
            100000.00, // min_amount
            5000000.00, // max_amount
            0, // installment_count
            'monthly', // installment_interval
            20000.00, // min_down_payment
            1000000.00, // max_down_payment
            1, // is_active
            1, // is_default
        ...
        [
            ...
            'installment',
            25.00, // down_payment_percentage
            0.00, // interest_rate
            1.50, // processing_fee
            0, // tenure_months
            50000.00, // min_amount
            2000000.00, // max_amount
            3, // installment_count
            'monthly', // installment_interval
            12500.00, // min_down_payment
            500000.00, // max_down_payment
            1, // is_active
            0, // is_default
            '2024-01-01', // effective_date
            NULL, // expiry_date
        ...
        [
            'Premium EMI Plan',
            'emi',
            15.00, // down_payment_percentage
            7.25, // interest_rate
            1.50, // processing_fee
            24, // tenure_months
            500000.00, // min_amount
            10000000.00, // max_amount
            0, // installment_count
            'monthly', // installment_interval
            75000.00, // min_down_payment
            1500000.00, // max_down_payment
            1, // is_active
            0, // is_default
            '2024-01-01', // effective_date
            NULL, // expiry_date
            'Premium EMI plan with lower interest rate for higher amounts',
            'Premium terms with special benefits'
        ]
    ];
    
    foreach ($samplePlans as $plan) {
        $stmt = $db->prepare("INSERT INTO payment_plans (
    ...
    echo "✅ " . count($samplePlans) . " payment plans inserted\n";
    ...
    $samplePayments = [
        [
            ...
            59000.00, // total_amount
            'razorpay', // gateway
            'razorpay_txn_123456', // gateway_transaction_id
            json_encode(['status' => 'success', 'captured' => true]), // gateway_response
            'completed', // status
            date('Y-m-d'), // payment_date
            date('H:i:s'), // payment_time
            0.00, // refund_amount
            NULL, // refund_reason
            NULL, // refund_date
            NULL, // refund_transaction_id
            NULL, // emi_plan_id
            NULL, // emi_month
            NULL, // emi_amount
            NULL, // total_emi_months
            'Booking amount for Plot A-101', // description
            'Initial booking payment', // notes
        ...
        [
            ...
            36000.00, // tax_amount
            0.00, // discount_amount
            236000.00, // total_amount
            'paytm', // gateway
            'paytm_txn_123456', // gateway_transaction_id
            json_encode(['status' => 'success', 'TXN_SUCCESS' => true]), // gateway_response
            'completed', // status
            date('Y-m-d', strtotime('-1 day')), // payment_date
            date('H:i:s', strtotime('-1 day')), // payment_time
            0.00, // refund_amount
            NULL, // refund_reason
            NULL, // refund_date
            NULL, // refund_transaction_id
            ...
            20000.00, // emi_amount
            12, // total_emi_months
            'Down payment for Suryoday Heights Phase 1', // description
            'First EMI payment', // notes
    ...
    $sampleNotifications = [
        [
            ...
            'Your payment of ₹59,000 for Plot A-101 has been successfully processed.', // message
            1, // email_sent
            1, // sms_sent
            0, // push_sent
            1, // customer_id
            'rahul.sharma@example.com', // customer_email
            '+91-9876543210', // customer_phone
            0, // is_read
            date('Y-m-d H:i:s'), // sent_at
            NULL, // read_at
            json_encode(['amount' => 59000, 'property' => 'Plot A-101']) // additional_data
        ],
        [
            2, // payment_id
            'payment_success', // notification_type
            'Payment Successful', // title
            'Your down payment of ₹2,36,000 for Suryoday Heights Phase 1 has been successfully processed.', // message
            1, // email_sent
            1, // sms_sent
            0, // push_sent
            2, // customer_id
            'priya.singh@example.com', // customer_email
            '+91-9876543220', // customer_phone
            0, // is_read
            date('Y-m-d H:i:s', strtotime('-1 day')), // sent_at
            NULL, // read_at
            json_encode(['amount' => 236000, 'project' => 'Suryoday Heights Phase 1']) // additional_data
        ]
    ];
    
    foreach ($sampleNotifications as $notification) {
        $stmt = $db->prepare("INSERT INTO payment_notifications (
    ...
    echo "✅ " . count($sampleNotifications) . " sample notifications inserted\n";
    ...
    echo "✅ Sample Data: 3 payment plans, 19 settings, 2 payments, 2 notifications\n";
