...
$db_user = 'root';
$db_pass = '';
$db_name = 'apsdreamhomefinal_complete';
...
// Files to merge
$file1 = __DIR__ . '/DATABASE FILE/apsdreamhomefinal.sql';      // Complete database
$file2 = __DIR__ . '/DATABASE FILE/apsdreamhomefinal (2).sql';  // Recent updates
