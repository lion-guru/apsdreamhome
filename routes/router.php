...
class Router
{
    ...
    public function dispatch($uri = null)
    {
        ...
        if (in_array($_SERVER['REQUEST_METHOD'], ['POST', 'PUT', 'DELETE'])) {
            $excludedPaths = ['/subscribe', '/api/', '/ad-click/', '/register', '/login', '/associate/login', '/associate/register', '/agent/login', '/agent/register', '/ai/property-valuation/generate', '/ai/', '/csp-report', '/webhook/'];
            $skip = false;
