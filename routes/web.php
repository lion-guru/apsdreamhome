...
$router->get('/senior-developer', 'AIController@seniorDeveloper');
$router->get('/senior-developer/status', 'AIController@seniorDeveloperStatus');
$router->post('/senior-developer/execute', 'AIController@seniorDeveloperExecute');
$router->get('/senior-developer/logs', 'AIController@seniorDeveloperLogs');
$router->get('/senior-developer/monitor', 'AIController@seniorDeveloperMonitor');
$router->get('/senior-developer/dashboard', 'AIController@seniorDeveloperDashboard');
