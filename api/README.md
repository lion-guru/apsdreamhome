...
1. **Start your local server**
   ...
   - The API will be available at `http://localhost/apsdreamhomefinal/api/v1/`
...
const client = new ApsDreamClient('http://localhost/apsdreamhomefinal/api/v1');
...
client = ApsDreamClient(base_url='http://localhost/apsdreamhomefinal/api/v1')
