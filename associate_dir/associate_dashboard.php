...
<body>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" id="referralLink"
                                       value="<?php echo $_SERVER['HTTP_HOST']; ?>/apsdreamhomefinal/associate_registration.php?ref=<?php echo $associate_data['referral_code'] ?? 'REF123'; ?>" readonly>
    ...
    <script>
        ...
        function shareTelegram() {
            ...
            window.open(`https://t.me/share/url?url=${encodeURIComponent(window.location.origin)}/apsdreamhomefinal/associate_registration.php?ref=${referralCode}&text=${encodeURIComponent(message)}`, '_blank');
        }
