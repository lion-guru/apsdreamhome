...
try {
    ...
    // 2. Create projects table (without foreign keys first)
    ...
    // 3. Add foreign keys after table creation
    echo "🔗 Adding foreign key constraints...\n";
    
    $db->exec("ALTER TABLE projects ADD CONSTRAINT fk_projects_colony FOREIGN KEY (colony_id) REFERENCES colonies(id) ON DELETE SET NULL");
    $db->exec("ALTER TABLE projects ADD CONSTRAINT fk_projects_district FOREIGN KEY (district_id) REFERENCES districts(id) ON DELETE SET NULL");
    $db->exec("ALTER TABLE projects ADD CONSTRAINT fk_projects_state FOREIGN KEY (state_id) REFERENCES states(id) ON DELETE SET NULL");
    
    echo "✅ Foreign key constraints added\n";
    
    // 4. Create project_status_history table
    ...
    // 7. Insert sample project images
