        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="alert alert-warning text-center">
                    ...
                    <br>
                    <small class="text-muted">Request ID: <?php echo uniqid('404_'); ?> | IP: <?php echo htmlspecialchars($_SERVER['REMOTE_ADDR'] ?? 'UNKNOWN', ENT_QUOTES, 'UTF-8'); ?></small>
                </div>
            </div>
        </div>
    </div>
...
logSecurityEvent('404 Page Loaded', {
    requested_url: '<?php echo htmlspecialchars($_SERVER['REQUEST_URI'] ?? 'UNKNOWN', ENT_QUOTES, 'UTF-8'); ?>',
    referrer: '<?php echo htmlspecialchars($_SERVER['HTTP_REFERER'] ?? 'DIRECT', ENT_QUOTES, 'UTF-8'); ?>'
});
