...
<body class="admin-dashboard">
    ...
    <script>
        ...
        function loadAnalytics() {
            fetch(`/apsdreamhome/api/alert_analytics.php?range=${currentTimeRange}`)
        ...
        function exportAnalytics() {
            window.location.href = `/apsdreamhome/api/export_alert_analytics.php?range=${currentTimeRange}`;
        }
