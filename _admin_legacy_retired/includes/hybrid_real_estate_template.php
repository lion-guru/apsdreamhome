<?php
/**
 * Hybrid Real Estate Dashboard Template
 * Complete dashboard for company owner with all hybrid real estate features
 */

// Function to generate the hybrid real estate dashboard
function generateHybridRealEstateDashboard($stats = [], $quick_actions = [], $recent_activities = [], $custom_content = '') {
    $html = '<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
            ...
            <div class="navbar-nav ms-auto">
                <div class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="hybrid_real_estate_control_center.php">
    ...
    foreach ($stats as $stat) {
        $change_class = $stat['change_type'] === 'positive' ? 'text-success' : 'text-danger';
        $html .= '<div class="col-md-3">
            <div class="stats-card">
                <i class="' . $stat['icon'] . ' fa-2x mb-2 text-primary"></i>
                <div class="stats-number">' . $stat['value'] . '</div>
                <p class="mb-0">' . $stat['label'] . '</p>
                <small class="' . $change_class . '">' . $stat['change'] . '</small>
            </div>
        </div>';
    }
    ...
    foreach ($quick_actions as $action) {
        $html .= '<a href="' . $action['url'] . '" class="btn btn-' . $action['color'] . ' btn-lg">
