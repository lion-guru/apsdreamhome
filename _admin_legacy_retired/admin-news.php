...
<body>
    ...
    <section class="admin-news-section py-5 bg-light position-relative">
        <div class="container position-relative" style="z-index:3;">
            ...
            $params = [];
            if ($q !== '') {
                $where = "WHERE title LIKE :q1 OR summary LIKE :q2";
                $params['q1'] = "%$q%";
                $params['q2'] = "%$q%";
            }
            // Count total news
            ...
            $news_items = [];
            try {
                $sql = "SELECT id, title, date, summary, image, content FROM news $where ORDER BY date DESC, id DESC LIMIT :limit OFFSET :offset";
                ...
                error_log("Error fetching news items: " . $e->getMessage());
            }
            $i = $offset + 1;
            ?>
