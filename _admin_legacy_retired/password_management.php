...
$stmt = $conn->prepare("SELECT id, auser, role, status FROM admin");
$stmt->execute();
                    ...
                    <form method="POST">
                        <div class="mb-3">
                            ...
                            <select name="username" class="form-control" required>
                                ...
                                <option value="<?php echo htmlspecialchars($user['auser']); ?>">
                                    <?php echo htmlspecialchars($user['auser'] . " (" . $user['role'] . ")"); ?>
                                </option>
                                <?php endforeach; ?>
                            </select>
                        </div>
