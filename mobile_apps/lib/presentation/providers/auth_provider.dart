...
class AuthNotifier extends StateNotifier<AsyncValue<User?>> {
    ...
    try {
      ...
      if (response['success'] == true && response['data'] != null) {
        ...
        await _secureStorage.write(
            key: AppConstants.userIdKey, value: user.userId);
        await _secureStorage.write(
            key: AppConstants.userProfileKey, value: user.toJson().toString());
  ...
  Future<void> logout() async {
    try {
      ...
      print('Logout API call failed: $e'); // ignore: avoid_print
    }
  ...
  Future<void> _refreshUserProfile() async {
    try {
      ...
      print('Failed to refresh user profile: $e'); // ignore: avoid_print
    }
  }
...
// Theme provider
final themeProvider =
    StateProvider<bool>((ref) => false); // false = light theme
