                ...
                <div class='card h-100 border-0 shadow-sm text-center'>
                    <div class='card-body p-4'>
                        ...
                        <div class='d-flex justify-content-center gap-2'>
                            <a href='tel:" . htmlspecialchars($member['phone'] ?? '') . "' class='btn btn-outline-primary btn-sm'>
                                <i class='fas fa-phone'></i>
                            </a>
                            <a href='mailto:" . htmlspecialchars($member['email'] ?? '') . "' class='btn btn-outline-primary btn-sm'>
                ...
                <div class='card border-0 shadow-sm h-100'>
                    <div class='card-body p-4'>
                        ...
                        <div class='d-flex align-items-center'>
                            ...
                            <div>
                                <h6 class='mb-0'>" . htmlspecialchars($testimonial['name'] ?? 'Anonymous') . "</h6>
...
// Render the complete page with all old about.php functionality preserved
page($content, 'About Us - APS Dream Home');
?>
