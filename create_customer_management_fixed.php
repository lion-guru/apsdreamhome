...
try {
    ...
    // 6. Insert Sample Customer Data using direct SQL
    ...
    $db->exec("INSERT INTO customers (
        ...
        'CUS001', 'Rahul', 'Sharma', 'rahul.sharma@example.com', '+91-9876543210', '" . password_hash('password123', PASSWORD_DEFAULT) . "',
        '1990-05-15', 'male', 'single', 'Software Engineer', 1200000.00,
        '123 Main Street, Gorakhpur', '456 Park Avenue, Gorakhpur', 'Gorakhpur', 'Uttar Pradesh', '273001', 'India',
        '123456789012', 'ABCDE1234F', '',
        'residential', 'Suryoday Colony, Gorakhpur', 2000000.00, 5000000.00,
        800.00, 2000.00,
        'individual', '', '',
        1, 1, 1, 1, '[\"aadhar\", \"pan\", \"photo\"]',
        '/uploads/customers/rahul_profile.jpg', 'Looking for residential property in Gorakhpur with modern amenities.', 'active', 1, 1,
        '" . date('Y-m-d H:i:s') . "', 5, 0, NULL, 1, NULL
    )");
    ...
    $db->exec("INSERT INTO customers (
        ...
        'CUS002', 'Priya', 'Singh', 'priya.singh@example.com', '+91-9876543220', '" . password_hash('password123', PASSWORD_DEFAULT) . "',
        '1988-08-22', 'female', 'married', 'Teacher', 600000.00,
        '789 School Road, Deoria', '456 College Road, Deoria', 'Deoria', 'Uttar Pradesh', '274001', 'India',
        '987654321098', 'FGHIJ5678K', '',
        'residential', 'Braj Radha Nagri, Deoria', 1500000.00, 3000000.00,
        1000.00, 1500.00,
        'individual', '', '',
        1, 1, 0, 0, '[\"aadhar\", \"pan\"]',
        '/uploads/customers/priya_profile.jpg', 'Interested in affordable residential property with good connectivity.', 'active', 1, 0,
        '" . date('Y-m-d H:i:s', strtotime('-2 days')) . "', 3, 0, NULL, 1, NULL
    )");
    
    echo "✅ 2 sample customers inserted\n";
    
    // 7. Insert Sample Preferences
    echo "⚙️ Inserting Sample Preferences...\n";
    
    $db->exec("INSERT INTO customer_preferences (customer_id, preference_key, preference_value, preference_type) VALUES 
    ...
    echo "✅ 10 sample preferences inserted\n";
    
    // 8. Insert Sample Wishlist Items
    echo "❤️ Inserting Sample Wishlist Items...\n";
    
    $db->exec("INSERT INTO customer_wishlist (customer_id, property_type, property_id, notes) VALUES 
    ...
    echo "✅ 5 sample wishlist items inserted\n";
