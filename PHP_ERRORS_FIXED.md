...
C:\xampp\htdocs\apsdreamhome\config.php on line 31
Warning: ini_set(): Session ini settings cannot be changed when a session is active in 
C:\xampp\htdocs\apsdreamhome\config.php on line 32
Warning: ini_set(): Session ini settings cannot be changed when a session is active in 
C:\xampp\htdocs\apsdreamhome\config.php on line 33
```

### **2. Function Redeclaration Fatal Error**
```
Fatal error: Cannot redeclare getDbConnection() (previously declared in 
C:\xampp\htdocs\apsdreamhome\config.php:120) in 
C:\xampp\htdocs\apsdreamhome\includes\db_connection.php on line 47
```

### **3. Minor REQUEST_METHOD Warning**
```
Warning: Undefined array key "REQUEST_METHOD" in C:\xampp\htdocs\apsdreamhome\index.php on line 43
```
...
- ✅ **Test Page**: `http://localhost/apsdreamhome/test.php`
- ✅ **Health Check**: `http://localhost/apsdreamhome/system_health_check.php`
...
- **Role:** admin
- **Status:** active
- **Database:** apsdreamhome (120+ tables)
...
1. **✅ Browse your website** - `http://localhost/apsdreamhome/`
2. **✅ Access admin panel** - `http://localhost/apsdreamhome/admin/`
...
### Problem
- User accessing `http://localhost/apsdreamhome/admin/dashboard.php` was getting "ERR_TOO_MANY_REDIRECTS"
...
### Problem
- User accessing `http://localhost/apsdreamhome/admin/admin_dashboard.php` was getting "ERR_TOO_MANY_REDIRECTS"
...
### Problem
- User accessing `http://localhost/apsdreamhome/admin/login.php` was getting "ERR_TOO_MANY_REDIRECTS"
...
- **Correct URLs to use:**
  - `http://localhost/apsdreamhome/admin/`
  - `http://localhost/apsdreamhome/admin/index.php`
- **DO NOT use:** `http://localhost/apsdreamhome/admin/login.php` (now works but redirects)
