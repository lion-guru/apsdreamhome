...
### 2. Schema Import
- **Source File**: `DATABASE FILE/apsdreamhomefinal.sql`
...
GRANT SELECT, INSERT, UPDATE, DELETE ON apsdreamhomefinal.* TO 'apsdreamhome'@'localhost';
...
#!/bin/bash
# Daily backup script
mysqldump -u root -p apsdreamhomefinal > backup_$(date +%Y%m%d).sql
```
