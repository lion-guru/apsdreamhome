...
echo "<li><strong>Visit:</strong> <a href='http://localhost/apsdreamhomefinal/index.php'>http://localhost/apsdreamhomefinal/index.php</a></li>";
echo "</ol>";

echo "<p><a href='http://localhost/apsdreamhomefinal/index.php' class='btn btn-primary'>Go to Main Site</a></p>";
?>
