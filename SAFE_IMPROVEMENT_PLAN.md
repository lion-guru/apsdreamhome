...
cp -r /xampp/htdocs/apsdreamhome /backup/apsdreamhome_full_backup_$(date +%Y%m%d_%H%M%S)
...
```bash
# Restore from backup
cp -r /backup/apsdreamhome_full_backup_* /xampp/htdocs/apsdreamhome
```

### **Selective Revert:**
```bash
# Restore specific files if needed
cp /backup/apsdreamhome_full_backup_*/includes/templates/* ./includes/templates/
cp /backup/apsdreamhome_full_backup_*/includes/footer.php ./includes/
```
