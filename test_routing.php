...
if (file_exists('support.php')) {
    ...
    // Test direct access
    $support_url = 'http://' . $_SERVER['HTTP_HOST'] . '/apsdreamhomefinal/support.php';
...
$test_url = 'http://' . $_SERVER['HTTP_HOST'] . '/apsdreamhomefinal/nonexistent-page';
...
echo "<ul>";
echo "<li><a href='/apsdreamhomefinal/' target='_blank'>Homepage</a></li>";
echo "<li><a href='/apsdreamhomefinal/support' target='_blank'>Support Page (routed)</a></li>";
echo "<li><a href='/apsdreamhomefinal/support.php' target='_blank'>Support Page (direct)</a></li>";
echo "<li><a href='/apsdreamhomefinal/nonexistent-page' target='_blank'>Test 404 Page</a></li>";
echo "</ul>";
?>
