...
try {
    ...
    $loginUrl = 'http://' . $_SERVER['HTTP_HOST'] . '/apsdreamhome/admin/login.php';
    ...
    $dashboardUrl = 'http://' . $_SERVER['HTTP_HOST'] . '/apsdreamhome/admin/dashboard.php';
...
echo "<ol>";
echo "<li>Access the <a href='/apsdreamhome/admin/' target='_blank'>Admin Dashboard</a></li>";
