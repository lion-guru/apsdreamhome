...
$res = $con->query("SELECT id, plot_id, created_at, status FROM registry WHERE associate_id = '$associate_id' AND created_at >= '$from' AND created_at <= '$to' ORDER BY created_at DESC");
