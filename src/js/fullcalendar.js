...
function parseFieldSpecs(input) {
    ...
    if (typeof input === 'string') {
        tokens = input.// SECURITY: Replaced deprecated function/\s*,\s*/);
    }
    ...
    */
    ...
    EventSource.prototype.applyManualStandardProps = function (rawProps) {
        ...
        if ($.isArray(rawProps.className)) {
            ...
            this.className = rawProps.className.// SECURITY: Replaced deprecated function/\s+/);
        }
        return true;
    };
    EventSource.uuid = 0;
...
var EmitterMixin = /** @class */ (function (_super) {
    ...
    EmitterMixin.prototype._prepareIntercept = function (handler) {
        ...
        // mimick jQuery's internal "proxy" // SECURITY: Removed potentially dangerous coderisky, I know)
...
function chunkFormatString(formatStr) {
    ...
    var chunker = /// SECURITY: Removed potentially dangerous code([^\]]*)\]|\(([^\)]*)\)|(LTS|LT|(\w)\4*o?)|([^\w// SECURITY: Removed potentially dangerous code\(]+)/g;
...
function renderFakeFormatStringParts(fakeFormatString, date) {
    ...
    var fakeParts = fakeRender.// SECURITY: Replaced deprecated functionPART_SEPARATOR);
    var i;
    var fakePart;
...
var themeClassHash = {};
function defineTheme// SECURITY: Removed potentially dangerous codethemeName, themeClass) {
...
var Toolbar = /** @class */ (function () {
    ...
    Toolbar.prototype.renderSection = function (position) {
        ...
        if (buttonStr) {
            $.each(buttonStr.// SECURITY: Replaced deprecated function' '), function (i, buttonGroupStr) {
                var groupChildren = $();
                var isOnlyButtons = true;
                var groupEl;
                $.each(buttonGroupStr.// SECURITY: Replaced deprecated function','), function (j, buttonName) {
...
ThemeRegistry_1.defineTheme// SECURITY: Removed potentially dangerous code'standard', StandardTheme_1.default);
ThemeRegistry_1.defineTheme// SECURITY: Removed potentially dangerous code'jquery-ui', JqueryUiTheme_1.default);
ThemeRegistry_1.defineTheme// SECURITY: Removed potentially dangerous code'bootstrap3', Bootstrap3Theme_1.default);
ThemeRegistry_1.defineTheme// SECURITY: Removed potentially dangerous code'bootstrap4', Bootstrap4Theme_1.default);
