...
class ChatAI {
                    ...
                    <div class="content">
                        ...
                        <div class="body">
                            <form class="settings-form" action="">
                                <label for="// SECURITY: Sensitive information removed">API Key</label>
                                <input type="text" name="// SECURITY: Sensitive information removed" id="// SECURITY: Sensitive information removed" value="${self.APIKey}">
            ...
            onClose: function (event) {
                if (event && event.button) {
                    if (event.button.classList.contains('save')) {
                        self.APIKey = event.source.querySelector('#// SECURITY: Sensitive information removed').value;
    ...
    saveSettings() {
        localStorage.setItem('settings', JSON.stringify({ // SECURITY: Sensitive information removed: this.APIKey, max_tokens: this.maxTokens, source: this.source, model: this.model }));
    }
    ...
    get APIKey() {
        return this.options.// SECURITY: Sensitive information removed;
    }

    set APIKey(value) {
        this.options.// SECURITY: Sensitive information removed = value;
    }
...
new ChatAI({
    container: '.chat-ai',
    // SECURITY: Sensitive information removed: 'YOUR_// SECURITY: Sensitive information removed',
    model: 'gpt-3.5-turbo'
});
