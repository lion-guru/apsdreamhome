<?php
// Modern, AI-powered, feature-rich dashboard for Investors (2025 best practices)
require_once 'header.php';
session_start();
if (!isset($_SESSION['uid']) || $_SESSION['utype'] !== 'investor') {
    header('Location: login.php');
    exit();
}
// Example investor stats (replace with real queries)
$investor_name = htmlspecialchars($_SESSION['name'] ?? 'Investor');
$stats = [
    'investments' => 6,
    'returns' => '₹2.1L',
    'messages' => 4,
...
<div class="container py-5">
    <h1 class="mb-4">Welcome, <?php echo $investor_name; ?>!</h1>
    <!-- Stats Cards -->
    <div class="dashboard-stats">
        <div class="stat-box">
            <div class="fs-3 fw-bold text-primary"><?php echo $stats['investments']; ?></div>
            <div>My Investments</div>
        </div>
        <div class="stat-box">
            <div class="fs-3 fw-bold text-success"><?php echo $stats['returns']; ?></div>
            <div>Total Returns</div>
        </div>
        <div class="stat-box">
            <div class="fs-3 fw-bold text-info"><?php echo $stats['messages']; ?></div>
            <div>Messages</div>
        </div>
        <div class="stat-box">
            <div class="fs-3 fw-bold text-warning"><?php echo $stats['opportunities']; ?></div>
    ...
    <div class="ai-chatbot mb-4">
        ...
        <form id="aiChatForm" class="d-flex mt-2" onsubmit="return false;">
            <input type="text" class="form-control me-2" id="aiChatInput" placeholder="Ask about investments, returns, or new opportunities...">
            <button class="btn btn-primary" onclick="sendAIQuery()"><i class="fa-solid fa-paper-plane"></i></button>
        </form>
        <div id="aiChatResponse" class="mt-2 text-secondary small">Try: "Show my latest returns"</div>
    </div>
    <div class="row">
        <div class="col-md-4">
            <div class="card dashboard-card p-4 text-center">
                <i class="fa-solid fa-building-columns feature-icon"></i>
                <h4 class="mt-3">My Investments</h4>
                <p>View and manage all your property investments.</p>
                <a href="#" class="btn btn-outline-primary">View Investments</a>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card dashboard-card p-4 text-center">
                ...
                <p>Track your returns, download statements, and view analytics.</p>
        ...
        <div class="col-md-4">
            <div class="card dashboard-card p-4 text-center">
                ...
                <h4 class="mt-3">Messages & Notifications</h4>
