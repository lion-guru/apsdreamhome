...
$mainHtaccessPath = "C:\xampp\htdocs\apsdreamhome\.htaccess"
...
RewriteCond %{REQUEST_URI} ^/apsdreamhome/admin/ [NC]
...
RewriteCond %{HTTP_REFERER} !^http(s)?://localhost/apsdreamhome/admin/ [NC]
RewriteRule ^ - [F]
"@
