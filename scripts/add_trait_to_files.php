...
foreach ($filesToAddTrait as $file) {
    ...
    if (strpos($content, 'class ServiceTenantTrait') !== false) {
        echo "SKIP: File $file already has ServiceTenantTrait, skipping\n";
        $skippedCount++;
        continue;
    }
    ...
    if (strpos($content, 'extends ServiceTenantTrait') !== false) {
        echo "SKIP: File $file already extends ServiceTenantTrait, skipping\n";
        $skippedCount++;
        continue;
    }
...
echo "Total files skipped: $skippedCount\n";

echo "\nAll files have been processed with ServiceTenantTrait.\n";
