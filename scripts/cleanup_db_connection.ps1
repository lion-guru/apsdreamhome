$content = Get-Content 'c:\xampp\htdocs\apsdreamhome\includes\db_connection.php'
...
$cleanedContent | Set-Content 'c:\xampp\htdocs\apsdreamhome\includes\db_connection.php'
