...
// File paths
$file1 = __DIR__ . '/DATABASE FILE/apsdreamhomefinal.sql';      // Older complete file
$file2 = __DIR__ . '/DATABASE FILE/apsdreamhomefinal (2).sql';  // Newer partial file
$file3 = __DIR__ . '/apsdreamhomefinal_ultimate.sql';           // New merged file
...
echo "<tr><td style='padding: 10px; border: 1px solid #ddd;'>apsdreamhomefinal.sql</td><td style='padding: 10px; border: 1px solid #ddd;'>$size1</td><td style='padding: 10px; border: 1px solid #ddd;'>$tables1</td><td style='padding: 10px; border: 1px solid #ddd;'>$data1</td><td style='padding: 10px; border: 1px solid #ddd;'>$status1</td></tr>";
echo "<tr><td style='padding: 10px; border: 1px solid #ddd;'>apsdreamhomefinal (2).sql</td><td style='padding: 10px; border: 1px solid #ddd;'>$size2</td><td style='padding: 10px; border: 1px solid #ddd;'>$tables2</td><td style='padding: 10px; border: 1px solid #ddd;'>$data2</td><td style='padding: 10px; border: 1px solid #ddd;'>$status2</td></tr>";
echo "<tr><td style='padding: 10px; border: 1px solid #ddd;'>apsdreamhomefinal_ultimate.sql</td><td style='padding: 10px; border: 1px solid #ddd;'>$size3</td><td style='padding: 10px; border: 1px solid #ddd;'>$tables3</td><td style='padding: 10px; border: 1px solid #ddd;'>$data3</td><td style='padding: 10px; border: 1px solid #ddd;'>$status3</td></tr>";
echo "</table>";
echo "</div>";
...
echo "<h4>📄 apsdreamhomefinal.sql (Complete):</h4>";
echo "<ul>";
...
echo "<h4>📄 apsdreamhomefinal (2).sql (Recent):</h4>";
echo "<ul>";
...
echo "<h4>🎯 apsdreamhomefinal_ultimate.sql (New Merged File):</h4>";
echo "<ul>";
...
echo "<table style='width: 100%; border-collapse: collapse;'>";
echo "<tr style='background: #e9ecef;'><th style='padding: 10px; border: 1px solid #ddd;'>Feature</th><th style='padding: 10px; border: 1px solid #ddd;'>apsdreamhomefinal.sql</th><th style='padding: 10px; border: 1px solid #ddd;'>apsdreamhomefinal (2).sql</th><th style='padding: 10px; border: 1px solid #ddd;'>apsdreamhomefinal_ultimate.sql</th></tr>";
...
echo "<h4>🏆 WINNER: apsdreamhomefinal_ultimate.sql</h4>";
...
echo "mysql -u root -p apsdreamhomefinal_ultimate < " . basename($file3);
echo "</pre>";
