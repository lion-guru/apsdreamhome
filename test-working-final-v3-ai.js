// Test script for Working Final V3 AI Chatbot
import { generateAIResponse } from './ai-chatbot-working-final-v3.js';

async function testChatbot() {
  console.log('🤖 Testing Working Final V3 AI Chatbot...\n');
