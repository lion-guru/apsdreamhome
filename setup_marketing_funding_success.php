...
try {
    ...
    echo "🗑️ Dropping existing marketing tables...\n";
    $db->exec("DROP TABLE IF EXISTS marketing_campaigns");
    $db->exec("DROP TABLE IF EXISTS investment_plans");
    $db->exec("DROP TABLE IF EXISTS funding_investors");
    $db->exec("DROP TABLE IF EXISTS special_offers");
    ...
    $db->exec("CREATE TABLE marketing_campaigns (
    ...
    $db->exec("CREATE TABLE investment_plans (
        id INT AUTO_INCREMENT PRIMARY KEY,
        colony_id INT NOT NULL,
    ...
    $db->exec("CREATE TABLE funding_investors (
        id INT AUTO_INCREMENT PRIMARY KEY,
    ...
    $db->exec("CREATE TABLE special_offers (
        id INT AUTO_INCREMENT PRIMARY KEY,
        colony_id INT NOT NULL,
