...
### **Main System URLs:**
- **System Showcase:** `http://localhost/apsdreamhomefinal/final_system_showcase.php`
- **Admin Dashboard:** `http://localhost/apsdreamhomefinal/admin/`
- **Visit Management:** `http://localhost/apsdreamhomefinal/visit_management_system.php`
- **System Monitor:** `http://localhost/apsdreamhomefinal/system_test_complete.php`
- **EMI System:** `http://localhost/apsdreamhomefinal/test_payment_emi_system.php`
