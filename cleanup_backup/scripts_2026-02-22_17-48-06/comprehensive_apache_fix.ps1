...
Copy-Item "C:\xampp\htdocs\apsdreamhome\.htaccess" "C:\xampp\htdocs\apsdreamhome\.htaccess.bak_$timestamp"
...
$htaccessContent | Set-Content "C:\xampp\htdocs\apsdreamhome\.htaccess"
