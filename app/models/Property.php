...
class Property extends Model
{
     ...
     * @return array
     */
    public static function getForSelect($columns = ['id', 'title', 'location'], $status = 'active')
    {
        try {
            ...
            error_log('Error in Property::getForSelect: ' . $e->getMessage());
            return [];
        }
    }
     ...
     * @return array
     */
    public static function getActive($limit = null, $offset = 0)
    {
        try {
            $db = \App\Core\Database::getInstance();
            $sql = "SELECT * FROM properties WHERE status = 'active' ORDER BY created_at DESC";
            ...
            error_log('Error in Property::getActive: ' . $e->getMessage());
            return [];
        }
    }
    ...
    {
        return self::getFeaturedProperties($limit ?? 6);
    }
    ...
    public static function getByType($type, $limit = null, $offset = 0)
    {
        try {
            $db = \App\Core\Database::getInstance();
            $sql = "SELECT * FROM properties WHERE type = :type AND status != 'sold' ORDER BY created_at DESC";
            ...
            error_log('Error in Property::getByType: ' . $e->getMessage());
            return [];
        }
    }
     ...
     * @return array
     */
    public static function getByLocation($location, $limit = null, $offset = 0)
    {
        try {
            $db = \App\Core\Database::getInstance();
            $sql = "SELECT * FROM properties WHERE location LIKE :location AND status != 'sold' ORDER BY created_at DESC";
            ...
            error_log('Error in Property::getByLocation: ' . $e->getMessage());
            return [];
        }
    }
     ...
     * @return array
     */
    public static function getByPriceRange($minPrice, $maxPrice, $limit = null, $offset = 0)
    {
        try {
            $db = \App\Core\Database::getInstance();
            $where = ["status != 'sold'"];
            ...
            $sql = "SELECT * FROM properties {$whereClause} ORDER BY price ASC";
            ...
            error_log('Error in Property::getByPriceRange: ' . $e->getMessage());
            return [];
        }
    }
}
