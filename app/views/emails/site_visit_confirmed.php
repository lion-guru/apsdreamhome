...
<title>Site Visit Confirmed</title>
<style>
  ...
  <tr>
    <td align="center" style="padding:30px 15px;">
      <table role="presentation" class="container" border="0" cellpadding="0" cellspacing="0" width="600" style="max-width:600px;background:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
        <!-- Header -->
        <tr>
          <td bgcolor="#3b82f6" align="center" style="background:linear-gradient(135deg,#3b82f6 0%,#2563eb 100%);padding:40px 30px;">
            ...
            <h1 class="h1-mobile" style="color:#ffffff;margin:0;font-size:28px;font-weight:700;line-height:34px;">Site Visit Confirmed</h1>
            <p style="color:rgba(255,255,255,0.9);margin:8px 0 0;font-size:15px;">We look forward to meeting you</p>
          </td>
        </tr>
        <!-- Body -->
        <tr>
          <td class="px-mobile" style="padding:40px 40px 20px;">
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="background:#eff6ff;border:1px solid #bfdbfe;border-radius:6px;margin:0 0 24px;">
              <tr>
                <td style="padding:16px 18px;font-size:14px;color:#1e40af;line-height:22px;">
                  <strong style="font-size:16px;">Visit Details</strong><br><br>
                  <strong>Property:</strong> {{plot_number}}, {{colony_name}}<br>
                  <strong>Address:</strong> {{colony_address}}<br>
                  <strong>Date:</strong> {{visit_date}}<br>
                  <strong>Time:</strong> {{visit_time}}<br>
                  <strong>Agent:</strong> {{agent_name}}<br>
                  <strong>Contact:</strong> {{agent_phone}}
                </td>
              </tr>
            </table>
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="background:#fefce8;border:1px solid #fde047;border-radius:6px;margin:0 0 24px;">
              <tr>
                <td style="padding:14px 18px;font-size:14px;color:#854d0e;line-height:22px;">
                  <strong>What to bring:</strong> Valid ID proof (Aadhaar/PAN), comfortable walking shoes, and any questions about the property.
                </td>
              </tr>
            </table>
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr>
                <td align="center" style="padding:10px 0 30px;">
                  <a href="{{map_url}}" class="button-mobile" style="display:inline-block;padding:14px 36px;background:#3b82f6;color:#ffffff;text-decoration:none;border-radius:6px;font-size:16px;font-weight:600;">View on Map</a>
                </td>
              </tr>
            </table>
