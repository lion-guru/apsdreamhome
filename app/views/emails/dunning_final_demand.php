...
<div style="padding: 24px; background: #ffffff;">
    ...
    <p style="color: #475569; line-height: 1.6;">This is a <strong>final demand</strong> for your overdue EMI payment. Your account is now <strong style="color: #0f766e;">{{days_overdue}} days past due</strong> across {{overdue_count}} installment(s).</p>
    
    <div style="background: #faf5ff; border: 2px solid #99f6e4; border-radius: 8px; padding: 16px; margin: 16px 0;">
        <table style="width: 100%; font-size: 14px;">
            ...
            <tr><td style="padding: 6px 0; color: #64748b;">Total Overdue Amount:</td><td style="padding: 6px 0; font-weight: bold; color: #0f766e; font-size: 18px;">₹{{total_overdue}}</td></tr>
