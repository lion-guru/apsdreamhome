      ...
      <table role="presentation" class="container" border="0" cellpadding="0" cellspacing="0" width="600" style="max-width:600px;background:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
        ...
        <tr>
          <td bgcolor="#f59e0b" align="center" style="background:linear-gradient(135deg,#f59e0b 0%,#d97706 100%);padding:40px 30px;">
            ...
            <h1 class="h1-mobile" style="color:#ffffff;margin:0;font-size:28px;font-weight:700;line-height:34px;">KYC Requires Update</h1>
            <p style="color:rgba(255,255,255,0.9);margin:8px 0 0;font-size:15px;">Action needed to complete verification</p>
          </td>
        </tr>
        <!-- Body -->
        <tr>
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr>
                <td align="center" style="padding:10px 0 30px;">
                  <a href="{{kyc_url}}" class="button-mobile" style="display:inline-block;padding:14px 36px;background:#f59e0b;color:#ffffff;text-decoration:none;border-radius:6px;font-size:16px;font-weight:600;">Resubmit KYC</a>
                </td>
              </tr>
            </table>
