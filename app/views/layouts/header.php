    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="<?php echo BASE_URL; ?>">
                ...
                $logo = $site['logo_url'] ?? '/assets/images/logo/apslogo.png'; ?>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    foreach ($items as $it): ?>
                        <li class="nav-item"><a class="nav-link" href="<?php echo BASE_URL . rtrim('/' . ltrim($it['url'] ?? '#', '/'), ''); ?>"><?php echo htmlspecialchars($it['label'] ?? ''); ?></a></li>
                    <?php endforeach; ?>
                </ul>
            </div>
        </div>
