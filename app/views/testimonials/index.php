                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="testimonial-card">
                                ...
                                <div class="d-flex align-items-center">
                                    <img loading="lazy" src="<?php echo $testimonial['image'] ?? '/assets/images/default-avatar.jpg'; ?> class="img-fluid">" alt="<?php echo htmlspecialchars($testimonial['name'] ?? ''); ?>" class="testimonial-img me-3">
                                    <div>
