...
<div class="container-fluid px-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?php echo $base; ?>/agent/collections/create" class="btn btn-success btn-sm">
    ...
    <?php echo CSRFProtection::csrfField(); ?>
                ...
                <div class="col-auto">
                    ...
                    <a href="<?php echo $base; ?>/agent/collections" class="btn btn-sm btn-outline-secondary"><i class="fas fa-times"></i></a>
                </div>
            </form>
        </div>
    </div>
        ...
        <div class="card-body p-0">
            <?php if (empty($collections)): ?>
                <div class="text-center py-5">
                    ...
                    <a href="<?php echo $base; ?>/agent/collections/create" class="btn btn-success">Record Your First Collection</a>
                </div>
            <?php else: ?>
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo $base; ?>/agent/collections/<?php echo (int)($c['id'] ?? 0); ?>" class="btn btn-sm btn-outline-primary"><i class="fas fa-eye"></i></a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
