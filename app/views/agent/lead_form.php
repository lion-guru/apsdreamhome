...
.form-header { background: linear-gradient(135deg, #064e3b, #10b981); color: #fff; border-radius: 12px; padding: 24px; margin-bottom: 20px; }
</style>
...
<div class="card shadow-sm">
    <div class="card-body">
        <form method="POST" action="<?= $base ?>/agent/leads/store">
            ...
            <div class="mt-4 d-flex gap-2">
                ...
                <a href="<?= $base ?>/agent/leads" class="btn btn-outline-secondary">Cancel</a>
            </div>
        </form>
    </div>
</div>
