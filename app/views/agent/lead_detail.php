...
<div class="lead-detail-header">
    <div class="d-flex justify-content-between align-items-start">
        <div>
            <a href="<?= $base ?>/agent/leads" class="text-white text-decoration-none">
            ...
            <h4 class="mt-2">
                ...
                ?>
                <span class="badge <?= e($statusCls) ?> ms-2"><?= e(ucfirst(str_replace('_', ' ', $leadStatus))) ?></span>
            </h4>
            <div class="lead-meta">
...
<div class="row g-4">
    ...
    <div class="col-lg-7">
        ...
        <div class="card lead-info-card shadow-sm mb-4">
            <div class="card-header bg-white py-3">
                <h6 class="mb-0"><i class="fas fa-sticky-note me-2"></i>Notes (<?= count($notes) ?>)</h6>
            </div>
            <div class="card-body">
    ...
    <div class="col-lg-5">
        ...
        <div class="card lead-info-card shadow-sm">
            <div class="card-header bg-white py-3">
                <h6 class="mb-0"><i class="fas fa-stream me-2"></i>Activity Timeline</h6>
            </div>
            <div class="card-body">
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="d-flex justify-content-between">
                            <div>
                                ...
                                <span class="fw-semibold"><?= ucfirst(str_replace('_', ' ', $actType)) ?></span>
                                <div class="text-muted mt-1"><?= htmlspecialchars($act['description'] ?? '') ?></div>
                            </div>
