...
<div class="row g-4">
    ...
    <div class="col-lg-7">
        ...
        <div class="card lead-info-card shadow-sm mb-4">
            <div class="card-header bg-white py-3">
                <h6 class="mb-0 style-23251"><i class="fas fa-info-circle me-2"></i>Lead Information</h6>
            </div>
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-md-6">
        ...
        <div class="card lead-info-card shadow-sm mb-4">
            <div class="card-header bg-white py-3">
                <h6 class="mb-0 style-23251"><i class="fas fa-sync-alt me-2"></i>Update Status</h6>
            </div>
            <div class="card-body">
        ...
        <div class="card lead-info-card shadow-sm mb-4">
            <div class="card-header bg-white py-3">
                <h6 class="mb-0 style-23251"><i class="fas fa-sticky-note me-2"></i>Add Note</h6>
            </div>
            <div class="card-body">
        ...
        <div class="card lead-info-card shadow-sm mb-4">
            <div class="card-header bg-white py-3">
                <h6 class="mb-0 style-23251"><i class="fas fa-sticky-note me-2"></i>Notes (<?= count($notes) ?>)</h6>
            </div>
            <div class="card-body">
    ...
    <div class="col-lg-5">
        ...
        <div class="card lead-info-card shadow-sm mb-4">
            <div class="card-header bg-white py-3">
                <h6 class="mb-0 style-23251"><i class="fas fa-bolt me-2"></i>Quick Actions</h6>
            </div>
            <div class="card-body">
        ...
        <div class="card lead-info-card shadow-sm">
            <div class="card-header bg-white py-3">
                <h6 class="mb-0 style-23251"><i class="fas fa-stream me-2"></i>Activity Timeline</h6>
            </div>
            <div class="card-body">
