        ...
        <div class="col-lg-8">
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-body p-0">
                    <div class="vr-viewport" style="height: 450px; background: linear-gradient(135deg, #0f0c29, #302b63, #24243e);">
                ...
                <div class="card-body">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item px-0 d-flex align-items-center">
                            <img loading="lazy" src="<?= $base ?? BASE_URL ?>/<?= ($p['avatar'] ?? 'assets/img/avatar.png') ?>" alt="" class="rounded-circle me-3" style="width:40px;height:40px;object-fit:cover;" onerror="this.src='<?= $base ?? BASE_URL ?>assets/img/avatar.png'">
                            <div>
