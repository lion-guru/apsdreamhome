                ...
                <div class="card-body">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item px-0 d-flex align-items-center">
                            <img />/<?= ($p['avatar'] ?? 'assets/img/avatar.png') ?>" alt="" class="rounded-circle me-3" style="width:40px;height:40px;object-fit:cover;" onerror="this.src='<?= $base ?? BASE_URL ?>assets/img/avatar.png'">
                            <div>
