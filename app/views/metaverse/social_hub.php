                ...
                <div class="card-body aps-cp-card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-3 text-center">
                            <img src="<?= BASE_URL ?>/<?= htmlspecialchars($avatar['preview'] ?? 'assets/img/avatar.png') ?>" alt="" class="rounded-circle mb-2 border" style="width:60px;height:60px;object-fit:cover;" onerror="this.src='<?= BASE_URL ?>/assets/img/avatar.png'">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item px-0 d-flex align-items-center">
                            <span class="position-relative">
                                <img src="<?= BASE_URL ?>/<?= htmlspecialchars($user['avatar'] ?? 'assets/img/avatar.png') ?>" alt="" class="rounded-circle me-3" style="width:40px;height:40px;object-fit:cover;" onerror="this.src='<?= BASE_URL ?>/assets/img/avatar.png'">
