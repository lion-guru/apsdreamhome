            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                <div class="team-member">
                    <div class="member-img">
                        <img src="<?php echo h($member['image']); ?>" 
                             alt="<?php echo h($member['name']); ?>" 
                             class="img-fluid" 
                             loading="lazy">
                        <div class="social">
                            <?php if (!empty($member['linkedin'])): ?>
                            <a href="<?php echo h($member['linkedin']); ?>" target="_blank">
                                <i class="fab fa-linkedin-in"></i>
                            </a>
                            <?php endif; ?>
                            <?php if (!empty($member['instagram'])): ?>
                            <a href="<?php echo h($member['instagram']); ?>" target="_blank">
                                <i class="fab fa-instagram"></i>
                            </a>
                            <?php endif; ?>
                            <?php if (!empty($member['pinterest'])): ?>
                            <a href="<?php echo h($member['pinterest']); ?>" target="_blank">
                    ...
                    <div class="member-info">
                        ...
                        <span><?php echo h($member['position']); ?></span>
