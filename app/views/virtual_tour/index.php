                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            <div class="border rounded p-2 text-center">
                                <img src="<?= $base ?? BASE_URL ?>/<?= ($pano['thumbnail_path'] ?? $pano['file_path'] ?? 'assets/img/no-image.jpg') ?>" alt="" class="img-fluid rounded mb-2" style="height:120px;width:100%;object-fit:cover;" onerror="this.src='<?= $base ?? BASE_URL ?>assets/img/no-image.jpg'">
