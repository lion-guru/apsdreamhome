        ...
        <div class="col-lg-8">
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-body p-0 position-relative">
                    <div id="panoramaViewer" class=" rounded">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            <div class="border rounded p-2 text-center">
                                <img src="<?= BASE_URL ?>/<?= htmlspecialchars($pano['thumbnail_path'] ?? $pano['file_path'] ?? 'assets/img/no-image.jpg') ?>" alt="" class="img-fluid rounded mb-2" onerror="this.src='<?= BASE_URL ?>/assets/images/placeholder/property.svg'">
