...
<div class="container py-4">
    ...
    <div class="row justify-content-center g-4">
        <div class="col-md-4">
            <div class="card border-0 shadow-sm h-100 text-center p-4 gateway-card" onclick="selectGateway('razorpay')" >
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm h-100 text-center p-4 gateway-card" onclick="selectGateway('stripe')" >
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm h-100 text-center p-4 gateway-card" onclick="selectGateway('upi')" >
