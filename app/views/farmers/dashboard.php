...
<div class="container-fluid py-4">
    ...
    <div class="row g-3 mb-4">
        <div class="col-md-3"><div class="card border-0 shadow-sm"><div class="card-body"><div class="d-flex justify-content-between"><div><small class="text-muted text-uppercase fw-bold">Total Farmers</small><h3 class="mb-0 mt-1"><?= number_format($statistics['total_farmers'] ?? 0) ?></h3></div><div class="bg-success-subtle p-3 rounded"><i class="fas fa-users fa-2x text-success"></i></div></div></div></div></div>
        <div class="col-md-3"><div class="card border-0 shadow-sm"><div class="card-body"><div class="d-flex justify-content-between"><div><small class="text-muted text-uppercase fw-bold">States</small><h3 class="mb-0 mt-1"><?= number_format($statistics['unique_states'] ?? 0) ?></h3></div><div class="bg-warning-subtle p-3 rounded"><i class="fas fa-map-marker-alt fa-2x text-warning"></i></div></div></div></div></div>
        <div class="col-md-3"><div class="card border-0 shadow-sm"><div class="card-body"><div class="d-flex justify-content-between"><div><small class="text-muted text-uppercase fw-bold">Districts</small><h3 class="mb-0 mt-1"><?= number_format($statistics['unique_districts'] ?? 0) ?></h3></div><div class="bg-info-subtle p-3 rounded"><i class="fas fa-city fa-2x text-info"></i></div></div></div></div></div>
        <div class="col-md-3"><div class="card border-0 shadow-sm"><div class="card-body"><div class="d-flex justify-content-between"><div><small class="text-muted text-uppercase fw-bold">Registered</small><h3 class="mb-0 mt-1"><?= number_format($statistics['farmers_with_state'] ?? 0) ?></h3></div><div class="bg-primary-subtle p-3 rounded"><i class="fas fa-tractor fa-2x text-primary"></i></div></div></div></div></div>
    </div>
