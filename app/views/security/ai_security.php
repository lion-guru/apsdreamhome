    ...
    <div class="row g-4 mb-4">
        <div class="col-md-3">
            <div class="card border-0 shadow-sm text-center h-100">
                <div class="card-body"><div class="fs-1 text-primary mb-2"><i class="fas fa-bullseye"></i></div><h3 class="fw-bold"><?= htmlspecialchars($anomaly['detection_accuracy'] ?? '0%') ?></h3><small class="text-muted">Detection Accuracy</small></div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card border-0 shadow-sm text-center h-100">
                <div class="card-body"><div class="fs-1 text-success mb-2"><i class="fas fa-check-circle"></i></div><h3 class="fw-bold"><?= htmlspecialchars($anomaly['false_positive_rate'] ?? '0%') ?></h3><small class="text-muted">False Positive Rate</small></div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card border-0 shadow-sm text-center h-100">
                <div class="card-body"><div class="fs-1 text-warning mb-2"><i class="fas fa-chart-line"></i></div><h3 class="fw-bold"><?= htmlspecialchars($predictive['threat_prediction']['accuracy'] ?? '0%') ?></h3><small class="text-muted">Threat Prediction Accuracy</small></div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card border-0 shadow-sm text-center h-100">
                <div class="card-body"><div class="fs-1 text-info mb-2"><i class="fas fa-gauge-high"></i></div><h3 class="fw-bold"><?= htmlspecialchars($automated['response_automation_rate'] ?? '0%') ?></h3><small class="text-muted">Response Automation</small></div>
            </div>
        </div>
    </div>
    <div class="row g-4 mb-4">
