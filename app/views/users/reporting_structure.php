                ...
                <div class="emp-rp-org">
                    <?php if ($manager): ?>
                        <div class="emp-rp-node manager">
                            <div class="emp-rp-avatar"><?= rpInitials($manager['name']) ?></div>
                            ...
                            <div class="text-muted"><?= htmlspecialchars($manager['email'] ?? '') ?></div>
                        </div>
                    ...
                    <div class="emp-rp-node self">
                        <div class="emp-rp-avatar"><?= rpInitials($employee['name']) ?></div>
                        ...
                        <div class="text-muted"><?= htmlspecialchars($employee['department'] ?? '') ?></div>
                    ...
                    <?php if (!empty($subordinates)): ?>
                        ...
                        <div class="emp-rp-branch mt-1">
                            <?php foreach ($subordinates as $sub): ?>
                                <div class="emp-rp-node">
                                    <div class="emp-rp-avatar"><?= rpInitials($sub['name']) ?></div>
                                    <div class="fw-semibold text-dark small"><?= htmlspecialchars($sub['name'] ?? '') ?></div>
                                    <div class="text-muted"><?= htmlspecialchars($sub['designation'] ?? '') ?></div>
                                </div>
                            <?php endforeach; ?>
                        </div>
                    <?php endif; ?>
                                ...
                                <div class="emp-rp-sub-card h-100">
                                    <div class="d-flex align-items-start gap-3 mb-3">
                                        ...
                                        <div class="min-width-0">
                                            ...
                                            <span class="badge bg-<?= ($sub['status'] ?? '') === 'active' ? 'success' : 'secondary' ?> bg-opacity-10 text-<?= ($sub['status'] ?? '') === 'active' ? 'success' : 'secondary' ?>"><?= htmlspecialchars(ucfirst($sub['status'] ?? 'Active')) ?></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="emp-rp-progress mb-2">
                                        <div class="emp-rp-progress-fill bg-<?= rpPerformanceColor($perf) ?>"></div>
                                    </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="emp-rp-avatar"><?= rpInitials($m['name']) ?></div>
