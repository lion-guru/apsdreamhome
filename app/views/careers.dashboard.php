...
<div class="container-fluid py-4">
    ...
    <div class="row g-3 mb-4">
        <div class="col-md-3"><div class="card border-0 shadow-sm"><div class="card-body"><div class="d-flex justify-content-between"><div><small class="text-muted text-uppercase fw-bold">Total Jobs</small><h3 class="mb-0 mt-1"><?= number_format($stats['total_jobs'] ?? 0) ?></h3></div><div class="bg-primary-subtle p-3 rounded"><i class="fas fa-briefcase fa-2x text-primary"></i></div></div></div></div></div>
        <div class="col-md-3"><div class="card border-0 shadow-sm"><div class="card-body"><div class="d-flex justify-content-between"><div><small class="text-muted text-uppercase fw-bold">Active</small><h3 class="mb-0 mt-1"><?= number_format($stats['active_jobs'] ?? 0) ?></h3></div><div class="bg-success-subtle p-3 rounded"><i class="fas fa-check-circle fa-2x text-success"></i></div></div></div></div></div>
        <div class="col-md-3"><div class="card border-0 shadow-sm"><div class="card-body"><div class="d-flex justify-content-between"><div><small class="text-muted text-uppercase fw-bold">Total Applicants</small><h3 class="mb-0 mt-1"><?= number_format($stats['total_applicants'] ?? 0) ?></h3></div><div class="bg-info-subtle p-3 rounded"><i class="fas fa-users fa-2x text-info"></i></div></div></div></div></div>
        <div class="col-md-3"><div class="card border-0 shadow-sm"><div class="card-body"><div class="d-flex justify-content-between"><div><small class="text-muted text-uppercase fw-bold">New</small><h3 class="mb-0 mt-1 text-warning"><?= number_format($stats['new_applications'] ?? 0) ?></h3></div><div class="bg-warning-subtle p-3 rounded"><i class="fas fa-star fa-2x text-warning"></i></div></div></div></div></div>
    </div>
    <div class="row g-4">
        <div class="col-lg-8">
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body"><div class="bg-light rounded d-flex align-items-center justify-content-center" style="min-height:200px"><p class="text-muted mb-0"><i class="fas fa-chart-pie me-2"></i>Department chart</p></div></div>
            </div>
        </div>
    </div>
</div>
