    ...
    <div class="row g-4">
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body aps-cp-card-body"><div class="bg-light rounded d-flex align-items-center justify-content-center" style="min-height:200px"><p class="text-muted mb-0"><i class="fas fa-chart-pie me-2"></i>Department chart</p></div></div>
            </div>
        </div>
    </div>
</div>
