...
<div class="row g-3 mb-4">
    <div class="col-6 col-lg-3">
        <div class="emp-stat">
            <div class="emp-stat-icon style-95160"><i class="fas fa-tasks"></i></div>
    ...
    <div class="col-6 col-lg-3">
        <div class="emp-stat">
            <div class="emp-stat-icon style-25636"><i class="fas fa-check-circle"></i></div>
    ...
    <div class="col-6 col-lg-3">
        <div class="emp-stat">
            <div class="emp-stat-icon style-81404"><i class="fas fa-calendar-check"></i></div>
    ...
    <div class="col-6 col-lg-3">
        <div class="emp-stat">
            <div class="emp-stat-icon style-11227"><i class="fas fa-history"></i></div>
    ...
    <div class="col-lg-8">
        <div class="emp-card">
            <div class="emp-card-header">
                ...
                <a href="<?= BASE_URL ?>/employee/tasks" class="small text-decoration-none style-8314">View All</a>
            </div>
                    ...
                    <?php foreach (array_slice($tasks, 0, 6) as $task): ?>
                        <div class="emp-task-item">
                            <div class="flex-grow-1">
                                <h6 class="mb-1 style-51894"><?= htmlspecialchars($task['title'] ?? 'Untitled Task') ?></h6>
                                ...
                                <small class="text-muted">
                                    ...
                                    <?php if (!empty($task['priority'])): ?>
                                        &middot;
                                        <span class="text-uppercase fw-bold style-537">
                                            <?= $task['priority'] ?>
                                        </span>
                                    <?php endif; ?>
                                </small>
        ...
        <div class="emp-card">
            <div class="emp-card-header">
                ...
                <a href="<?= BASE_URL ?>/employee/activities" class="small text-decoration-none style-8314">View All</a>
            </div>
            <div class="emp-card-body">
                <?php if (!empty($activities)): ?>
                    <?php foreach (array_slice($activities, 0, 5) as $activity): ?>
                        <div class="emp-activity-item">
                            <div class="emp-activity-dot style-95160">
                                <i class="fas fa-circle style-96543"></i>
                            </div>
                            <div class="flex-grow-1">
                                <p class="mb-1 style-47175"><?= htmlspecialchars($activity['activity'] ?? $activity['description'] ?? 'Activity') ?></p>
                ...
                <div class="d-flex justify-content-between">
                    <?php foreach ($weekDays as $wd): ?>
                        <div class="text-center">
                            ...
                            <small class="text-muted style-56522"><?= $wd['day'] ?></small>
                        </div>
                    <?php endforeach; ?>
                </div>
            </div>
