                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div class="d-flex gap-2 mt-2">
                                            <?php if (!empty($sub['email'])): ?>
                                                <a href="mailto:<?= htmlspecialchars($sub['email'] ?? '') ?>" class="btn btn-sm btn-outline-primary py-0 px-2"><i class="fas fa-envelope"></i></a>
                                            <?php endif; ?>
                                            <?php if (!empty($sub['phone'])): ?>
                                                <a href="tel:<?= htmlspecialchars($sub['phone'] ?? '') ?>" class="btn btn-sm btn-outline-success py-0 px-2"><i class="fas fa-phone"></i></a>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
