            ...
            <div class="row align-items-center mb-5 pb-4">
                ...
                <div class="col-lg-5 mt-5 mt-lg-0">
                    <div class="card border-0 shadow-lg rounded-4 overflow-hidden">
                        <img loading="lazy" src="<?= get_asset_url('amenities/1.jpg', 'images') ?>" class="img-fluid" alt="Budha City Kushinagar">
                    ...
                    <?php foreach ($amenities as $amenity): ?>
                        <div class="col-lg-3 col-md-6">
                            <div class="card border-0 shadow-sm rounded-4 overflow-hidden hover-lift h-100">
                                <img loading="lazy" src="<?= get_asset_url($amenity['image'], 'images') ?>" class="card-img-top" alt="<?= h($amenity['alt_text']) ?>" style="height: 200px; object-fit: cover;">
