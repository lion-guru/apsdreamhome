...
<div class="row">
    <div class="col-lg-12">
        <div class="page-banner mb-5 style-23579">
        ...
        <div class="container py-5">
            <div class="row align-items-center mb-5">
                ...
                <div class="col-lg-6">
                    <img src="<?= BASE_URL ?>/assets/images/projects/gorakhpur/suryoday.jpg" alt="Ganga Nagri" class="img-fluid rounded-4 shadow-lg" />
                </div>
            </div>
                    ...
                    <div class="row g-4 justify-content-center">
                        ...
                        <div class="col-6 col-md-4 col-lg-3 text-center">
                            <div class="card h-100 border-0 shadow-sm p-4">
                                <div class="mb-3">
                                    <img src="<?= BASE_URL ?>/images/<?= htmlspecialchars($item['image'] ?? '') ?>" alt="<?= htmlspecialchars($item['alt_text'] ?? '') ?>" class="img-fluid style-90188">
                                </div>
