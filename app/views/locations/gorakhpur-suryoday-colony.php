...
<div class="row">
    <div class="col-lg-12">
        <div class="hero-section-project">
            <div class="container">
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <!-- Contact Sidebar -->
                <div class="col-lg-5">
                    <div class="card shadow-lg border-0 rounded-4 p-4 sticky-top">
                ...
                <div class="col-6 col-md-3 mb-4">
                    <div class="card h-100 border-0 shadow-sm text-center p-4">
                        <div class="amenity-icon mb-3">
                            <img src="<?= BASE_URL ?>/images/<?= htmlspecialchars($amenity['image'] ?? '') ?>" alt="<?= htmlspecialchars($amenity['title'] ?? '') ?>" class="img-fluid">
                        </div>
