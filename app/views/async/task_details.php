                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <div class="progress" style="height: 20px;">
                            <div class="progress-bar bg-primary" role="progressbar" style="width: <?= (int)($task['progress_percentage'] ?? 0) ?>%" aria-valuenow="<?= (int)($task['progress_percentage'] ?? 0) ?>" aria-valuemin="0" aria-valuemax="100">
