    ...
    <div class="row g-3 mb-4">
        <div class="col-6 col-md-3">
            <div class="doc-stat-card bg-white border">
                <div class="doc-stat-icon" style="background:#dbeafe;color:#2563eb;"><i class="fas fa-folder"></i></div>
        ...
        <div class="col-6 col-md-3">
            <div class="doc-stat-card bg-white border">
                <div class="doc-stat-icon" style="background:#fef3c7;color:#d97706;"><i class="fas fa-clock"></i></div>
        ...
        <div class="col-6 col-md-3">
            <div class="doc-stat-card bg-white border">
                <div class="doc-stat-icon" style="background:#dcfce7;color:#15803d;"><i class="fas fa-check-circle"></i></div>
        ...
        <div class="col-6 col-md-3">
            <div class="doc-stat-card bg-white border">
                <div class="doc-stat-icon" style="background:#fee2e2;color:#dc2626;"><i class="fas fa-times-circle"></i></div>
    ...
    <div class="card border-0 shadow-sm">
        ...
        <div class="card-body p-0">
            ...
            <div class="text-center py-5">
                <i class="fas fa-folder-open fa-4x text-muted mb-3" style="opacity:.15"></i>
                        ...
                        <tr class="doc-row">
                            <td>
                                <div class="d-flex align-items-center gap-2">
                                    <div class="doc-icon-box" style="background:<?= $typeInfo['color'] === 'primary' ? '#dbeafe' : ($typeInfo['color'] === 'success' ? '#dcfce7' : '#f3f4f6') ?>;">
                                        <i class="fas <?= $typeInfo['icon'] ?>" style="color:<?= $typeInfo['color'] === 'primary' ? '#2563eb' : ($typeInfo['color'] === 'success' ? '#15803d' : '#6b7280') ?>;"></i>
                                    </div>
