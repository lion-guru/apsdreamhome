                ...
                <?php endif; ?>
                        <div class="event-list-item <?= $isVisit ? 'site_visit' : '' ?> <?= $isPast && ($event['status'] ?? '') !== 'completed' ? 'overdue' : '' ?>">
                            <div class="d-flex align-items-center gap-2">
                                <div class="rounded-circle d-flex align-items-center justify-content-center" style="width:35px;height:35px;background:<?= $isVisit ? '#fef3c7' : ($isToday ? '#dbeafe' : '#f3f4f6') ?>;">
