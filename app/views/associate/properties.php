        ...
        <div class="row g-3">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card border-0 shadow-sm h-100">
                    ...
                    <?php else: ?>
                        <div class="card-img-top d-flex align-items-center justify-content-center style-8293">
                    ...
                    <div class="card-body">
                        ...
                        <div class="fw-bold text-primary mb-1 style-88102">₹<?= number_format($p['price'] ?? 0) ?></div>
