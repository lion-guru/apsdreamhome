            ...
            <div class="nav-right">
                ...
                <div class="dropdown">
                    <div class="user-box" data-bs-toggle="dropdown">
                        ...
                        <div>
                            <div style="font-size:.85rem;font-weight:600;color:#1e293b"><?php echo htmlspecialchars($associate_name); ?></div>
                            <div style="font-size:.7rem;color:#64748b"><?php echo htmlspecialchars($associate_email); ?></div>
                        </div>
