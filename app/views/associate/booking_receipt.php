            ...
            <div class="row g-4">
                <div class="col-md-6">
                    ...
                    <table class="table table-sm table-borderless">
                        <tr><td class="text-muted"><?= __('assoc_br_property', [], 'Property') ?></td><td><strong><?= htmlspecialchars($booking['property_title'] ?? __('assoc_br_na', [], 'N/A')) ?></strong></td></tr>
                ...
                <div class="col-md-6">
                    ...
                    <table class="table table-sm table-borderless">
                        <tr><td class="text-muted"><?= __('assoc_br_name', [], 'Name') ?></td><td><strong><?= htmlspecialchars($booking['customer_name'] ?? __('assoc_br_na', [], 'N/A')) ?></strong></td></tr>
