    ...
    <div class="col-6 col-lg-3">
        <div class="stat-card-glass">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <div class="stat-value"><?= number_format($directReferrals) ?></div>
    ...
    <div class="col-6 col-lg-3">
        <div class="stat-card-glass">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <div class="stat-value">₹<?= number_format($monthEarnings) ?></div>
    ...
    <div class="col-6 col-lg-3">
        <div class="stat-card-glass">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <div class="stat-value"><?= number_format($activeLeads) ?></div>
...
<div class="row mb-4">
    <div class="col-12">
        <div class="list-card border-0 shadow-lg position-relative overflow-hidden">
    ...
    <div class="col-lg-8">
        <div class="list-card h-100">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h5 class="fw-bold m-0"><i class="fas fa-network-wired text-primary me-2"></i>Network Overview</h5>
                ...
                <?php foreach ($network as $level): ?>
                    <div class="list-item-row border-bottom">
                        <div>
                            ...
                            <span class="fw-bold"><?= e($level['members'] ?? 0) ?> members</span>
                        </div>
                        <div class="text-end">
            ...
            <?php if (!empty($commissions)): ?>
                <?php foreach (array_slice($commissions, 0, 5) as $c): ?>
                    <div class="list-item-row px-0">
                        <div>
                            <div class="fw-bold"><?= htmlspecialchars($c['commission_type'] ?? 'Commission') ?></div>
