        ...
        <div class="col-lg-8">
            ...
            <div class="card border-0 shadow-sm mt-4">
                ...
                <div class="card-body text-center">
                    <img src="<?php echo $base . '/' . ltrim($c['receipt_photo'], '/');?>" alt="Receipt" class="img-fluid rounded">
                </div>
            </div>
            <?php endif; ?>
            ...
            <div class="mt-4 text-center">
                <a href="<?php echo e($base); ?>/associate/collections" class="btn btn-outline-secondary">
                    <i class="fas fa-arrow-left me-1"></i>Back to Collections
                </a>
            </div>
        </div>
