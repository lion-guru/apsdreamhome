...
<div class="container-fluid px-4 py-3">
    ...
    <div class="modern-header flex-wrap gap-3">
        <div>
            <h4 class="mb-1 fw-bold"><i class="fas fa-users text-primary me-2"></i><?= __('assoc_team_title', [], 'My Team') ?></h4>
        ...
        <div class="px-4 py-4 border-bottom d-flex flex-wrap justify-content-between align-items-center gap-3 bg-white">
            ...
            <div class="d-flex gap-3">
                <div class="input-group input-group-sm rounded-pill overflow-hidden shadow-sm border">
                    ...
                    <input type="text" id="teamSearch" class="form-control border-0 shadow-none" placeholder="<?= __('assoc_team_search', [], 'Search by name...') ?>" autocomplete="off" >
                </div>
