...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
        ...
        <div>
            <input type="text" id="searchCustomer" class="form-control form-control-sm" placeholder="<?= __('assoc_cust_search', [], 'Search customers...') ?>" oninput="filterCustomers()">
        </div>
    </div>
    <div class="card-body">
            ...
            <div class="row g-3" id="customerList">
                <?php foreach ($customers as $c): ?>
                    ...
                    <div class="col-md-6 col-lg-4 customer-card" data-name="<?= e(strtolower($c['name'] ?? '')) ?>" data-phone="<?= e($c['phone'] ?? '') ?>">
                        <div class="card border h-100 <?= $isAssociate ? 'border-success' : '' ?>">
                            <div class="card-body">
