...
<div class="container-fluid py-4">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="glass-card genealogy-container p-0 overflow-hidden">
                <div id="tree-loading" class="position-absolute w-100 h-100 d-flex align-items-center justify-content-center bg-dark bg-opacity-25">
                ...
                <div class="tree-overlay position-absolute bottom-0 end-0 p-3">
                    <div class="glass-card p-2 d-flex flex-column gap-2">
                        <div class="d-flex align-items-center gap-2 small text-white">
                            <span class="badge bg-primary rounded-circle p-1"></span> Active
                        </div>
                        <div class="d-flex align-items-center gap-2 small text-white">
                            <span class="badge bg-danger rounded-circle p-1"></span> Inactive
                        </div>
                    </div>
                </div>
            </div>
