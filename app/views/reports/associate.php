...
<?php $associates = $associates ?? []; $summary = $summary ?? ['total' => 0, 'active' => 0, 'total_commission' => 0, 'total_sales' => 0]; ?>
<div class="container-fluid py-4">
    ...
    <div class="row g-3 mb-4">
        <div class="col-md-3"><div class="card border-0 shadow-sm"><div class="card-body text-center"><small class="text-muted">Total Associates</small><h4 class="mb-0"><?= number_format($summary['total'] ?? 0) ?></h4></div></div></div>
