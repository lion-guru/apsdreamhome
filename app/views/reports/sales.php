...
<div class="container-fluid py-4">
    ...
    <div class="row g-3 mb-4">
        <div class="col-md-3"><div class="card border-0 shadow-sm"><div class="card-body text-center"><small class="text-muted">Total Revenue</small><h4 class="text-success mb-0">₹<?= number_format($summary['total_revenue'] ?? 0) ?></h4></div></div></div>
        ...
        <div class="col-md-3"><div class="card border-0 shadow-sm"><div class="card-body text-center"><small class="text-muted">Avg. Value</small><h4 class="text-info mb-0">₹<?= number_format($summary['avg_value'] ?? 0) ?></h4></div></div></div>
    ...
    <div class="row g-4">
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm"><div class="card-header bg-white"><h6 class="mb-0"><i class="fas fa-chart-bar me-2"></i>Revenue Trend</h6></div><div class="card-body aps-cp-card-body"><div class="bg-light rounded d-flex align-items-center justify-content-center" style="min-height:300px"><p class="text-muted mb-0"><i class="fas fa-chart-simple me-2"></i>Chart will render here</p></div></div></div>
        </div>
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm"><div class="card-header bg-white"><h6 class="mb-0"><i class="fas fa-chart-pie me-2"></i>By Category</h6></div><div class="card-body aps-cp-card-body"><div class="bg-light rounded d-flex align-items-center justify-content-center" style="min-height:300px"><p class="text-muted mb-0"><i class="fas fa-chart-pie me-2"></i>Pie chart placeholder</p></div></div></div>
        </div>
    </div>
