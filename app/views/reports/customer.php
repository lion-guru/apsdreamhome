...
<?php $customers = $customers ?? []; $summary = $summary ?? ['total' => 0, 'new_this_month' => 0, 'active' => 0, 'total_purchases' => 0]; ?>
<div class="container-fluid py-4">
    ...
    <div class="row g-3 mb-4">
        <div class="col-md-3"><div class="card border-0 shadow-sm"><div class="card-body text-center"><small class="text-muted">Total Customers</small><h4 class="mb-0"><?= number_format($summary['total'] ?? 0) ?></h4></div></div></div>
        ...
        <div class="col-md-3"><div class="card border-0 shadow-sm"><div class="card-body text-center"><small class="text-muted">Active Customers</small><h4 class="text-info mb-0"><?= number_format($summary['active'] ?? 0) ?></h4></div></div></div>
