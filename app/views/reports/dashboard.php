...
<div class="container-fluid py-4">
    ...
    <div class="row g-3 mb-4">
        <div class="col-md-3"><div class="card border-0 shadow-sm"><div class="card-body"><div class="d-flex justify-content-between"><div><small class="text-muted text-uppercase fw-bold">Total Reports</small><h3 class="mb-0 mt-1"><?= $stats['total_reports'] ?? 0 ?></h3></div><div class="bg-primary-subtle p-3 rounded"><i class="fas fa-file-alt fa-2x text-primary"></i></div></div></div></div></div>
        <div class="col-md-3"><div class="card border-0 shadow-sm"><div class="card-body"><div class="d-flex justify-content-between"><div><small class="text-muted text-uppercase fw-bold">Scheduled</small><h3 class="mb-0 mt-1"><?= $stats['scheduled'] ?? 0 ?></h3></div><div class="bg-warning-subtle p-3 rounded"><i class="fas fa-clock fa-2x text-warning"></i></div></div></div></div></div>
        <div class="col-md-3"><div class="card border-0 shadow-sm"><div class="card-body"><div class="d-flex justify-content-between"><div><small class="text-muted text-uppercase fw-bold">Sales Reports</small><h3 class="mb-0 mt-1"><?= $stats['sales'] ?? 0 ?></h3></div><div class="bg-success-subtle p-3 rounded"><i class="fas fa-chart-line fa-2x text-success"></i></div></div></div></div></div>
        <div class="col-md-3"><div class="card border-0 shadow-sm"><div class="card-body"><div class="d-flex justify-content-between"><div><small class="text-muted text-uppercase fw-bold">Property Reports</small><h3 class="mb-0 mt-1"><?= $stats['properties'] ?? 0 ?></h3></div><div class="bg-info-subtle p-3 rounded"><i class="fas fa-building fa-2x text-info"></i></div></div></div></div></div>
    </div>
    <div class="row g-4">
