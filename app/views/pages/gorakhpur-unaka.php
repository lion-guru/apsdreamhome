...
$startingPrice = "₹9,00,000";
$projectArea = "30 Acres";
$totalUnits = "250";
$possessionDate = "March 2025";

// Project description
$projectDescription = "Unaka is an upcoming premium residential plot project in Gorakhpur, offering modern infrastructure and excellent connectivity. The project is designed to provide a perfect blend of urban convenience and peaceful living environment.";

// Meta description for SEO
$metaDescription = "Unaka - Upcoming residential plots in Gorakhpur by APS Dream Homes. Starting at ₹9,00,000. Modern infrastructure and excellent connectivity.";
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style>
        .project-hero {
            background: linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), 
                        url('assets/images/projects/gorakhpur/unaka-banner.jpg');
...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 mx-auto text-center">
                    ...
                    <p class="lead mb-4">Upcoming Premium Residential Plots</p>
                ...
                <div class="col-lg-8 mb-4">
                    <div class="card border-0 shadow-sm mb-4">
                        <div class="card-body">
                            ...
                            <h3 class="mt-5 mb-4">Planned Amenities</h3>
                            <div class="row">
                                <div class="col-md-6">
                    ...
                    <div class="project-highlight sticky-top" style="top: 100px;">
                        ...
                        <div class="d-grid gap-2 mt-4">
                            <button class="btn btn-primary btn-lg" data-bs-toggle="modal" data-bs-target="#enquiryModal">
                                <i class="fas fa-phone-alt me-2"></i> Get Early Bird Offer
                            </button>
                            <a href="#" class="btn btn-outline-primary">
                                <i class="fas fa-info-circle me-2"></i> More Information
                            </a>
                        </div>
                        
                        <div class="mt-4">
                            <h5>Register Interest:</h5>
                            <p class="text-muted small">Be the first to know about launch details and special offers</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="enquiryModalLabel">Register Interest for <?php echo $projectName; ?></h5>
                ...
                <div class="modal-body">
                    <form id="enquiryForm">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="message" name="message" rows="3">I'm interested in <?php echo $projectName; ?> and would like to receive early bird offers and launch details.</textarea>
                        </div>
    ...
    <script>
        ...
        document.getElementById('enquiryForm').addEventListener('submit', function(e) {
            e.preventDefault();
            alert('Thank you for registering your interest. We will contact you with launch details.');
