...
<section class="py-5">
    <div class="container">
        <div class="text-center mb-5">
            <h2 class="fw-bold mb-2">Our Leadership & Team</h2>
            <p class="text-muted">Dedicated professionals working together to deliver exceptional real estate solutions with innovation and integrity.</p>
        </div>
        ...
        <div class="team-grid" id="teamGrid">
            ...
            <div class="team-card" data-category="<?php echo e($catSlug); ?>">
                ...
                <div class="team-card-body">
                    ...
                    <span class="group-badge"><?= htmlspecialchars($m->group_name) ?></span>
                    <?php endif; ?>
                </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 mb-4 mb-lg-0">
                <span class="badge bg-danger bg-opacity-10 text-danger px-3 py-2 mb-3"><i class="fas fa-fist-raised me-2"></i>Nari Shakti</span>
...
<section class="special-section">
    <div class="container">
        <div class="text-center mb-5">
            <span class="badge bg-warning bg-opacity-10 text-warning px-3 py-2 mb-3"><i class="fas fa-trophy me-2"></i>Team Competition</span>
            ...
            <div class="col-md-3">
                <div class="group-card" style="background-color: <?= $bgColor ?>;">
                    ...
                    <div class="d-flex justify-content-between align-items-end mt-3">
                        <div><small >Leader: <?= htmlspecialchars($g['leader_name'] ?? 'TBD') ?></small></div>
                        <div class="text-end">
...
<section class="special-section">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 mb-4 mb-lg-0">
                <span class="badge bg-success bg-opacity-10 text-success px-3 py-2 mb-3"><i class="fas fa-microchip me-2"></i>Tech Powered</span>
                ...
                <div class="row g-3 mt-2">
                    <div class="col-md-6">
                        <div class="feature-card text-start p-3">
                            <div class="f-icon text-success"><i class="fas fa-robot"></i></div>
                            <h5 >AI Lead Scoring</h5>
                            <p >Smart algorithms score and prioritize leads for maximum conversion.</p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="feature-card text-start p-3">
                            <div class="f-icon text-primary"><i class="fas fa-phone-volume"></i></div>
                            <h5 >AI Voice Agents</h5>
                            <p >Automated calling, follow-ups, and lead nurturing 24/7.</p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="feature-card text-start p-3">
                            <div class="f-icon text-warning"><i class="fas fa-chart-bar"></i></div>
                            <h5 >Price Prediction</h5>
                            <p >ML models predict optimal pricing for properties and plots.</p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="feature-card text-start p-3">
                            <div class="f-icon text-info"><i class="fas fa-calculator"></i></div>
                            <h5 >Smart Calculators</h5>
                            <p >EMI, stamp duty, loan eligibility — all AI-powered.</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="bg-white rounded-4 shadow-sm p-4">
                    ...
                    <div class="d-flex flex-wrap gap-2 mb-4">
                        ...
                        <span class="badge bg-purple">Flutter</span>
                    </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-5 mb-4 mb-lg-0">
                <span class="badge bg-primary bg-opacity-10 text-primary px-3 py-2 mb-3"><i class="fas fa-graduation-cap me-2"></i>Student Program</span>
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="mb-3 d-flex align-items-start gap-3">
                        <i class="fas fa-clock text-success mt-1"></i>
                    ...
                    <li class="mb-3 d-flex align-items-start gap-3">
                        <i class="fas fa-laptop-code text-info mt-1"></i>
                    ...
                    <li class="mb-3 d-flex align-items-start gap-3">
                        <i class="fas fa-certificate text-warning mt-1"></i>
                ...
                <div class="row g-3">
                    <div class="col-6">
                        <div class="feature-card p-3 text-start">
                            <div class="f-icon text-primary"><i class="fas fa-building"></i></div>
                            <h5 >Rental Listings</h5>
                            <p >Help property owners list rentals. Earn per listing.</p>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="feature-card p-3 text-start">
                            <div class="f-icon text-success"><i class="fas fa-handshake"></i></div>
                            <h5 >Tenant Matching</h5>
                            <p >Connect tenants to properties. Earn referral bonus.</p>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="feature-card p-3 text-start">
                            <div class="f-icon text-warning"><i class="fas fa-bullhorn"></i></div>
                            <h5 >Campus Ambassador</h5>
                            <p >Represent APS on your campus. Earn stipend + incentives.</p>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="feature-card p-3 text-start">
                            <div class="f-icon text-info"><i class="fas fa-robot"></i></div>
                            <h5 >AI Tools Access</h5>
                            <p >Use our AI for lead gen, property matching, more.</p>
                        </div>
                    </div>
                    <div class="col-12">
...
<section class="values-section">
    <div class="container">
        <div class="text-center mb-5">
            ...
            <p class="text-muted">The principles that guide every decision we make and every relationship we build.</p>
        </div>
        <div class="row g-4">
...
<section class="cta-section">
    <div class="container">
        ...
        <div>
            ...
            <a href="tel:<?= $phoneRaw ?>" class="btn-cta mb-2">
