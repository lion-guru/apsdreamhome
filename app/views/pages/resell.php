                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card resell-property-card h-100 shadow-sm border-0 rounded-3 overflow-hidden">
                            <div class="position-relative">
                                ...
                                <img loading="lazy" src="<?= !empty($prop->image) ? get_asset_url($prop->image) : 'https://images.unsplash.com/photo-1568605114967-8130f3a36994?auto=format&fit=crop&w=800&q=80' ?>" class="card-img-top resell-card-img img-fluid" alt="<?= htmlspecialchars($prop->title) ?>">
