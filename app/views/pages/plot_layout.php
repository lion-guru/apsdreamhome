...
<div class="map-container">
    ...
    <div class="map-sidebar">
        ...
        <div class="sidebar-stats" id="sidebarStats">
            ...
            <div class="stat-row"><span class="label"><?= __('plot_stat_available', [], 'Available') ?></span><span class="value" id="statAvail"><?= $total_stats['available'] ?></span></div>
            <div class="stat-row"><span class="label"><?= __('plot_stat_booked', [], 'Booked') ?></span><span class="value" id="statBooked"><?= $total_stats['booked'] ?></span></div>
            <div class="stat-row"><span class="label"><?= __('plot_stat_sold', [], 'Sold') ?></span><span class="value" id="statSold"><?= $total_stats['sold'] ?></span></div>
            <div class="stat-row"><span class="label"><?= __('plot_stat_blocked', [], 'Blocked') ?></span><span class="value" id="statBlocked"><?= $total_stats['blocked'] ?></span></div>
        </div>
    </div>
...
function renderSVG() {
    ...
    colsToShow.forEach(function(colony) {
        ...
        if (!plots || plots.length === 0) {
            html += '<div class="empty-colony"><i class="fas fa-map"></i> No plots in ' + escHtml(colony.name) + '</div>';
            return;
        }
    ...
    var svg = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ' + svgWidth + ' ' + svgHeight + '" width="' + svgWidth + '" height="' + svgHeight + '" >' + html + '</svg>';
...
function showPlotDetail(id) {
    ...
    var body = '<div class="detail-field"><div class="label">Status</div><div class="value"><span class="detail-status-badge">' + status.label + '</span></div></div>';
    ...
    body += '<div class="detail-field"><div class="label">Total Price</div><div class="value">&#8377; ' + formatPrice(plot.total_price) + '</div></div>';
    if (plot.facing) body += '<div class="detail-field"><div class="label">Facing</div><div class="value">' + escHtml(plot.facing) + '</div></div>';
    if (plot.corner_plot == 1) body += '<div class="detail-field"><div class="label">Corner Plot</div><div class="value"><i class="fas fa-check-circle"></i> Yes</div></div>';
    if (plot.park_facing == 1) body += '<div class="detail-field"><div class="label">Park Facing</div><div class="value"><i class="fas fa-check-circle"></i> Yes</div></div>';
