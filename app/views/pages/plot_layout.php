...
<div class="map-container">
    ...
    <div class="map-sidebar">
        ...
        <div class="sidebar-legend">
            ...
            <div class="legend-item"><div class="legend-dot style-6546"></div> Available</div>
            <div class="legend-item"><div class="legend-dot style-6351"></div> Booked / Reserved</div>
            <div class="legend-item"><div class="legend-dot style-68656"></div> Sold</div>
            <div class="legend-item"><div class="legend-dot style-99107"></div> Hold / Other</div>
        </div>
        ...
        <div class="sidebar-stats" id="sidebarStats">
            ...
            <div class="stat-row"><span class="label"><?= __('plot_stat_available', [], 'Available') ?></span><span class="value style-2154" id="statAvail"><?= $total_stats['available'] ?></span></div>
            <div class="stat-row"><span class="label"><?= __('plot_stat_booked', [], 'Booked') ?></span><span class="value style-62735" id="statBooked"><?= $total_stats['booked'] ?></span></div>
            <div class="stat-row"><span class="label"><?= __('plot_stat_sold', [], 'Sold') ?></span><span class="value style-78822" id="statSold"><?= $total_stats['sold'] ?></span></div>
            <div class="stat-row"><span class="label"><?= __('plot_stat_blocked', [], 'Blocked') ?></span><span class="value style-41689" id="statBlocked"><?= $total_stats['blocked'] ?></span></div>
        </div>
    </div>
...
function renderSVG() {
    ...
    colsToShow.forEach(function(colony) {
        ...
        if (!plots || plots.length === 0) {
            html += '<div class="empty-colony"><i class="fas fa-map style-35440"></i> No plots in ' + escHtml(colony.name) + '</div>';
            return;
        }
...
function showPlotDetail(id) {
    ...
    var body = '<div class="detail-field"><div class="label">Status</div><div class="value"><span class="detail-status-badge style-63612">' + status.label + '</span></div></div>';
    ...
    body += '<div class="detail-field"><div class="label">Total Price</div><div class="value style-76270">&#8377; ' + formatPrice(plot.total_price) + '</div></div>';
    if (plot.facing) body += '<div class="detail-field"><div class="label">Facing</div><div class="value">' + escHtml(plot.facing) + '</div></div>';
    if (plot.corner_plot == 1) body += '<div class="detail-field"><div class="label">Corner Plot</div><div class="value style-2154"><i class="fas fa-check-circle"></i> Yes</div></div>';
    if (plot.park_facing == 1) body += '<div class="detail-field"><div class="label">Park Facing</div><div class="value style-2154"><i class="fas fa-check-circle"></i> Yes</div></div>';
