            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    <form method="POST" action="<?= BASE_URL ?>/user/book-site-visit">
                        ...
                        <div class="mb-3">
                            <label class="form-label">Property/Project <span class="text-danger">*</span></label>
                            <select name="property_id" class="form-select" required>
                                ...
                                <option value="0">General inquiry (no specific property)</option>
                            </select>
                        </div>
                        <div class="row">
            ...
            <div class="card shadow-sm bg-light">
                <div class="card-body">
                    ...
                    <ul class="small text-muted ps-3">
                        ...
                        <li class="mb-1">Free pick-up & drop from office</li>
                        <li class="mb-1">Complimentary refreshments</li>
