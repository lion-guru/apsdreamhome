...
<head>
    ...
    <title><?= $page_title ?? 'AI Assistant - APS Dream Home' ?></title>
...
<body>
    <div class="ai-header">
        ...
        <div class="ai-header-actions">
            <a href="<?= BASE_URL ?? '/apsdreamhome' ?>/" class="ai-header-btn" title="Home"><i class="fas fa-home"></i></a>
        </div>
    </div>
    ...
    <script>
        var BASE_URL = '<?= BASE_URL ?? "/apsdreamhome" ?>';
