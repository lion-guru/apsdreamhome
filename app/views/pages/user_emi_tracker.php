...
<div class="aps-cp-hero" style="background: linear-gradient(135deg, #0d9488 0%, #0f766e 100%);">
...
<div class="aps-cp-card mb-4" style="border-left: 4px solid #0d9488; background: linear-gradient(135deg, #ede9fe 0%, #fff 100%);">
    <div class="aps-cp-card-body">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
            <div>
                <h6 class="mb-1" style="color:#0d9488;"><i class="fas fa-bell me-2"></i>Next Payment Due</h6>
