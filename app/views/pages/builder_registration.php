    ...
    if (empty($company_name) || empty($contact_person) || empty($mobile) || empty($email) || empty($password)) {
        ...
        if ($check_stmt->get_result()->num_rows > 0) {
            ...
            if ($stmt->execute()) {
                ...
                $whatsapp_message = "≡ƒÄë Welcome to APS Dream Homes!\n\n";
                $whatsapp_message .= "≡ƒÅù∩╕Å Builder Registration Successful\n";
                $whatsapp_message .= "≡ƒöó Your Builder Code: " . $builder_code . "\n";
                $whatsapp_message .= "≡ƒÅó Company: " . $company_name . "\n";
                $whatsapp_message .= "≡ƒæ¿ΓÇì≡ƒÆ╝ Contact Person: " . $contact_person . "\n";
                $whatsapp_message .= "≡ƒô▒ Mobile: " . $mobile . "\n";
                $whatsapp_message .= "≡ƒôº Email: " . $email . "\n\n";

                $whatsapp_message .= "≡ƒôè Company Details:\n";
                $whatsapp_message .= "≡ƒÅ¬ Type: " . $company_type . "\n";
                $whatsapp_message .= "≡ƒôà Established: " . $established_year . "\n";
                $whatsapp_message .= "≡ƒÅá Total Projects: " . $total_projects . "\n";
                $whatsapp_message .= "≡ƒÜº Ongoing: " . $ongoing_projects . "\n";
                $whatsapp_message .= "≡ƒôì Location: " . $city . ", " . $state . "\n\n";

                $whatsapp_message .= "≡ƒöÉ Your Login Credentials:\n";
                $whatsapp_message .= "Builder Code: " . $builder_code . "\n";
                $whatsapp_message .= "Password: " . $password . "\n\n";

                $whatsapp_message .= "You can login using:\n";
                $whatsapp_message .= "ΓÇó Builder Code + Password\n";
                $whatsapp_message .= "ΓÇó Mobile + Password\n";
                $whatsapp_message .= "ΓÇó Email + Password\n\n";

                $whatsapp_message .= "≡ƒô₧ Contact: +91-9277121112\n";
                $whatsapp_message .= "≡ƒîÉ Portal: http://localhost/apsdreamhome/builder_login.php\n\n";
                $whatsapp_message .= "List your projects and reach thousands of buyers! ≡ƒÅáΓ£¿";
                ...
                <div class="registration-container">
                    ...
                    <div class="p-4">
                        ...
                        <div class="info-box">
                            ...
                            <small>
                                ≡ƒñ¥ Partner with us to showcase your projects<br>
                                ≡ƒÅù∩╕Å List new developments and under-construction properties<br>
                                ≡ƒÅá Reach thousands of potential buyers<br>
                                ≡ƒÆ░ Competitive commission structure<br>
                                ≡ƒôè Advanced analytics and lead management
                            </small>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="text-center">
                                        <h5 class="text-success">≡ƒÄ» Premium Visibility</h5>
                                ...
                                <div class="col-md-4">
                                    <div class="text-center">
                                        <h5 class="text-primary">≡ƒôê Lead Generation</h5>
                                ...
                                <div class="col-md-4">
                                    <div class="text-center">
                                        <h5 class="text-warning">≡ƒÆ╝ Marketing Support</h5>
