                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card border-0 shadow-sm rounded-4 overflow-hidden h-100">
                        <?php if (!empty($fav['image'])): ?>
                            <img src="<?= BASE_URL ?>/assets/images/properties/<?= htmlspecialchars($fav['image']) ?>" class="card-img-top" alt="<?= htmlspecialchars($fav['title'] ?? 'Property') ?>" style="height: 180px; object-fit: cover;">
                        <?php else: ?>
