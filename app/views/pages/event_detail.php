<div class="container mt-4">
    <nav aria-label="breadcrumb"><ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?php echo BASE_URL; ?>/event-calendar">Events</a></li>
    ...
    <a href="<?php echo BASE_URL; ?>/event-calendar" class="btn btn-secondary mt-3">&larr; Back to Events</a>
</div>
