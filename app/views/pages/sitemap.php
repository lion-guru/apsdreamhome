        ...
        <div class="row g-4">
            ...
            <div class="col-md-4">
                <div class="card border-0 shadow-sm h-100 rounded-4 overflow-hidden">
                    ...
                    <div class="card-body aps-cp-card-body">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item border-0"><a href="<?= BASE_URL ?>/privacy" class="text-decoration-none text-dark d-block py-1 hover-premium"><i class="fas fa-chevron-right small me-2 text-premium"></i> <?= __('sitemap_privacy_policy') ?></a></li>
