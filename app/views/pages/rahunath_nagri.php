...
$startingPrice = "Γé╣7,50,000";
$projectArea = "25 Acres";
$totalUnits = "600";
$possessionDate = "December 2026";

// Project description
$projectDescription = "Raghunath Nagri is a premium residential plot project located in the rapidly developing area of Gorakhpur. This project offers meticulously planned plots with modern infrastructure, excellent connectivity, and all essential amenities. Perfect for those looking to build their dream home or make a sound investment.";

// Meta description for SEO
$metaDescription = "Raghunath Nagri - Premium residential plots in Gorakhpur by APS Dream Homes. Starting at Γé╣8,50,000. Modern infrastructure, excellent connectivity, and all essential amenities.";
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style>
        .project-hero {
            background: linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), 
                        url('assets/images/projects/gorakhpur/minua-banner.jpg');
                ...
                <div class="col-lg-8 mb-4">
                    <div class="card border-0 shadow-sm mb-4">
                        <div class="card-body">
                            ...
                            <h3 class="mt-5 mb-4">Location Advantages</h3>
                            <ul class="amenities-list">
                                <li>Close proximity to Gorakhpur city center</li>
                                <li>Excellent connectivity to major highways</li>
                                <li>Nearby educational institutions and hospitals</li>
                                <li>Easy access to markets and shopping centers</li>
