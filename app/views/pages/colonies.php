...
$page_description = 'Explore APS Dream Homes premium colonies and real estate projects in Gorakhpur, Lucknow and across Uttar Pradesh';
...
$js_assets = [
    ...
    ['url' => '/assets/js/colony-showcase.js', 'defer' => true, 'async' => true]
];
