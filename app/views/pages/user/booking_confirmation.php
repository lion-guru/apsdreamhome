<?php
$page_title = $page_title ?? 'Booking Confirmed';
...
<div class="aps-cp-hero">
    <div class="row align-items-center">
        <div class="col-md-8">
            <h2><i class="fas fa-file-contract me-2"></i>Booking Confirmation</h2>
            <p>Review your plot booking details and next steps.</p>
        </div>
...
<div class="aps-cp-card">
    <div class="aps-cp-card-body">
        <div class="aps-cp-empty">
            ...
            <p>The booking you are looking for does not exist or you do not have access to it.</p>
            <a href="<?= BASE_URL ?>/user/bookings" class="btn btn-primary"><i class="fas fa-list me-2"></i>Go to My Bookings</a>
        </div>
    </div>
</div>
<?php else: ?>
...
<div class="row justify-content-center">
    <div class="col-lg-8">
        ...
        <div class="text-center mb-4">
            ...
            <h4 class="fw-bold">Booking <?= htmlspecialchars($statusLabels[$bStatus] ?? ucfirst(str_replace('_', ' ', $bStatus))) ?></h4>
            <p class="text-muted">Your booking number is <strong><?= htmlspecialchars($booking['booking_number'] ?? '') ?></strong></p>
            <?php else: ?>
            ...
            <h4 class="fw-bold">Booking Status: <?= htmlspecialchars($statusLabels[$bStatus] ?? ucfirst($bStatus)) ?></h4>
            <?php endif; ?>
        </div>

        <div class="aps-cp-card mb-4">
            <div class="aps-cp-card-header">
                <h5 class="mb-0"><i class="fas fa-map-marker-alt text-primary me-2"></i>Plot Details</h5>
            ...
            <div class="aps-cp-card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <div class="bg-light rounded-3 p-3 h-100">
                            <h6 class="text-muted small mb-2">PLOT INFO</h6>
                            <p class="mb-1"><strong>Plot #<?= htmlspecialchars($booking['plot_number'] ?? 'N/A') ?></strong> &middot; Block <?= htmlspecialchars($booking['block'] ?? 'N/A') ?></p>
                            <p class="mb-0 text-muted">
                                ...
                                <?php if (!empty($booking['facing'])): ?>
                                    &middot; <?= htmlspecialchars($booking['facing']) ?> facing
                                <?php endif; ?>
                            </p>
                        </div>
                    </div>
        ...
        <div class="aps-cp-card mb-4">
            <div class="aps-cp-card-header">
                <h5 class="mb-0"><i class="fas fa-receipt text-success me-2"></i>Booking Summary</h5>
            </div>
            <div class="aps-cp-card-body">
                <div class="row g-3">
        ...
        <div class="aps-cp-card mb-4">
            <div class="aps-cp-card-header">
                <h5 class="mb-0"><i class="fas fa-list-check text-info me-2"></i>Next Steps</h5>
            </div>
            <div class="aps-cp-card-body">
                <div class="d-flex flex-column gap-3">
                    ...
                    <div class="d-flex align-items-start gap-3 p-3 bg-light rounded-3">
                        ...
                        <div class="flex-grow-1">
                            <h6 class="mb-1">Sign Agreement</h6>
                            <p class="text-muted small mb-0">Visit our office or schedule a call to complete the agreement process.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="aps-cp-card mb-4">
            <div class="aps-cp-card-header">
                <h5 class="mb-0"><i class="fas fa-sticky-note text-warning me-2"></i>Notes</h5>
            </div>
            <div class="aps-cp-card-body">
        ...
        <div class="text-center mb-4">
            ...
            <a href="<?= BASE_URL ?>/user/bookings/new" class="btn btn-primary">
                <i class="fas fa-plus me-2"></i>Book Another Plot
            </a>
        </div>
