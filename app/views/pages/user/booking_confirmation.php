...
<div class="row justify-content-center">
    <div class="col-lg-8">
        ...
        <div class="text-center mb-4">
            ...
            <div class="d-inline-flex align-items-center justify-content-center rounded-circle bg-<?= $bColor ?> bg-opacity-10 mb-3 style-61938">
            ...
            <?php else: ?>
            <div class="d-inline-flex align-items-center justify-content-center rounded-circle bg-secondary bg-opacity-10 mb-3 style-61938">
            ...
            <div class="aps-cp-card-body">
                <div class="d-flex flex-column gap-3">
                    <div class="d-flex align-items-start gap-3 p-3 bg-light rounded-3">
                        <div class="aps-cp-stat-icon flex-shrink-0 style-18663">
                    ...
                    <div class="d-flex align-items-start gap-3 p-3 bg-light rounded-3">
                        <div class="aps-cp-stat-icon flex-shrink-0 style-18807">
                    ...
                    <div class="d-flex align-items-start gap-3 p-3 bg-light rounded-3">
                        <div class="aps-cp-stat-icon flex-shrink-0 style-12298">
