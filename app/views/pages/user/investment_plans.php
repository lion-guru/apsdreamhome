    ...
    <div class="aps-cp-card-body">
        <div class="aps-cp-flex-between">
            <div>
                ...
                <h3 class="mt-0"><i class="fas fa-trophy"></i> <span class="aps-cp-badge aps-cp-badge-<?= $levelColor ?> aps-cp-badge-lg"><?= htmlspecialchars($stats['level'] ?? '') ?></span></h3>
            </div>
            <div >
...
<div id="investModal" class="aps-cp-modal">
