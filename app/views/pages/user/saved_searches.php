        ...
        <div class="card-body aps-cp-card-body">
            <?php if (empty($searches)): ?>
                <div class="text-center py-5">
                    ...
                    <p class="text-muted mx-auto"><?= __('saved_empty_desc', null, 'Apply filters on the properties page and click "Save this search" to get notified when new properties match your criteria.') ?></p>
