    ...
    <div class="col-12">
        <div class="d-flex align-items-center gap-3">
            <div class="d-flex align-items-center gap-2 <?= $selectedColony > 0 ? 'text-success' : 'text-primary' ?>">
                <span class="badge rounded-pill bg-<?= $selectedColony > 0 ? 'success' : 'primary' ?> d-inline-flex align-items-center justify-content-center">1</span>
            ...
            <div class="d-flex align-items-center gap-2 <?= !empty($_GET['plot_id']) ? 'text-success' : 'text-muted' ?>">
                <span class="badge rounded-pill bg-<?= !empty($_GET['plot_id']) ? 'success' : 'secondary' ?> d-inline-flex align-items-center justify-content-center">2</span>
                <span class="fw-semibold"><?= __('user_new_booking_step_choose_plot', 'Choose Plot') ?></span>
            </div>
            <i class="fas fa-chevron-right text-muted"></i>
            <div class="d-flex align-items-center gap-2 text-muted">
                <span class="badge rounded-pill bg-secondary d-inline-flex align-items-center justify-content-center">3</span>
