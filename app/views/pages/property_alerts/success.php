...
<section class="py-5" style="background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #fff;">
    <div class="container text-center py-5">
        ...
        <p class="lead mb-4">Your property alert has been created successfully</p>
        <p class="mb-4 opacity-75">We'll send notifications to <strong><?= htmlspecialchars($email ?? '') ?></strong></p>
    </div>
</section>
        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm">
                <div class="card-body p-5 text-center">
                    ...
                    <p class="text-muted mb-4">Your subscription ID is <strong>#<?= $subscription_id ?? 'N/A' ?></strong></p>
                    <div class="row g-4">
                        <div class="col-md-4">
                            <div class="text-primary mb-2"><i class="fas fa-search fa-2x"></i></div>
                            <h6>1. We Search</h6>
                            <p class="text-muted small">We monitor new property listings matching your criteria</p>
                        </div>
                        <div class="col-md-4">
                            <div class="text-warning mb-2"><i class="fas fa-bell fa-2x"></i></div>
                            <h6>2. We Notify</h6>
                            <p class="text-muted small">You'll receive alerts via your selected channels</p>
                        </div>
                        <div class="col-md-4">
                            <div class="text-success mb-2"><i class="fas fa-home fa-2x"></i></div>
                            <h6>3. You Choose</h6>
                            <p class="text-muted small">View, save, and contact sellers directly</p>
                        </div>
                    </div>
                    <div class="d-flex gap-3 justify-content-center mt-4">
                        ...
                        <a href="<?= BASE_URL ?>/property-alerts/subscribe" class="btn btn-outline-primary">
                            <i class="fas fa-plus me-1"></i> Create Another Alert
                        </a>
                    </div>
                </div>
            </div>
