        ...
        <div class="row g-3 g-md-4 mb-5">
            <div class="col-md-3 col-6">
                <div class="invest-card" style="border-top:4px solid #10b981;">
                    ...
                    <span class="badge" style="background:#10b981;color:#fff;">⭐ Best Investment</span>
                </div>
            </div>
            <div class="col-md-3 col-6">
                ...
                <div class="career-card">
                    <div class="card-body p-4 text-center">
                        ...
                        <div class="bg-light rounded-3 p-3 mt-3" style="max-height:160px;overflow-y:auto;">
                            <div class="small mb-1"><span class="text-warning me-1">👑</span>Associate: <strong>5%</strong></div>
                            <div class="small mb-1"><span class="text-secondary me-1">👑</span>Bronze: <strong>7%</strong></div>
                            <div class="small mb-1"><span class="text-secondary me-1">👑</span>Silver: <strong>10%</strong></div>
                            <div class="small mb-1"><span class="text-warning me-1">👑</span>Gold: <strong>12.5%</strong></div>
                            <div class="small mb-1"><span class="text-info me-1">👑</span>Platinum: <strong>15%</strong></div>
                            <div class="small mb-1"><span class="text-primary me-1">👑</span>Diamond: <strong>18%</strong></div>
                            <div class="small mb-1"><span class="text-success me-1">👑</span>Executive: <strong>20%</strong></div>
                            <div class="small mb-1"><span class="text-success me-1">👑</span>Sr. Executive: <strong>22%</strong></div>
                            <div class="small mb-1"><span class="text-danger me-1">👑</span>Director: <strong>25%</strong></div>
                            <div class="small"><span class="text-danger me-1">👑</span>Global Director: <strong>30%</strong></div>
                        </div>
                    </div>
                </div>
            </div>
