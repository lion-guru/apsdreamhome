...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($full_name) || empty($mobile) || empty($email) || empty($property_id)) {
        ...
        if ($booking_stmt->execute()) {
            ...
            $whatsapp_message = "≡ƒÄë Booking Confirmed!\n\n";
            $whatsapp_message .= "≡ƒôï Booking ID: BK" . str_pad($booking_id, 6, '0', STR_PAD_LEFT) . "\n";
            $whatsapp_message .= "≡ƒÅá Property ID: " . $property_id . "\n";
            $whatsapp_message .= "≡ƒæñ Customer: " . $full_name . "\n";
            $whatsapp_message .= "≡ƒô▒ Mobile: " . $mobile . "\n";
            $whatsapp_message .= "≡ƒôº Email: " . $email . "\n";
            $whatsapp_message .= "≡ƒôà Visit Date: " . date('d M Y', strtotime($visit_date)) . "\n";
            $whatsapp_message .= "≡ƒòÉ Visit Time: " . $visit_time . "\n\n";
            ...
            $whatsapp_message .= "ΓÇó Customer ID + Password\n";
            $whatsapp_message .= "ΓÇó Mobile Number + Password\n";
                ...
                <div class="booking-container">
                    ...
                    <div class="p-4">
                            ...
                            <div class="property-card">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <strong>Price:</strong> Γé╣<?php echo number_format($property['price']); ?>
                                    </div>
                                    <div class="col-md-6">
                        ...
                        <div class="info-box">
                            ...
                            <small>
                                ≡ƒô¥ Fill out the form below to schedule your property visit<br>
                                ≡ƒô▒ You'll receive instant confirmation via WhatsApp<br>
                                ≡ƒöÉ Auto-generated login credentials will be sent to you<br>
                                ≡ƒô₧ Our team will contact you to confirm the visit details
                            </small>
                        </div>
                        ...
                        <div class="whatsapp-info">
                            ...
                            <small>
                                Γ£à Instant booking confirmation<br>
                                Γ£à Complete property details<br>
                                Γ£à Your login credentials<br>
                                Γ£à Visit reminders and updates<br>
                                Γ£à 24/7 customer support
                            </small>
                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" name="budget_range">
                                            ...
                                            <option value="20-50L">Γé╣20L - Γé╣50L</option>
                                            <option value="50L-1Cr">Γé╣50L - Γé╣1Cr</option>
                                            <option value="1Cr-2Cr">Γé╣1Cr - Γé╣2Cr</option>
                                            <option value="2Cr+">Γé╣2Cr+</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
