...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($full_name) || empty($mobile) || empty($email) || empty($property_title) || empty($price)) {
        ...
        if ($property_stmt->execute()) {
            ...
            $whatsapp_message = "≡ƒÅá Property Listing Submitted Successfully!\n\n";
            $whatsapp_message .= "≡ƒæñ Seller: " . $full_name . "\n";
            $whatsapp_message .= "≡ƒô▒ Mobile: " . $mobile . "\n";
            $whatsapp_message .= "≡ƒôº Email: " . $email . "\n\n";

            $whatsapp_message .= "≡ƒÅí Property Details:\n";
            $whatsapp_message .= "≡ƒôï Title: " . $property_title . "\n";
            $whatsapp_message .= "≡ƒÅ╖∩╕Å Type: " . ucfirst($property_type) . "\n";
            $whatsapp_message .= "≡ƒÆ░ Price: Γé╣" . number_format($price) . "\n";
            $whatsapp_message .= "≡ƒôì Location: " . $address . ", " . $city . ", " . $state . "\n\n";

            if (!empty($uploaded_images)) {
                $whatsapp_message .= "≡ƒô╕ Images Uploaded: " . count($uploaded_images) . "\n";
            }

            $whatsapp_message .= "Γ£à Your property is under review\n";
                ...
                <div class="listing-container">
                    ...
                    <div class="p-4">
                        ...
                        <div class="info-box">
                            ...
                            <small>
                                ≡ƒÅá List your property for free on our platform<br>
                                ≡ƒô▒ Get direct inquiries from verified buyers<br>
                                ≡ƒÆ░ Sell faster with our extensive network<br>
                                ≡ƒôè Track views and inquiries in real-time<br>
                                Γ£à Properties are reviewed before going live
                            </small>
                        </div>
                        ...
                        <div class="whatsapp-info">
                            ...
                            <small>
                                Γ£à Instant listing confirmation<br>
                                Γ£à Property status updates<br>
                                Γ£à Buyer inquiry notifications<br>
                                Γ£à 24/7 customer support<br>
                                ≡ƒô₧ Call: +91-9277121112
                            </small>
                        </div>
                        ...
                        <form method="POST" id="propertyListingForm" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label">
                                            <i class="fas fa-money-bill me-1"></i>Price (Γé╣) *
                                        </label>
