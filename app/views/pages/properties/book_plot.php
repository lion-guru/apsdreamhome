...
<body>
                        ...
                        <div class="plot-card">
                            ...
                            <div class="plot-content">
                                ...
                                <div class="plot-specs">
                                    ...
                                    <div class="spec-item">
                                        <span class="spec-value">Γé╣<?php echo number_format($plot['price_per_sqyard']); ?></span>
                            ...
                            <div class="plot-pricing">
                                <div class="total-price">Γé╣<?php echo number_format($plot['total_price']); ?></div>
                                <div class="booking-amount">Booking: Γé╣<?php echo number_format($plot['booking_amount']); ?></div>
                    ...
                    <div class="calculator-card">
                        ...
                        <div class="calculation-result" id="emiResult" style="display: none;">
                            ...
                            <div class="result-item">
                                ...
                                <span class="result-value" id="loanAmount">Γé╣0</span>
                            </div>
                            <div class="result-item">
                                <span>Monthly EMI:</span>
                                <span class="result-value" id="monthlyEMI">Γé╣0</span>
                            </div>
                            <div class="result-item">
                                <span>Total Interest:</span>
                                <span class="result-value" id="totalInterest">Γé╣0</span>
                            </div>
                            <div class="result-item">
                                <span>Total Amount:</span>
                                <span class="result-value" id="totalAmount">Γé╣0</span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        function openBookingModal(plotId) {
            ...
            if (plot) {
                document.querySelector('.modal-title').innerHTML = `Book Plot ${plot.plot_number} - Γé╣${plot.total_price.toLocaleString()}`;
            }
        ...
        function calculateEMI() {
            ...
            if (loanAmount > 0 && monthlyRate > 0 && numPayments > 0) {
                ...
                document.getElementById('loanAmount').textContent = 'Γé╣' + loanAmount.toLocaleString();
                document.getElementById('monthlyEMI').textContent = 'Γé╣' + Math.round(monthlyEMI).toLocaleString();
                document.getElementById('totalInterest').textContent = 'Γé╣' + Math.round(totalInterest).toLocaleString();
                document.getElementById('totalAmount').textContent = 'Γé╣' + Math.round(totalAmount).toLocaleString();
...
//
// This file contains 841 lines. Consider optimizations:
//
