<?php
$page_title = $page_title ?? 'Share Your Testimonial';
$page_heading = $page_heading ?? 'Share Your Testimonial';
$content = $content ?? '';
$errors = $errors ?? [];
        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-primary text-white py-3">
                    <h4 class="mb-0"><i class="fas fa-pen-fancy me-2"></i>Share Your Experience</h4>
                </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control" name="content" rows="6" required
                                          placeholder="Share your experience with us..."><?= htmlspecialchars($_POST['content'] ?? '') ?></textarea>
                            </div>
                            <div class="col-12">
                                <button type="submit" class="btn btn-primary btn-lg">
                                    <i class="fas fa-paper-plane me-2"></i> Submit Testimonial
                                </button>
                                <a href="<?= BASE_URL ?>/testimonials" class="btn btn-outline-secondary">Cancel</a>
                            </div>
                        </div>
                    </form>
                </div>
