...
try {
    ...
    echo "<h2>≡ƒÅá APS Dream Homes Pvt Ltd - Property Portfolio</h2>\n";
    ...
    foreach ($properties as $index => $property) {
        ...
        if ($check_stmt->rowCount() > 0) {
            echo "<p>ΓÜá∩╕Å Property '{$property['title']}' already exists. Skipping...</p>\n";
            continue;
        }
        ...
        if ($result) {
            echo "<p>Γ£à Property " . ($index + 1) . ": '{$property['title']}' added successfully!</p>\n";
        } else {
            echo "<p>Γ¥î Failed to add property: '{$property['title']}'</p>\n";
        }
    }

    echo "<hr>\n";
    echo "<h3>≡ƒôè APS Dream Homes Project Portfolio:</h3>\n";
    ...
    echo "<h5>≡ƒÅù∩╕Å Project Types:</h5>\n";
    echo "<ul>\n";
    ...
    echo "<div class='col-md-6'>\n";
    echo "<h5>≡ƒÆ░ Portfolio Value:</h5>\n";
    echo "<p><strong>Total Portfolio Value:</strong> Γé╣" . number_format($total_value) . "</p>\n";
    echo "<p><strong>Average Project Price:</strong> Γé╣" . number_format($total_value / 8) . "</p>\n";
    echo "<p><strong>Active Projects:</strong> 8 premium developments</p>\n";
    echo "</div>\n";
    echo "</div>\n";

    echo "<div class='alert alert-info mt-4'>\n";
    echo "<h6>≡ƒÅå Project Highlights:</h6>\n";
    echo "<ul>\n";
            ...
            <div class="col-md-10">
                <div class="card">
                    <div class="card-header bg-success text-white">
                        <h4 class="mb-0">≡ƒÅá APS Dream Homes Pvt Ltd - Project Portfolio</h4>
                    </div>
                    <div class="card-body">
                        <p class="text-muted">Adding professional property portfolio for a registered real estate development company.</p>

                        <div class="alert alert-info">
                            <h6>Γ£à Projects Being Added:</h6>
                            <ul>
                                <li><strong>Green Valley:</strong> 2BHK Premium Apartments (Γé╣45 Lac)</li>
                                <li><strong>Royal Residency:</strong> 3BHK Luxury Flats (Γé╣75 Lac)</li>
                                <li><strong>Business Park:</strong> Commercial Office Spaces (Γé╣85 Lac)</li>
                                <li><strong>Smart Villas:</strong> 4BHK Independent Houses (Γé╣1.5 Cr)</li>
                                <li><strong>Affordable Housing:</strong> 1BHK Starter Homes (Γé╣28 Lac)</li>
                                <li><strong>Lakeview Plots:</strong> Residential Land (Γé╣35 Lac)</li>
                                <li><strong>Corporate Suites:</strong> Service Apartments (Γé╣55 Lac)</li>
                                <li><strong>Heritage Row Houses:</strong> Traditional Homes (Γé╣92 Lac)</li>
                            </ul>
                        </div>

                        <div class="alert alert-warning">
                            <h6>≡ƒÅù∩╕Å Developer Features:</h6>
