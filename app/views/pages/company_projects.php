                                ...
                                <div class="col-lg-4 col-md-6 mb-4">
                                    <div class="card project-card h-100 shadow-sm border-0 overflow-hidden">
                                        <div class="project-image position-relative">
                                            <img src="<?php echo BASE_URL . $imgPath; ?>" class="img-fluid card-img-top" alt="<?php echo htmlspecialchars($project->site_name); ?>" style="height: 180px; object-fit: cover;" onerror="this.src='<?php echo BASE_URL; ?>/assets/images/placeholder/property.svg'">
