    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex flex-wrap gap-2 align-items-center">
                ...
                <a href="<?= BASE_URL ?>/properties" class="btn btn-sm px-3">
        ...
        <?php if (!empty($colonies)): ?>
            <?php foreach ($colonies as $colony): ?>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card h-100 shadow-sm border-0 rounded-4 overflow-hidden position-relative aps-colony-card">
                        <?php if (!empty($colony['is_featured'])): ?>
                            <span class="position-absolute top-0 start-0 m-3 badge bg-warning text-dark fw-bold px-3 py-2 shadow-sm">
