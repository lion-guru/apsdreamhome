    ...
    <div class="col-12">
        <div class="aps-cp-card">
            <div class="aps-cp-card-header">
                <h5><i class="fas fa-file-invoice-dollar"></i> <?= __('dash_my_bookings', null, 'My Bookings') ?></h5>
            ...
            <div class="aps-cp-card-body">
                <div class="row g-3 text-center">
                    ...
                    <div class="col-md-3 col-6">
                        <div class="bg-white rounded-3 p-3 border">
                            <div class="fw-bold fs-4 text-amber" data-aps-count="<?= $dashActiveEmis ?>">0</div>
...
<div class="row g-4">
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <?php if ($bStatus === 'pending' && $tokenRequired > $tokenPaid): ?>
                                        <a href="<?= BASE_URL ?>/booking/<?= (int)$b['id'] ?>/pay" class="aps-cp-icon-btn" title="<?= __('dash_btn_pay_token', null, 'Pay Token') ?>" >
            ...
            <div class="aps-cp-card-body">
                <div class="row g-3 mb-3">
                    <div class="col-sm-4">
                        <div class="aps-cp-stat aps-cp-stat--red">
                            <div class="aps-cp-stat-body">
                                <div class="aps-cp-stat-value">₹<?= number_format($paymentSummary['total_overdue_amount'] ?? 0) ?></div>
                    ...
                    <div class="col-sm-4">
                        <div class="aps-cp-stat">
                            <div class="aps-cp-stat-body">
                                <div class="aps-cp-stat-value">₹<?= number_format($paymentSummary['total_accrued_penalties'] ?? 0) ?></div>
                    ...
                    <div class="col-sm-4">
                        <div class="aps-cp-stat">
                            <div class="aps-cp-stat-body">
                                <div class="aps-cp-stat-value"><?= (int)($paymentSummary['worst_overdue_days'] ?? 0) ?> days</div>
    ...
    <div class="col-lg-4">
        ...
        <div class="aps-cp-card mb-4">
            <div class="aps-cp-card-header">
                <h5><i class="fas fa-trophy"></i> <?= __('dash_investor_level', null, 'Investor Level') ?></h5>
            </div>
            <div class="aps-cp-card-body text-center">
                <div class="display-5 fw-bold mb-1"><?= htmlspecialchars($lvl ?? '') ?></div>
                ...
                <div class="aps-cp-progress">
                    <div class="aps-cp-progress-bar"></div>
                </div>
        ...
        <div class="aps-cp-card mb-4">
            ...
            <div class="aps-cp-card-body">
                <div class="text-center mb-3">
                    <div class="display-6 fw-bold text-warning mb-1" id="dashRefCode">
                ...
                <div class="d-flex gap-2 justify-content-center mt-3">
                    <a href="https://wa.me/?text=<?= urlencode(sprintf(__('dash_share_whatsapp_msg', null, 'Join APS Dream Home! Use my referral code: %s Register here: %s'), $referral_code, $referral_link)) ?>" target="_blank" class="aps-cp-icon-btn" title="<?= __('dash_share_whatsapp', null, 'Share on WhatsApp') ?>"><i class="fab fa-whatsapp"></i></a>
                    <a href="sms:?body=<?= urlencode(sprintf(__('dash_share_sms_msg', null, 'Use my referral code %s to register at APS Dream Home: %s'), $referral_code, $referral_link)) ?>" class="aps-cp-icon-btn" title="<?= __('dash_share_sms', null, 'Share via SMS') ?>"><i class="fas fa-sms"></i></a>
        ...
        <div class="aps-cp-card mb-4">
            <div class="aps-cp-card-header">
                <h5><i class="fas fa-headset"></i> <?= __('dash_need_help', null, 'Need Help?') ?></h5>
            </div>
            <div class="aps-cp-card-body text-center">
                <div class="d-flex justify-content-center gap-4 mb-3">
                    <div>
                        <div class="fw-bold fs-4" data-aps-count="<?= $dashOpenTickets ?>">0</div>
        ...
        <div class="aps-cp-card mt-4">
            ...
            <div class="aps-cp-card-body">
                <div class="d-flex align-items-center mb-3">
                    <div class="aps-cp-stat-icon"><i class="<?= $kycIcon ?>"></i></div>
                    <div class="ms-3">
