...
<!-- Hero Section -->
<section class="position-relative overflow-hidden  cta-gradient">
    <div style="background:url(&quot;data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23ffffff' fill-opacity='0.04'%3E%3Cpath d='M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E&quot;)"></div>
    <div class="container position-relative">
        <div class="row align-items-center">
            <div class="col-lg-6 mb-4 mb-lg-0">
                <h1 class="display-5 display-lg-4 fw-bold mb-3"><?php echo __('get_in_touch'); ?></h1>
                <p class="lead mb-4"><?php echo __('contact_subtitle'); ?></p>
            ...
            <div class="col-lg-6">
                <div class="card shadow-lg border-0 glass-card-premium">
                    ...
                    <div class="card-body p-3 p-md-4">
                        ...
                        <form action="<?php echo BASE_URL; ?>/contact" method="POST" id="contactForm" data-aps-ajax="true">
                            ...
                            <div class="aps-form-field mb-3">
                                ...
                                <input type="text" name="name" id="name" class="form-control form-control-lg animate-focus" placeholder="<?php echo __('your_name_placeholder'); ?>" required>
                            ...
                            <div class="row g-2">
                                <div class="col-md-6 mb-3 aps-form-field">
                                    ...
                                    <input type="email" name="email" id="email" class="form-control form-control-lg animate-focus" placeholder="your@email.com" required >
                                    <div class="aps-field-error" role="alert"></div>
                                </div>
                                <div class="col-md-6 mb-3 aps-form-field">
                                    <label for="phone" class="form-label fw-bold mb-1"><?php echo __('phone'); ?> *</label>
                                    <input type="tel" name="phone" id="phone" class="form-control form-control-lg animate-focus" placeholder="+91 XXXXXXXXXX" required >
                                    <div class="aps-field-error" role="alert"></div>
                                </div>
                            </div>
                            <div class="aps-form-field mb-3">
                                <label for="subject" class="form-label fw-bold mb-1"><?php echo __('subject'); ?> *</label>
                                <select name="subject" id="subject" class="form-select form-select-lg animate-focus" required >
                            ...
                            <div class="aps-form-field mb-3">
                                ...
                                <textarea name="message" id="message" class="form-control form-control-lg animate-focus" rows="4" placeholder="<?php echo __('message_placeholder_contact'); ?>" required></textarea>
                                <div class="aps-field-error" role="alert"></div>
                            </div>
<button type="submit" class="btn btn-primary btn-lg w-100 shadow-hover">
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="faq1">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqCollapse1">
                                    <i class="fas fa-building me-2"></i><?= __('contact_faq1_q', null, 'What types of properties do you offer?') ?>
                                </button>
                            </h2>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="faq2">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqCollapse2">
                                    <i class="fas fa-calendar-check me-2"></i><?= __('contact_faq2_q', null, 'How can I schedule a property visit?') ?>
                                </button>
                            </h2>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="faq3">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqCollapse3">
                                    <i class="fas fa-university me-2"></i><?= __('contact_faq3_q', null, 'Do you provide home loan assistance?') ?>
                                </button>
                            </h2>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="faq4">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqCollapse4">
                                    <i class="fas fa-shield-alt me-2"></i><?= __('contact_faq4_q', null, 'Are your properties legally verified?') ?>
                                </button>
                            </h2>
            ...
            <div class="col-lg-5">
                ...
                <div class="office-card scroll-reveal">
                    ...
                    <div class="office-body">
                        <address class="mb-0">
                            <strong><i class="fas fa-map-pin me-1"></i> <?= __('contact_office_addr1', null, '1st floor, Singhariya Chauraha, Kunraghat, Deoria Road') ?></strong><br>
                            <?= __('contact_office_addr2', null, 'Gorakhpur, UP - 273008') ?><br><br>
                            <i class="fas fa-phone me-1"></i> <?= __('phone_lbl', null, 'Phone') ?>: <a href="tel:<?= preg_replace('/[^0-9+]/', '', $sc('contact_phone', '+919277121112')) ?>"><?= htmlspecialchars($sc('contact_phone', '+91 92771 21112')) ?></a><?php if ($sc('contact_phone_2')): ?> / <a href="tel:<?= preg_replace('/[^0-9+]/', '', $sc('contact_phone_2')) ?>"><?= htmlspecialchars($sc('contact_phone_2')) ?></a><?php endif; ?><br>
                            <i class="fas fa-envelope me-1"></i> <?= __('email_lbl', null, 'Email') ?>: <a href="mailto:<?= htmlspecialchars($sc('contact_email', 'info@apsdreamhome.com')) ?>"><?= htmlspecialchars($sc('contact_email', 'info@apsdreamhome.com')) ?></a>
                        </address>
