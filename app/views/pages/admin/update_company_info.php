...
try {
    ...
    foreach ($updates as $update) {
        ...
        if ($result) {
            echo "<p>Γ£à Updated: " . $update['setting_name'] . "</p>\n";
        } else {
            echo "<p>Γ¥î Failed to update: " . $update['setting_name'] . "</p>\n";
        }
    }

    echo "<hr>\n";
    echo "<h3>≡ƒôï Updated Information:</h3>\n";
    echo "<ul>\n";
