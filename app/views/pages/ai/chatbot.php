            ...
            <div class="card shadow-lg border-0 rounded-4 overflow-hidden">
                ...
                <div class="chat-container">
                    <div class="chat-messages p-4" id="chatMessages" >
                        <div class="message bot-message mb-3 p-3 rounded-4 bg-white shadow-sm">
                    ...
                    <div class="loading text-center py-3 text-muted small" id="loading" >
                    ...
                    <div class="chat-input p-3 bg-white border-top">
                        <div class="d-flex align-items-center gap-2 mb-2">
                            <button class="btn btn-sm rounded-circle d-flex align-items-center justify-content-center" id="voiceToggle" onclick="toggleVoiceMode()" title="Voice mode ON/OFF">
                                <i class="fas fa-volume-up" id="voiceToggleIcon"></i>
                            </button>
                            <small class="text-muted" id="voiceModeLabel" >Voice: OFF</small>
                            <div class="ms-auto d-flex align-items-center gap-2">
                                <button class="btn btn-sm rounded-circle d-flex align-items-center justify-content-center" id="micBtn" onclick="toggleMic()" title="Speak">
