<!-- Hero Section -->
<section class="news-hero-section text-white py-5">
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <?php if (!empty($news['image'])): ?>
                    ...
                    ?>
                    <img src="<?= htmlspecialchars($newsImageUrl ?? '') ?>" alt="<?= htmlspecialchars($news['title'] ?? '') ?>" class="img-fluid rounded mb-4 w-100">
                <?php endif; ?>
