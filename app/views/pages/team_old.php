...
try {
    ...
    $whereClause = $currentDepartment !== 'all' ? "AND department = :department" : "";

    // Get team members
    $membersQuery = "SELECT * FROM team_members WHERE status = 'active' $whereClause ORDER BY display_order ASC, name ASC";
