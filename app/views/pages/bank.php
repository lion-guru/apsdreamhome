                ...
                <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-5 bg-white" data-aos="fade-up">
                    <div class="card-body p-0">
                        <div class="bank-details-wrapper text-center p-4 p-md-5">
                            ...
                            <img src="<?= BASE_URL ?>/assets/images/placeholder/property.svg" class="img-fluid rounded-4 shadow-sm border" alt="APS Dream Homes Bank Details" onerror="this.src='https://placehold.co/800x400?text=Bank+Details+Image'" />
                        </div>
                    </div>
                </div>
