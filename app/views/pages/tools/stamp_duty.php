<section class="py-5" style="background: linear-gradient(135deg, #0f0c29, #302b63, #24243e);">
    <div class="container">
        <div class="text-center mb-4">
            <h1 class="text-white fw-bold">Stamp Duty & Registration Calculator</h1>
            <p class="text-white-50">Property khareedne se pehle total cost calculate karein</p>
        </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="stateSel" onchange="calcStamp()">
                                <option value="7">Uttar Pradesh (7% Stamp Duty)</option>
                                <option value="6">Bihar (6%)</option>
                                <option value="5">Madhya Pradesh (5%)</option>
                                <option value="6">Rajasthan (6%)</option>
                                <option value="5">Delhi (5%)</option>
                                <option value="6">Maharashtra (6%)</option>
                            </select>
                        </div>
                        <div class="row g-3 text-center" id="stampResults">
                            <div class="col-4">
                                <div class="bg-light rounded p-3">
                                    <small class="text-muted">Stamp Duty</small>
                                    <h5 class="text-primary mb-0" id="stampDuty">₹3,50,000</h5>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="bg-light rounded p-3">
                                    <small class="text-muted">Registration (1%)</small>
