...
<div class="container py-4">
  ...
  <div class="alert alert-info d-flex align-items-center gap-2 py-2 px-3 mb-4 small">
    ...
    <?php foreach ($packages as $pkg): ?>
      <span class="badge ms-1"><?= htmlspecialchars($pkg['badge_label'] ?? $pkg['name']) ?> ₹<?= number_format($pkg['price']) ?></span>
    <?php endforeach; ?>
    ...
    <div class="row g-3">
      <?php foreach ($listings as $prop): ?>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="reg-card">
            <?php if ($badge): ?>
            <span class="position-absolute top-0 end-0 m-2 premium-badge-sm <?= $bc ?>"><i class="fas fa-crown me-1"></i><?= $badge ?></span>
            <?php endif; ?>
            <?php if ($img): ?>
