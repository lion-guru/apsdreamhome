    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-lg-5">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body p-4">
                    <h6 class="fw-bold text-dark mb-4"><i class="fas fa-trophy me-2"></i>My Rank Progress</h6>

                    <!-- Current Rank Badge -->
                    <div class="d-flex align-items-center mb-4">
                        <div class="rounded-3 d-flex align-items-center justify-content-center me-3">
                            <i class="fas fa-medal fa-xl"></i>
                        </div>
                        <div>
                            <div class="badge px-3 py-2 mb-1 fw-bold fs-6">
                    ...
                    <div class="mb-3">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <small class="fw-semibold text-dark">Progress to <span ><?= htmlspecialchars($nextRankLabel ?? '') ?></span></small>
                            <span class="badge rounded-pill"><?= $rankProgressPct ?>%</span>
                        </div>
                        <div class="progress">
                    ...
                    <div class="rounded-3 p-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <div class="fw-semibold small">Unlock <?= htmlspecialchars($nextRankLabel ?? '') ?></div>
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4">
                    ...
                    <div class="row g-3">
                        <div class="col-xl-3 col-md-6">
                            <a href="javascript:void(0)" onclick="shareReferralLink()" class="btn w-100 py-3 fw-semibold text-start d-flex align-items-center text-decoration-none">
                                <div class="rounded-3 d-flex align-items-center justify-content-center me-3">
                        ...
                        <div class="col-xl-3 col-md-6">
                            <a href="#downlineSection" class="btn w-100 py-3 fw-semibold text-start d-flex align-items-center text-decoration-none">
                                <div class="rounded-3 d-flex align-items-center justify-content-center me-3">
                        ...
                        <div class="col-xl-3 col-md-6">
                            <a href="javascript:void(0)" onclick="requestPayout()" class="btn w-100 py-3 fw-semibold text-start d-flex align-items-center text-decoration-none">
                                <div class="rounded-3 d-flex align-items-center justify-content-center me-3">
                        ...
                        <div class="col-xl-3 col-md-6">
                            <a href="javascript:void(0)" onclick="downloadStatement()" class="btn w-100 py-3 fw-semibold text-start d-flex align-items-center text-decoration-none">
                                <div class="rounded-3 d-flex align-items-center justify-content-center me-3">
            ...
            <div class="card border-0 shadow-sm h-100">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="d-flex justify-content-center gap-3">
                        <button class="btn btn-outline-success btn-sm rounded-circle" onclick="shareVia('whatsapp')" title="WhatsApp">
                            <i class="fab fa-whatsapp"></i>
                        </button>
                        <button class="btn btn-outline-primary btn-sm rounded-circle" onclick="shareVia('telegram')" title="Telegram">
                            <i class="fab fa-telegram-plane"></i>
                        </button>
                        <button class="btn btn-outline-info btn-sm rounded-circle" onclick="shareVia('twitter')" title="Twitter">
                            <i class="fab fa-twitter"></i>
                        </button>
                        <button class="btn btn-outline-secondary btn-sm rounded-circle" onclick="shareVia('email')" title="Email">
                                    ...
                                    <li class="mb-2">
                                        <div class="d-flex align-items-center p-2 rounded-2 bg-light">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <small class="d-block text-muted"><?= __('mlm_dash_joined', [], 'Joined:') ?> <?= htmlspecialchars($member['join_date'] ?? 'N/A') ?></small>
                                            </div>
                                            ...
                                            <li class="mb-1">
                                                <div class="d-flex align-items-center p-2 rounded-2">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        ...
                                                        <span class="badge bg-success bg-opacity-10 text-success ms-1">L2</span>
                                                    </div>
                                                    <span class="badge <?= ($child['status'] ?? 'active') === 'active' ? 'bg-success' : 'bg-secondary' ?>">
