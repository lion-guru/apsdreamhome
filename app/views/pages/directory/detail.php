            ...
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-body">
                    ...
                    <?php if ($listing['photo']): ?>
                        <img src="<?= htmlspecialchars($listing['photo'] ?? '') ?>" loading="lazy" alt="<?= htmlspecialchars($listing['business_name'] ?? '') ?>" class="img-fluid rounded mb-3">
                    <?php endif; ?>
                            ...
                            <div class="mb-2">
                                ...
                                <div class="star-rating">
                                    <?php for ($i = 5; $i >= 1; $i--): ?>
                                        ...
                                        <label for="star<?= $i ?>" class="fs-4 text-warning">â˜…</label>
                                    <?php endfor; ?>
                                </div>
                            </div>
                            <div class="mb-2">
