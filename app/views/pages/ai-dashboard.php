...
<!-- Hero -->
<section class="ai-dash-hero py-5 text-white position-relative">
    <div class="container text-center py-4 position-relative">
        ...
        <h1 class="display-4 fw-bold mb-3"><i class="fas fa-brain me-3"></i>AI Dashboard</h1>
        <p class="lead mb-4">Your personal AI-powered real estate assistant — smarter searches, accurate valuations, and market insights</p>
...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="fw-bold mb-0"><i class="fas fa-wand-magic-sparkles me-2"></i>AI-Powered Tools</h4>
        <span class="text-muted"><?= count($ai_tools) ?> tools available</span>
    </div>

    <div class="row g-4 mb-5">
        <?php foreach ($ai_tools as $tool): ?>
            <div class="col-md-6 col-lg-4">
                <a href="<?= BASE_URL . $tool['url'] ?>" class="ai-tool-card position-relative">
                    <div class="tool-icon">
                        <i class="<?= $tool['icon'] ?>"></i>
                    </div>
    ...
    <div class="row g-4 mb-5">
        ...
        <div class="col-lg-7">
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4">
                    <h6 class="fw-bold mb-3"><i class="fas fa-graduation-cap me-2"></i>AI Training Progress</h6>
                    <?php if (!empty($training_progress)): ?>
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <span ><?= htmlspecialchars($training_progress['current_model'] ?? 'Model') ?></span>
                            <span class="fw-bold"><?= (int)($training_progress['progress_percentage'] ?? 0) ?>%</span>
                        </div>
                        ...
                        <div class="row g-3">
                            <div class="col-4">
                                <div >Dataset</div>
                                <div ><?= $training_progress['dataset_size'] ?? 'N/A' ?></div>
                            </div>
                            <div class="col-4">
                                <div >Epochs</div>
                                <div ><?= (int)($training_progress['epochs_completed'] ?? 0) ?>/<?= (int)($training_progress['total_epochs'] ?? 0) ?></div>
                            </div>
                            <div class="col-4">
                                <div >Accuracy</div>
                                <div ><?= $training_progress['current_accuracy'] ?? 0 ?>%</div>
                            </div>
                        </div>
                    <?php else: ?>
        ...
        <div class="col-lg-5">
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4">
                    <h6 class="fw-bold mb-3"><i class="fas fa-stream me-2"></i>Recent AI Activity</h6>
                    <?php if (!empty($recent_activity)): ?>
                        <?php foreach (array_slice($recent_activity, 0, 5) as $activity): ?>
                            ...
                            <div class="ai-activity-item">
                                ...
                                <div>
                                    <div ><?= htmlspecialchars($activity['activity'] ?? '') ?></div>
                                    <div ><?= htmlspecialchars($activity['details'] ?? '') ?></div>
    ...
    <div class="text-center mb-5">
        <h4 class="fw-bold mb-4"><i class="fas fa-lightbulb me-2"></i>How AI Helps You</h4>
        <div class="row g-4">
            <div class="col-md-4">
                <div class="p-4">
                    <i class="fas fa-clock fa-2x mb-3"></i>
                    <h6 class="fw-bold">Save Time</h6>
                    <p >AI instantly finds properties matching your exact needs — no more scrolling through irrelevant listings</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="p-4">
                    <i class="fas fa-shield-halved fa-2x mb-3"></i>
                    <h6 class="fw-bold">Make Smart Decisions</h6>
                    <p >Data-driven price predictions and market analysis help you buy at the right price</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="p-4">
                    ...
                    <p >Real-time market trends and AI-generated insights keep you ahead of the curve</p>
                </div>
            </div>
        </div>
    </div>
