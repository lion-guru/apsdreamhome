        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm">
                <div class="position-relative">
                    ...
                    <img src="<?= BASE_URL ?>/assets/images/placeholder/property.svg" class="card-img-top" alt="<?php echo htmlspecialchars($property['name'] ?? ''); ?>" onerror="this.parentElement.querySelector('.no-image-placeholder').style.display='flex'">
                    <?php endif; ?>
                    <div class="no-image-placeholder d-<?php echo empty($property['image']) ? 'flex' : 'none'; ?> align-items-center justify-content-center bg-light">
...
<div class="modal fade" id="detailInterestModal" tabindex="-1" aria-hidden="true">
    ...
    <?php echo CSRFProtection::csrfField(); ?>
                ...
                <div id="detailInterestSuccess" class="text-center py-3">
