        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm">
                <div class="position-relative">
                    ...
                    <img src="<?php echo BASE_URL . '/assets/images/' . htmlspecialchars($property['image']); ?>" class="card-img-top" alt="<?php echo htmlspecialchars($property['name'] ?? ''); ?>" style="height:400px;object-fit:cover;" onerror="this.parentElement.querySelector('.no-image-placeholder').style.display='flex'">
                    <?php endif; ?>
