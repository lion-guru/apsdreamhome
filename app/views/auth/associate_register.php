...
/**
 * Associate Registration - APS Dream Home
 */

$layout = 'layouts/base';
$page_title = $page_title ?? 'Associate Registration - APS Dream Home';
$page_description = $page_description ?? 'Register as an associate partner';
?>
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body p-5">
                        <div class="text-center mb-4">
                            ...
                            <p class="text-muted">Register as an associate partner and earn commissions</p>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <button type="submit" class="btn btn-primary btn-lg w-100">
                                        <i class="fas fa-handshake me-2"></i>Register as Associate
                                    </button>
                                </div>
                            </div>
                        </form>
                        ...
                        <div class="text-center mt-4">
                            <p class="mb-0">Already have an account? 
                                <a href="<?php echo BASE_URL; ?>/associate/login" class="text-primary">Login here</a>
                            </p>
