...
<body>
    ...
    <div class="login-wrapper">
        ...
        <div class="login-card">
            ...
            <!-- Google Login Button -->
            <div class="google-login-section" style="margin-top: 1.5rem;">
                <div style="text-align: center; color: #888; font-size: 0.85rem; margin-bottom: 1rem; position: relative;">
                    <span style="background: #fff; padding: 0 1rem; position: relative; z-index: 1;">or continue with</span>
                    <div style="position: absolute; top: 50%; left: 0; right: 0; height: 1px; background: #e8e8f0; z-index: 0;"></div>
                </div>
                <a href="<?php echo BASE_URL; ?>/auth/google" class="btn-google" style="display: flex; align-items: center; justify-content: center; gap: 0.75rem; width: 100%; height: 50px; border: 2px solid #e8e8f0; border-radius: 12px; background: #fff; color: #1a1a2e; font-size: 1rem; font-weight: 600; cursor: pointer; transition: all 0.2s; text-decoration: none;">
