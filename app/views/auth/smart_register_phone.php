...
<button type="submit" class="btn-send" id="sendBtn">
            ...
            <div class="social-buttons">
                <a href="<?php echo $base; ?>/auth/google" class="social-btn google">
                ...
                <a href="<?php echo $base; ?>/auth/facebook" class="social-btn facebook">
        ...
        <p class="login-link">Already have an account? <a href="<?php echo $base; ?>/login">Sign in</a></p>
    ...
    <script nonce="<?= $GLOBALS['csp_nonce'] ?? '' ?>">
        ...
        function trackBehavior(eventType, eventData) {
            ...
            fetch('<?php echo $base; ?>/api/smart-register/track', {
                method: 'POST',
