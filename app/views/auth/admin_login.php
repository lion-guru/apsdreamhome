    ...
    <div class="login-wrapper">
        <div class="login-card">
            ...
            <div class="brand-section">
                ...
                <p class="brand-subtitle"><?php echo __('auth_admin_portal', 'Admin Portal'); ?></p>
            </div>
            ...
            <form action="<?php echo BASE_URL; ?>/admin/login" method="POST" novalidate>
                ...
                <div class="mb-3">
                    <label class="form-label" for="username">
                        <i class="fa-solid fa-user"></i> <?php echo __('auth_username_email', 'Username or Email'); ?>
                    </label>
                    <div class="input-group">
                        ...
                        <input
                            ...
                            id="username"
                            name="username"
                            placeholder="<?php echo __('auth_enter_username_email', 'Enter your username or email'); ?>"
                ...
                <div class="mb-3">
                    <label class="form-label" for="password">
                        <i class="fa-solid fa-lock"></i> <?php echo __('auth_password', 'Password'); ?>
                    </label>
                    <div class="input-group">
                        ...
                        <input
                            ...
                            id="password"
                            name="password"
                            placeholder="<?php echo __('auth_enter_password', 'Enter your password'); ?>"
                            required>
            ...
            <a href="<?php echo BASE_URL; ?>/auth/google" >
