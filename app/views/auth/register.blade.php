                    ...
                    <div class="p-4">
                        ...
                        @if($referrerInfo)
                            <div class="referrer-info">
                                ...
                                <p class="mb-1"><strong>{{ $referrerInfo['name'] }}</strong></p>
                                <p class="mb-0">Code: {{ $referrerInfo['referral_code'] }}</p>
                            </div>
                        @endif
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="tel" class="form-control" name="mobile" id="mobile"
                                           value="{{ old('mobile') }}" pattern="[0-9]{10}" maxlength="10" required>
                                    @error('mobile')
                                        <div class="text-danger small">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="referrer_code" id="referrer_code"
                                           value="{{ $referralCode }}" placeholder="Optional">
                                    @error('referrer_code')
                                        <div class="text-danger small">{{ $message }}</div>
                                    @enderror
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-control" name="budget_range">
                                                ...
                                                <option value="0-10" {{ old('budget_range') == '0-10' ? 'selected' : '' }}>₹0-10 Lakh</option>
                                                <option value="10-25" {{ old('budget_range') == '10-25' ? 'selected' : '' }}>₹10-25 Lakh</option>
                                                <option value="25-50" {{ old('budget_range') == '25-50' ? 'selected' : '' }}>₹25-50 Lakh</option>
                                                <option value="50-100" {{ old('budget_range') == '50-100' ? 'selected' : '' }}>₹50-100 Lakh</option>
                                                <option value="100+" {{ old('budget_range') == '100+' ? 'selected' : '' }}>₹1 Crore+</option>
                                            </select>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="license_number"
                                                   value="{{ old('license_number') }}" placeholder="Real Estate License">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="pan_number"
                                                   value="{{ old('pan_number') }}" style="text-transform: uppercase;"
                                                   placeholder="AAAAA0000A">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label">Aadhar Number</label>
                                            <input type="text" class="form-control" name="aadhar_number"
                                                   value="{{ old('aadhar_number') }}" pattern="[0-9]{12}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="company_name"
                                                   value="{{ old('company_name') }}" placeholder="Your Company Name">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label">RERA Registration</label>
                                            <input type="text" class="form-control" name="rera_registration"
                                                   value="{{ old('rera_registration') }}" placeholder="RERA Registration Number">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-control" name="investment_range">
                                                ...
                                                <option value="10-50" {{ old('investment_range') == '10-50' ? 'selected' : '' }}>₹10-50 Lakh</option>
                                                <option value="50-100" {{ old('investment_range') == '50-100' ? 'selected' : '' }}>₹50-100 Lakh</option>
                                                <option value="100-500" {{ old('investment_range') == '100-500' ? 'selected' : '' }}>₹1-5 Crore</option>
                                                <option value="500+" {{ old('investment_range') == '500+' ? 'selected' : '' }}>₹5 Crore+</option>
                                            </select>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-control" name="investment_type">
                                                <option value="">Select Type</option>
                                                <option value="residential" {{ old('investment_type') == 'residential' ? 'selected' : '' }}>Residential</option>
                                                <option value="commercial" {{ old('investment_type') == 'commercial' ? 'selected' : '' }}>Commercial</option>
                                                <option value="mixed" {{ old('investment_type') == 'mixed' ? 'selected' : '' }}>Mixed Portfolio</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        ...
        document.getElementById('email').addEventListener('input', function() {
            ...
            emailTimeout = setTimeout(() => {
                fetch(`{{ route('register.check-email') }}?email=${encodeURIComponent(email)}`)
        ...
        document.getElementById('mobile').addEventListener('input', function() {
            ...
            mobileTimeout = setTimeout(() => {
                fetch(`{{ route('register.check-mobile') }}?mobile=${encodeURIComponent(mobile)}`)
                    .then(response => response.json())
                    .then(data => {
                        if (data.available) {
        ...
        document.getElementById('referrer_code').addEventListener('input', function() {
            ...
            referrerTimeout = setTimeout(() => {
                fetch(`{{ route('register.validate-referral') }}`, {
                    method: 'POST',
                    headers: {
        ...
        document.getElementById('registrationForm').addEventListener('submit', function(e) {
            ...
            // Show loading state
            submitBtn.innerHTML = '<span class="loading me-2"></span>Registering...';
