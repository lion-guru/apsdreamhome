...
if (!isAdmin() && !isSuperAdmin()) {
    header('Location: dashboard.php?error=' . urlencode('Access Denied: Admin privilege required.'));
    exit();
}
                ...
                <div class="col-md-4 text-end">
                    <div class="ai-status-badges">
                        <span class="badge bg-light text-dark me-2">
                            <i class="fas fa-user me-1"></i><?php echo h(getAuthFullName() ?? 'Guest'); ?>
                        </span>
                        <span class="badge bg-light text-dark">
                            <i class="fas fa-shield-alt me-1"></i><?php echo h(getAuthSubRole() ?? 'Admin'); ?>
                        </span>
                    </div>
                </div>
            </div>
