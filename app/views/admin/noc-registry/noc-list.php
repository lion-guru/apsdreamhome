                    ...
                    <?php foreach ($nocs as $n): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="text-muted"><?= htmlspecialchars($n['customer_phone'] ?? '') ?></div>
                            </td>
                            <td class="small"><?= htmlspecialchars($n['plot_no'] ?? '') ?>, <?= htmlspecialchars($n['colony_name'] ?? '') ?></td>
                            <td class="small text-truncate"><?= htmlspecialchars($n['purpose'] ?? '') ?></td>
                            <td>
                                <?php
                                ...
                                <?php if ($n['noc_number']): ?>
                                    <div class="text-muted"><?= htmlspecialchars($n['noc_number'] ?? '') ?></div>
                                <?php endif; ?>
                            </td>
