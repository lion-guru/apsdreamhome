    ...
    <div class="col-md-8">
        <div class="card aps-cp-card mb-4">
            ...
            <div class="card-body aps-cp-card-body">
                ...
                <div class="row g-3">
                    <div class="col-md-3">
                        <div class="card border text-center py-3" style="border-radius:8px">
                    ...
                    <div class="col-md-3">
                        <div class="card border text-center py-3" style="border-radius:8px;border-color:#198754!important">
