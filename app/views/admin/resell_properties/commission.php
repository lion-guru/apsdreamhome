    ...
    <div class="col-md-8">
        <div class="card aps-cp-card mb-4">
            ...
            <div class="card-body aps-cp-card-body">
                <div class="row mb-4">
                    <div class="col-md-4">
                        <label class="form-label small fw-semibold">Property Price (â‚¹)</label>
                    ...
                    <div class="col-md-4">
                        <label class="form-label small fw-semibold">Commission Amount (â‚¹)</label>
                        <input type="text" class="form-control fw-bold text-success" id="calcAmount" value="â‚¹<?= number_format($commission, 2) ?>" readonly>
                    </div>
                </div>
                <div class="row g-3">
                    <div class="col-md-3">
                        <div class="card border text-center py-3" class="style-37644">
                            ...
                            <div class="fw-bold">â‚¹<?= number_format($price * 1 / 100, 2) ?></div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card border text-center py-3" class="style-37644">
                            <div class="small text-muted">1.5% Rate</div>
                            <div class="fw-bold">â‚¹<?= number_format($price * 1.5 / 100, 2) ?></div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card border text-center py-3" class="style-68713">
                            <div class="small text-muted">2% Rate (Default)</div>
                            <div class="fw-bold text-success">â‚¹<?= number_format($price * 2 / 100, 2) ?></div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card border text-center py-3" class="style-37644">
                            <div class="small text-muted">3% Rate</div>
                            <div class="fw-bold">â‚¹<?= number_format($price * 3 / 100, 2) ?></div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="col-md-4">
        <div class="card aps-cp-card mb-4">
            ...
            <div class="card-body aps-cp-card-body">
                ...
                <div class="small text-muted mb-1">Price: â‚¹<?= number_format($price) ?></div>
...
function calculateCommission() {
    ...
    document.getElementById('calcAmount').value = 'â‚¹' + amount.toLocaleString('en-IN', {minimumFractionDigits: 2, maximumFractionDigits: 2});
}
</script>
