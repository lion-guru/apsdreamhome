    ...
    <div class="card-body aps-cp-card-body">
        ...
        <?php if (empty($images)): ?>
            <div class="text-center py-5">
                <i class="fas fa-image fa-3x mb-3" style="opacity:0.15"></i>
                ...
                <?php foreach ($images as $idx => $img): ?>
                    ...
                    <div class="col-md-3">
                        <div class="card border position-relative" style="border-radius:10px;overflow:hidden">
                            <img src="<?= htmlspecialchars($src) ?>" alt="Property Image <?= $idx + 1 ?>" class="card-img-top" style="height:180px;object-fit:cover" onerror="this.style.display='none';this.nextElementSibling.style.display='flex'">
                            <div class="d-none align-items-center justify-content-center bg-light" style="height:180px"><i class="fas fa-broken-image fa-2x text-muted"></i></div>
