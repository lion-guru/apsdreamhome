            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-nowrap">
                        <a href="<?php echo BASE_URL; ?>/admin/colonies/<?php echo e($c['id']); ?>" class="btn btn-sm btn-info" title="View"><i class="fas fa-eye"></i></a>
                        <a href="<?php echo BASE_URL; ?>/admin/colonies/<?php echo e($c['id']); ?>/edit" class="btn btn-sm btn-primary" title="Edit"><i class="fas fa-edit"></i></a>
                        <a href="<?php echo BASE_URL; ?>/admin/colonies/<?php echo e($c['id']); ?>/plots" class="btn btn-sm btn-success" title="Plots"><i class="fas fa-map"></i></a>
