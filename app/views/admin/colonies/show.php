            ...
            <div class="card-body p-0">
                ...
                <div class="table-responsive"><table class="table table-hover mb-0">
                    ...
                    <tbody><?php foreach ($plots as $p): ?>
                        ...
                        <td><?php echo $p['area_sqft'] ?? 0; ?></td><td>â‚¹<?php echo number_format($p['total_price'] ?? 0); ?></td>
        ...
        <div class="col-md-4">
            ...
            <div class="card-body aps-cp-card-body">
                <table class="table table-sm">
                    ...
                    <tr><td><strong>Starting Price</strong></td><td>â‚¹<?php echo number_format($colony['starting_price'] ?? 0); ?></td></tr>
