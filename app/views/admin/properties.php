                    ...
                    <form method="GET" class="row g-3">
                        ...
                        <div class="col-md-2">
                            ...
                            <select name="price_range" class="form-select">
                                ...
                                <option value="0-10lakh">Under ₹10L</option>
                                <option value="10lakh-50lakh">₹10L - ₹50L</option>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="https://via.placeholder.com/60x40/2c3e50/ffffff?text=PROP" class="rounded me-3" style="width: 60px; height: 40px; object-fit: cover;">
                                            <div>
                                                <div class="fw-bold">Premium Villa</div>
                                                <small class="text-muted">3 BHK • 1500 sqft</small>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="https://via.placeholder.com/60x40/2c3e50/ffffff?text=PROP" class="rounded me-3" style="width: 60px; height: 40px; object-fit: cover;">
                                            <div>
                                                <div class="fw-bold">Commercial Plot</div>
                                                <small class="text-muted">2000 sqft</small>
                                            </div>
                                        </div>
                                    </td>
