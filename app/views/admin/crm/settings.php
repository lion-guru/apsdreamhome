...
<div class="crm-settings-header">
    <div class="d-flex justify-content-between align-items-center">
        <div>
            ...
            <p class="mb-0 mt-1">Configure CRM features, permissions, and automation for your team</p>
        </div>
        <div>
            <span class="badge bg-white text-dark"><i class="fas fa-shield-alt me-1"></i>SaaS-Ready</span>
        </div>
    </div>
</div>
...
<form method="POST" action="<?= $base ?>/admin/settings/crm">
    ...
    <div class="card setting-card shadow-sm mb-4">
        <div class="card-header bg-white py-3">
            <h6 class="mb-0"><i class="fas fa-power-off me-2"></i>Global CRM</h6>
        </div>
        <div class="card-body">
    ...
    <div class="card setting-card shadow-sm mb-4">
        <div class="card-header bg-white py-3">
            <h6 class="mb-0"><i class="fas fa-user-shield me-2"></i>Lead Permissions</h6>
        </div>
        <div class="card-body">
    ...
    <div class="card setting-card shadow-sm mb-4">
        <div class="card-header bg-white py-3">
            <h6 class="mb-0"><i class="fas fa-random me-2"></i>Auto-Assignment</h6>
        </div>
        <div class="card-body">
            <div class="setting-section">
    ...
    <div class="card setting-card shadow-sm mb-4">
        <div class="card-header bg-white py-3">
            <h6 class="mb-0"><i class="fas fa-star me-2"></i>Lead Scoring</h6>
        </div>
        <div class="card-body">
            <div class="setting-section">
                <div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <div class="card setting-card shadow-sm mb-4">
        <div class="card-header bg-white py-3">
            <h6 class="mb-0"><i class="fas fa-clock me-2"></i>SLA & Data Settings</h6>
        </div>
        <div class="card-body">
            <div class="row g-3">
                <div class="col-md-3">
