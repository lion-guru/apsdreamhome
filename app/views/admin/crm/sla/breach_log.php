...
<div class="container-fluid px-4 py-4">
    ...
    <div class="card border-0 shadow-sm" style="border-radius:14px"><div class="card-body p-0"><div class="table-responsive"><table class="table table-hover mb-0"><thead class="table-light"><tr><th>Time</th><th>Rule</th><th>Type</th><th>Lead</th><th>Phone</th><th>Target</th><th>Actual</th><th>Status</th></tr></thead><tbody>
