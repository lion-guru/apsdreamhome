...
<div class="container-fluid px-4 py-4">
    ...
    <div class="card border-0 shadow-sm"><div class="card-body p-0"><div class="table-responsive"><table class="table table-hover mb-0"><thead class="table-light"><tr><th>Name</th><th>Type</th><th>Target</th><th>Applies To (Roles)</th><th>Stages</th><th>Status</th></tr></thead><tbody>
