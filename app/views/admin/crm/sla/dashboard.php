...
<div class="container-fluid px-4 py-4">
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-md-2"><div class="sla-stat"><div class="stat-val style-23141"><?= $stats['compliance_rate'] ?? 0 ?>%</div><div class="stat-label">Compliance</div></div></div>
    </div>

    <?php if (!empty($breached)): ?>
    <div class="card border-0 shadow-sm mb-4 style-56956"><div class="card-header bg-danger text-white style-62632"><h6 class="mb-0"><i class="fas fa-exclamation-triangle me-1"></i>Recent Breaches</h6></div>
    ...
    <div class="card border-0 shadow-sm mb-4 style-56956"><div class="card-header bg-info text-white style-62632"><h6 class="mb-0"><i class="fas fa-hourglass-half me-1"></i>Pending SLAs (<?= count($pending) ?>)</h6></div>
    ...
    <div class="row g-3">
        <div class="col-md-8">
            <div class="card border-0 shadow-sm style-56956"><div class="card-header style-62632"><h6 class="mb-0"><i class="fas fa-cog me-1"></i>Active Rules</h6></div>
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm style-56956"><div class="card-header style-62632"><h6 class="mb-0"><i class="fas fa-plus me-1"></i>Add Rule</h6></div>
                <div class="card-body">
