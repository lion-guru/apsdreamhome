                            ...
                            <div class="card border-0 shadow-sm h-100">
                                <div class="card-body">
                                    ...
                                    <?php if (!empty($t['subject'])): ?>
                                        <p class="text-muted mb-1" style="font-size:13px"><strong>Subject:</strong> <?= htmlspecialchars(mb_strimwidth($t['subject'], 0, 60, '...')) ?></p>
                                    <?php endif; ?>
                                    <p class="text-muted mb-2" style="font-size:12px"><?= htmlspecialchars(mb_strimwidth($t['body'] ?? '', 0, 100, '...')) ?></p>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card border-0 shadow-sm h-100">
                                <div class="card-body">
                                    ...
                                    <p class="text-muted mb-2" style="font-size:12px"><?= htmlspecialchars(mb_strimwidth($t['body'] ?? '', 0, 120, '...')) ?></p>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <small class="text-muted"><i class="fas fa-folder me-1"></i><?= ucfirst($t['category'] ?? 'general') ?></small>
                                        <div class="d-flex gap-1">
                                            <a href="<?= BASE_URL ?>/admin/crm/templates/<?= $t['id'] ?>/edit" class="btn btn-sm btn-outline-primary"><i class="fas fa-edit"></i></a>
