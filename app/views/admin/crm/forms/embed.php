            ...
            <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="position-relative">
                        ...
                        <button class="btn btn-sm btn-primary position-absolute" style="top:8px;right:8px" onclick="copyToClipboard('iframeCode')"><i class="fas fa-copy"></i> Copy</button>
                    </div>
            ...
            <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="position-relative">
                        ...
                        <button class="btn btn-sm btn-primary position-absolute" style="top:8px;right:8px" onclick="copyToClipboard('scriptCode')"><i class="fas fa-copy"></i> Copy</button>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="position-relative">
                        ...
                        <button class="btn btn-sm btn-success position-absolute" style="top:8px;right:8px" onclick="copyToClipboard('directUrl')"><i class="fas fa-copy"></i> Copy</button>
                    </div>
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <p class="text-muted" style="font-size:13px">Paste the iframe code into a Custom HTML block in your page editor.</p>
                    <h6 class="fw-bold">For Shopify:</h6>
                    <p class="text-muted" style="font-size:13px">Add the iframe code to your theme's template files or use a Custom Liquid section.</p>
                    <h6 class="fw-bold">For Wix/Squarespace:</h6>
                    <p class="text-muted" style="font-size:13px">Use the "Embed HTML" or "Custom Code" widget to paste the iframe code.</p>
                    <h6 class="fw-bold">For Social Media:</h6>
                    <p class="text-muted" style="font-size:13px">Share the Direct URL via WhatsApp, Facebook, Instagram stories, or email campaigns.</p>
                </div>
            </div>
