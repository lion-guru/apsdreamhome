...
<div class="container-fluid px-4 py-4">
    ...
    <div class="voice-call-ui">
        ...
        <div class="lead-avatar-lg"><?= $initials ?></div>
        ...
        <div class="card border-0 shadow-sm mb-3"><div class="card-body text-start">
        ...
        <div class="card border-0 shadow-sm"><div class="card-body text-start">
