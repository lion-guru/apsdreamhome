...
<div class="container-fluid px-4 py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="/admin/crm/custom-fields/create" class="btn btn-primary"><i class="fas fa-plus me-1"></i>Add Field</a>
    </div>
        ...
        <div class="col-md-6 col-lg-4">
            <div class="cf-card h-100">
                ...
                <div class="mt-3 d-flex gap-2">
                    <a href="/admin/crm/custom-fields/<?= $f['id'] ?>/edit" class="btn btn-sm btn-outline-primary"><i class="fas fa-edit"></i></a>
                    <form method="POST" action="/admin/crm/custom-fields/<?= $f['id'] ?>/delete" onsubmit="return confirm('Delete this field?')"><input type="hidden" name="csrf_token" value="<?= $_SESSION['csrf_token'] ?? '' ?>"><button class="btn btn-sm btn-outline-danger"><i class="fas fa-trash"></i></button></form>
                </div>
            </div>
        </div>
        <?php endforeach; ?>
