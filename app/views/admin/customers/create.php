        ...
        <div class="card-body p-4">
            <form method="POST" action="/admin/customers/store">
                <div class="row g-3">
                    ...
                    <div class="col-12"><button type="submit" class="btn btn-primary"><i class="fas fa-save me-1"></i>Save Customer</button> <a href="/admin/customers" class="btn btn-secondary">Cancel</a></div>
                </div>
            </form>
        </div>
    </div>
