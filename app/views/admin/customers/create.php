        ...
        <div class="col-md-8 offset-md-2">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="http://localhost.//admin/customers/store" method="POST" class="needs-validation" novalidate>
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group mb-3">
                                    <label class="form-label"><?php echo h($mlSupport->translate('Gender')); ?></label>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group mb-3">
                                    <label class="form-label"><?php echo h($mlSupport->translate('Marital Status')); ?></label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group mb-3">
                                    <label class="form-label"><?php echo h($mlSupport->translate('Referral Source')); ?></label>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group mb-3">
                                    <label class="form-label"><?php echo h($mlSupport->translate('Sponsor ID (Optional)')); ?></label>
