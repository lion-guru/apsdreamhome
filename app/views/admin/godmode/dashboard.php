...
<div class="god-mode-dashboard">
    ...
    <?php if ($roleSwitched): ?>
    <div class="container mt-3">
        <div class="alert alert-warning-god">
            ...
            <div class="col-lg-6">
                <div class="god-card">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mt-2">
                            <span class="badge bg-secondary me-1" onclick="filterUsers('customer')">users</span>
                            <span class="badge bg-secondary me-1" onclick="filterUsers('associate')">users</span>
                            <span class="badge bg-secondary me-1" onclick="filterUsers('agent')">users</span>
                            <span class="badge bg-secondary me-1" onclick="filterUsers('employee')">users</span>
                        </div>
                    </div>
