...
<div class="container-fluid">
        ...
        <div class="row align-items-center">
            <div class="col">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="/admin/media/show/<?= $media['id'] ?? 0 ?>"><?= $media['title'] ?? 'Media' ?></a></li>
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body p-4">
            <form method="POST" action="/admin/media/update/<?= $media['id'] ?? 0 ?>">
                <div class="row g-3">
                    ...
                    <div class="col-12"><button type="submit" class="btn btn-primary"><i class="fas fa-save me-1"></i>Update</button> <a href="/admin/media" class="btn btn-secondary">Cancel</a></div>
                </div>
            </form>
        </div>
    </div>
