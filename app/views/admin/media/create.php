        ...
        <div class="card-body p-4">
            <form method="POST" action="/admin/media/store" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12"><button type="submit" class="btn btn-primary"><i class="fas fa-upload me-1"></i>Upload</button> <a href="/admin/media" class="btn btn-secondary">Cancel</a></div>
                </div>
            </form>
        </div>
    </div>
