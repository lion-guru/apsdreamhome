...
<div class="container-fluid">
    <div class="page-header mb-4">
        <div class="row align-items-center">
            ...
            <div class="col-auto">
                <a href="/admin/media/edit/<?= $media['id'] ?? 0 ?>" class="btn btn-primary btn-sm"><i class="fas fa-edit me-1"></i>Edit</a>
                <a href="/admin/media" class="btn btn-secondary btn-sm"><i class="fas fa-arrow-left me-1"></i>Back</a>
            </div>
        </div>
    </div>
    <?php if (empty($media)): ?>
            ...
            <div class="card shadow-sm border-0">
                <div class="card-body text-center p-4">
                    <?php if (strpos($media['mime_type'] ?? '', 'image') !== false): ?>
                        <img src="<?= $media['url'] ?? '/assets/images/placeholder.svg' ?>" class="img-fluid rounded" alt="<?= $media['title'] ?>" style="max-height:300px">
                    <?php else: ?>
