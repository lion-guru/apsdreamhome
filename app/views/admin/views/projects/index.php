                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                ...
                                                <div class="me-3">
                                                    <img src="<?php echo h($project['thumbnail']); ?>" 
                                                         class="avatar avatar-sm me-3">
                                                </div>
                                                <?php endif; ?>
                                                <div class="d-flex flex-column justify-content-center">
                                                    <h6 class="mb-0 text-sm"><?php echo h($project['name']); ?></h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td><?php echo h($project['location']); ?></td>
                                        <td>
                                        ...
                                        <td>
                                            <?php echo (int)$project['available_units']; ?> / <?php echo (int)$project['total_units']; ?>
                                        </td>
                                        <td>
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" 
                                                       <?php echo $project['featured'] ? 'checked' : ''; ?>
                                                       onchange="toggleFeatured(<?php echo (int)$project['id']; ?>, this)">
                                            </div>
                                        </td>
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-sm btn-danger"
                                                    onclick="deleteProject(<?php echo (int)$project['id']; ?>)">Delete</button>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
