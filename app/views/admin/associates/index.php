...
$title = $title ?? $mlSupport->translate("Associates Management");
        ...
        <div class="page-header">
            <div class="row align-items-center">
                ...
                <div class="col-auto float-end ms-auto">
                    <a href="/admin/associates/create" class="btn add-btn"><i class="fa fa-plus"></i> <?php echo h($mlSupport->translate('Add Associate')); ?></a>
                </div>
            </div>
        </div>
