...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0"><i class="fas fa-brain"></i> Agentic AI System</h1>
                    <small class="text-muted">Autonomous AI Agents running your company 24/7</small>
                </div>
                <div class="col-sm-6 text-right">
                    <button onclick="runAllAgents(this)" class="btn btn-sm"><i class="fas fa-play me-1"></i> Run All Agents</button>
                                ...
                                <table class="table table-sm table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <span ><i class="fas <?= $ag['icon'] ?>"></i> <?= $ag['name'] ?></span>
                                        </td>
                    ...
                    <div class="card card-outline card-purple">
                        ...
                        <div class="card-body">
                            <ol class="small mb-0 pl-3">
                                ...
                                <li class="mb-2"><strong>Low confidence</strong> â†’ escalates to human</li>
