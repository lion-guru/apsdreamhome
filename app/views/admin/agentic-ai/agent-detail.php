...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0"><i class="fas <?= $_agent['icon'] ?>"></i> <?= htmlspecialchars($_agent['name'] ?? '') ?></h1>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card card-outline card-danger">
                        <div class="card-header"><h3 class="card-title"><i class="fas fa-exclamation-triangle"></i> Pending Escalations</h3></div>
                        <div class="card-body p-0">
