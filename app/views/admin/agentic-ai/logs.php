...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0"><i class="fas fa-list"></i> Agent Logs</h1>
                </div>
                ...
                <div class="card-body p-0">
                    ...
                    <div class="table-responsive">
                        <table class="table table-sm table-hover">
                            ...
                            <tr>
                                <td class="text-muted small"><?= date('H:i:s', strtotime($l['created_at'])) ?></td>
                                <td>
                                    <?php $a = $_ag[$l['agent_type']] ?? ['name' => $l['agent_type'], 'color' => '#666', 'icon' => 'fa-robot']; ?>
                                    <span ><i class="fas <?= $a['icon'] ?>"></i> <?= htmlspecialchars($a['name'] ?? '') ?></span>
                                </td>
