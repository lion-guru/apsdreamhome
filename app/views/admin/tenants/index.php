...
<div class="tenant-list-header">
    <div class="d-flex justify-content-between align-items-center">
        <div>
            ...
            <p class="mb-0 mt-1" style="opacity:0.85;">Manage all SaaS tenants and subscriptions (<?= $total ?> total)</p>
        </div>
        <div>
                        ...
                        <?php $i = ($page - 1) * ($per_page ?? 20); foreach ($tenants as $t): $i++; ?>
                            <tr class="tenant-row">
                                ...
                                <td>
                                    ...
                                    ?>
                                    <div class="usage-bar mt-1"><div class="usage-fill" style="width:<?= min(100, $usagePct) ?>%;background:<?= $barColor ?>;"></div></div>
                                </td>
                                <td>
