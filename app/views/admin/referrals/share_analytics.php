...
<div class="container-fluid px-4 py-3">
    ...
    <div class="row g-3 mb-4">
        <div class="col-md-3 col-6">
            <div class="card border-0 shadow-sm text-center py-3">
                <div style="font-size:1.8rem;font-weight:700;color:#6366f1;"><?= number_format($funnel['total_shares'] ?? 0) ?></div>
                <div class="text-muted small">Total Shares</div>
            </div>
        </div>
        <div class="col-md-3 col-6">
            <div class="card border-0 shadow-sm text-center py-3">
                <div style="font-size:1.8rem;font-weight:700;color:#10b981;"><?= number_format($funnel['total_signups'] ?? 0) ?></div>
                <div class="text-muted small">Signups</div>
            </div>
        </div>
        <div class="col-md-3 col-6">
            <div class="card border-0 shadow-sm text-center py-3">
                <div style="font-size:1.8rem;font-weight:700;color:#f59e0b;"><?= number_format($funnel['total_bookings'] ?? 0) ?></div>
                <div class="text-muted small">Bookings</div>
            </div>
        </div>
        <div class="col-md-3 col-6">
            <div class="card border-0 shadow-sm text-center py-3">
                <div style="font-size:1.8rem;font-weight:700;color:#ef4444;"><?= ($funnel['conversion_rate'] ?? 0) ?>%</div>
    ...
    <div class="card border-0 shadow-sm mb-4">
        ...
        <div class="card-body">
            <div class="d-flex align-items-center justify-content-center gap-2" style="flex-wrap:wrap;">
                <div class="text-center p-3 rounded" style="background:#6366f122;min-width:150px;">
                    <div style="font-size:1.5rem;font-weight:700;color:#6366f1;"><?= number_format($funnel['total_shares'] ?? 0) ?></div>
                    <div class="small text-muted">Shares</div>
                </div>
                <i class="fas fa-arrow-right text-muted"></i>
                <div class="text-center p-3 rounded" style="background:#10b98122;min-width:150px;">
                    <div style="font-size:1.5rem;font-weight:700;color:#10b981;"><?= number_format($funnel['total_signups'] ?? 0) ?></div>
                    <div class="small text-muted">Signups (<?= ($funnel['conversion_rate'] ?? 0) ?>%)</div>
                </div>
                <i class="fas fa-arrow-right text-muted"></i>
                <div class="text-center p-3 rounded" style="background:#f59e0b22;min-width:150px;">
                    <div style="font-size:1.5rem;font-weight:700;color:#f59e0b;"><?= number_format($funnel['total_bookings'] ?? 0) ?></div>
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center mb-2">
                        <span class="text-capitalize" style="width:100px;">
                            <?php
                        ...
                        <div class="flex-grow-1 mx-2">
                            <div class="progress" style="height:8px;">
                                <div class="progress-bar" style="width:<?= round(($count / max($platforms)) * 100) ?>%;background:#6366f1;"></div>
                            </div>
                        </div>
                        <strong style="width:50px;text-align:right;"><?= number_format($count) ?></strong>
                    </div>
                    <?php endforeach; ?>
                    <?php endif; ?>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div>
                            ...
                            <span class="badge bg-light text-dark me-1" style="font-size:0.7rem;"><?= ucfirst($p) ?>: <?= $c ?></span>
                            <?php endforeach; ?>
                        </div>
                    </div>
                    <?php endforeach; ?>
