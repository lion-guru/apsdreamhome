    ...
    <div class="row g-3 mb-4">
        <div class="col-md-3 col-6">
            <div class="card border-0 shadow-sm text-center py-3">
                <div ><?= number_format($funnel['total_shares'] ?? 0) ?></div>
                <div class="text-muted small">Total Shares</div>
            </div>
        </div>
        <div class="col-md-3 col-6">
            <div class="card border-0 shadow-sm text-center py-3">
                <div ><?= number_format($funnel['total_signups'] ?? 0) ?></div>
                <div class="text-muted small">Signups</div>
            </div>
        </div>
        <div class="col-md-3 col-6">
            <div class="card border-0 shadow-sm text-center py-3">
                <div ><?= number_format($funnel['total_bookings'] ?? 0) ?></div>
                <div class="text-muted small">Bookings</div>
            </div>
        </div>
        <div class="col-md-3 col-6">
            <div class="card border-0 shadow-sm text-center py-3">
                <div ><?= ($funnel['conversion_rate'] ?? 0) ?>%</div>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div>
                            ...
                            <span class="badge bg-light text-dark me-1"><?= ucfirst($p) ?>: <?= $c ?></span>
                            <?php endforeach; ?>
                        </div>
                    </div>
                    <?php endforeach; ?>
