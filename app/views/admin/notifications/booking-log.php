                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <table class="table table-sm">
                                                    <tr><td class="text-muted">Customer</td><td><?= htmlspecialchars($log['user_name'] ?? '') ?> (<?= htmlspecialchars($log['user_email'] ?? '') ?>)</td></tr>
                                                ...
                                                <div class="mt-2">
                                                    ...
                                                    <div class="bg-light p-3 rounded small"><?= htmlspecialchars($log['message'] ?? '') ?></div>
                                                </div>
