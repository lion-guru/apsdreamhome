                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <table class="table table-sm">
                                                    <tr><td class="text-muted" style="width:120px">Customer</td><td><?= htmlspecialchars($log['user_name'] ?? '') ?> (<?= htmlspecialchars($log['user_email'] ?? '') ?>)</td></tr>
                                                ...
                                                <div class="mt-2">
                                                    ...
                                                    <div class="bg-light p-3 rounded small" style="max-height:200px; overflow-y:auto; white-space:pre-wrap;"><?= htmlspecialchars($log['message'] ?? '') ?></div>
                                                </div>
