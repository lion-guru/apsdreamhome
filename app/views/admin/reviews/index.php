                        ...
                        <?php if (empty($reviews)): ?>
                            <tr>
                                <td colspan="9" class="text-center py-5">
                                    <i class="fas fa-star fa-3x text-muted mb-3 style-82835"></i>
                ...
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        <?php if (empty($testimonials)): ?>
                            <tr>
                                <td colspan="9" class="text-center py-5">
                                    <i class="fas fa-quote-left fa-3x text-muted mb-3 style-82835"></i>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php if (!empty($t['client_photo'])): ?>
                                            <br><img src="<?= BASE_URL ?>/assets/images/placeholder/property.svg" class="rounded-circle mt-1 style-91602" />
                                        <?php endif; ?>
                                    </td>
                                    <td>
