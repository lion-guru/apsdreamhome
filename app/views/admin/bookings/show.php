                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <p><strong>Booking Number:</strong><br>
                                            <span class="badge bg-primary"><?= htmlspecialchars($booking['booking_number']) ?></span></p>
                                        ...
                                        <p><strong>Total Amount:</strong><br>
                                            <span class="text-success fw-bold">₹<?= number_format($booking['total_amount'], 2) ?></span></p>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <h4 class="text-primary">₹<?= number_format($booking['total_amount'], 2) ?></h4>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <h4 class="text-danger">₹<?= number_format($booking['total_amount'] - $total_paid, 2) ?></h4>
                                </div>
                                    ...
                                    <tbody>
                                        <?php foreach ($commissions as $commission): ?>
                                            <tr class="commission-row">
                                                ...
                                                <td class="fw-bold text-info">₹<?= number_format($commission['amount'], 2) ?></td>
                                                <td>
