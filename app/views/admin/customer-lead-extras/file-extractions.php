                    ...
                    <tbody>
                        <?php if (!empty($fileExtractions)): ?>
                            <?php foreach ($fileExtractions as $extraction): ?>
                                <tr>
                                    <td>
                                        <div class="text-truncate" title="<?php echo htmlspecialchars($extraction['file_name'] ?? ''); ?>">
                                            <?php echo htmlspecialchars($extraction['file_name'] ?? ''); ?>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="text-truncate" title="<?php echo htmlspecialchars($extraction['original_name'] ?? ''); ?>">
                    ...
                    if (data.success) {
                        modalBody.innerHTML = `
                            ...
                            <div class="mb-4">
                                ...
                                <pre class="bg-light p-3 rounded">${JSON.stringify(data.extraction.extracted_data, null, 2)}</pre>
                            </div>
                            <?php endif; ?>
                        `;
                    } else {
