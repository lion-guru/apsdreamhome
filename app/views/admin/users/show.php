...
<div class="row g-4">
        ...
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body">
                <table class="table table-sm mb-0">
                    <tr><td class="text-muted">Phone</td><td><?= htmlspecialchars($user['phone'] ?? 'N/A') ?></td></tr>
    ...
    <div class="col-md-6">
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body">
                <table class="table table-sm mb-0">
                    <tr><td class="text-muted">Referral Code</td><td><code class="fs-6"><?= htmlspecialchars($user['referral_code'] ?? 'N/A') ?></code></td></tr>
            ...
            <div class="card-body">
                ...
                <form id="referralForm">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="new_referral_code" required minlength="3" maxlength="20" value="<?= htmlspecialchars($user['referral_code'] ?? '') ?>">
                    </div>
