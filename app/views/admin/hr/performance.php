                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="progress flex-grow-1 me-2" style="height:6px;max-width:80px;">
                                            <div class="progress-bar bg-<?= ($r['achievement_percentage'] ?? 0) >= 100 ? 'success' : (($r['achievement_percentage'] ?? 0) >= 80 ? 'warning' : 'danger') ?>" style="width:<?= min(100, $r['achievement_percentage'] ?? 0) ?>%"></div>
                                        </div>
