    ...
    <div class="col-md-6">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white py-3">
                <h6 class="mb-0 fw-bold"><i class="fas fa-user-tie me-2 text-primary"></i>Active Employees</h6>
            </div>
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            <?php if (empty($active_employees)): ?>
                                <tr><td colspan="4" class="text-center text-muted py-3">No active employees</td></tr>
                            <?php else: ?>
                                <?php foreach ($active_employees as $e): ?>
                                    <tr>
                                        <td><a href="<?= BASE_URL ?>/admin/hr/employees/view/<?= $e['id'] ?>"><?= htmlspecialchars($e['name'] ?? '') ?></a></td>
        ...
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body">
                <div class="d-grid gap-2">
                    <a href="<?= BASE_URL ?>/admin/hr/employees" class="btn btn-outline-primary text-start"><i class="fas fa-list me-2"></i>Manage Employees</a>
                    <a href="<?= BASE_URL ?>/admin/hr/employees/create" class="btn btn-outline-success text-start"><i class="fas fa-plus me-2"></i>Add New Employee</a>
