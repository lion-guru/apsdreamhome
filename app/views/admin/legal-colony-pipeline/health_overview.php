          ...
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-start mb-3">
              ...
              <div class="text-center">
                <div class="rounded-circle d-inline-flex align-items-center justify-content-center bg-<?= $grade['color'] ?> text-white fw-bold">
                  <?= $grade['letter'] ?>
                </div>
              </div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="progress">
                <div class="progress-bar bg-<?= $grade['color'] ?>"></div>
              </div>
            </div>
