      ...
      <div class="d-flex align-items-center justify-content-between">
        ...
        foreach ($stageKeys as $i => $sk): ?>
          <div class="text-center flex-fill">
            <div class="rounded-circle bg-<?= $stageColors[$i] ?> d-inline-flex align-items-center justify-content-center mb-1">
                  ...
                  ?>
                    <div class="d-flex align-items-center gap-2">
                      <div class="position-relative">
                        ...
                        <span class="position-absolute top-50 start-50 translate-middle fw-bold small"><?= $letter ?></span>
                      </div>
                      <div>
