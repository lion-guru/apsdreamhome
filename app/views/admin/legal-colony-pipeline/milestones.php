            ...
            ?>
              <div class="timeline-item mb-4 position-relative ps-5">
                ...
                <div class="position-absolute top-0 start-0 translate-middle">
                  <div class="rounded-circle bg-<?= $color ?> d-flex align-items-center justify-content-center">
                    <i class="fas <?= $icon ?> text-white fa-sm"></i>
                  </div>
                  <?php if ($i < count($milestones) - 1): ?>
                    <div class="position-absolute top-100 start-50 translate-middle-x bg-<?= $color ?>-subtle"></div>
                  <?php endif; ?>
                </div>
