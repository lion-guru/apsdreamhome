    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card aps-cp-card">
                ...
                <div class="card-footer"><a href="<?= BASE_URL ?>/admin/commission/telecaller/rules" class="btn btn-sm">Manage Rules</a></div>
            </div>
        </div>
    </div>
            ...
            <div class="card aps-cp-card">
                ...
                <div class="card-body aps-cp-card-body">
                    <div class="row text-center">
                        ...
                        <div class="col-6 col-md-2 mb-2"><a href="<?= BASE_URL ?>/admin/commission/telecaller/rules" class="btn btn-outline-purple btn-sm w-100">TC Rules</a></div>
                        <div class="col-6 col-md-2 mb-2"><a href="<?= BASE_URL ?>/admin/commission/telecaller/commissions" class="btn btn-outline-purple btn-sm w-100">TC Commissions</a></div>
