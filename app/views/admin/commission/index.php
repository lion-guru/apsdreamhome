ï»¿<div class="container-fluid">
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-md-3">
            <div class="card aps-cp-card style-3150">
                <div class="card-body text-center">
                    <h6>Telecaller</h6>
    ...
    <div class="row">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colspan="3" class="text-center py-5">
                                    <i class="fas fa-dollar-sign fa-3x text-muted mb-3 style-82835"></i>
        ...
        <div class="col-md-4">
            <div class="card aps-cp-card">
                ...
                <div class="card-body p-0">
                    <div class="table-responsive"><table class="table table-sm mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colspan="3" class="text-center py-5">
                                    <i class="fas fa-phone fa-3x text-muted mb-3 style-82835"></i>
                ...
                <div class="card-footer"><a href="<?= BASE_URL ?>/admin/commission/telecaller/rules" class="btn btn-sm style-3150">Manage Rules</a></div>
            </div>
        </div>
    </div>
            ...
            <div class="card aps-cp-card">
                ...
                <div class="card-body aps-cp-card-body">
                    <div class="row text-center">
                        ...
                        <div class="col-6 col-md-2 mb-2"><a href="<?= BASE_URL ?>/admin/commission/telecaller/rules" class="btn btn-outline-purple btn-sm w-100 style-2592">TC Rules</a></div>
                        <div class="col-6 col-md-2 mb-2"><a href="<?= BASE_URL ?>/admin/commission/telecaller/commissions" class="btn btn-outline-purple btn-sm w-100 style-2592">TC Commissions</a></div>
