                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="11" class="text-center py-5">
                            <i class="fas fa-calculator fa-3x text-muted mb-3" style="opacity:0.2"></i>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form method="POST" action="<?= BASE_URL ?>/admin/commission/associate/calc-status/<?= $c['id'] ?>" style="display:inline" onsubmit="return confirm('Confirm calculation #<?= $c['id'] ?>?')">
                            ...
                            <form method="POST" action="<?= BASE_URL ?>/admin/commission/associate/calc-status/<?= $c['id'] ?>" style="display:inline" onsubmit="return confirm('Mark #<?= $c['id'] ?> as paid?')">
                                <input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($_SESSION['csrf_token'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
