                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form method="POST" action="<?= BASE_URL ?>/admin/commission/associate/calc-status/<?= $c['id'] ?>" data-aps-confirm="Confirm calculation #<?= $c['id'] ?>?">
                            ...
                            <form method="POST" action="<?= BASE_URL ?>/admin/commission/associate/calc-status/<?= $c['id'] ?>" data-aps-confirm="Mark #<?= $c['id'] ?> as paid?">
                                <input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($_SESSION['csrf_token'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
