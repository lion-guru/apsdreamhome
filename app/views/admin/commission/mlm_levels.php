                    ...
                    <div class="table-responsive"><table class="table table-striped mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><form method="POST" action="<?= BASE_URL ?>/admin/commission/mlm/levels/delete/<?= $l['id'] ?>" data-aps-confirm="Delete level #<?= $l['id'] ?>?"><input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($_SESSION['csrf_token'] ?? '', ENT_QUOTES, 'UTF-8'); ?>"><button type="submit" class="btn btn-sm btn-danger" aria-label="Delete"><i class="fas fa-trash"></i></button></form></td>
                            </tr>
                            <?php endforeach; ?>
                            <?php endif; ?>
                        </tbody>
