        ...
        <form method="POST" action="<?= $base ?>/admin/commission-plans/store">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-2">
                    ...
                    <input type="text" name="plan_code" class="cp-input" required placeholder="e.g. STD" maxlength="20">
                </div>
                <div class="col-md-2">
            ...
            <h6 ><i class="fas fa-cog me-1"></i>Global Commission Parameters</h6>
            <div class="row mb-4">
                <div class="col-md-2">
            ...
            <h6 ><i class="fas fa-layer-group me-1"></i>Rank Levels (Default 7)</h6>
            <div >
                <table class="table rank-table m-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><input type="number" value="<?= $r[8] ?>" step="100000" min="0" ></td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
