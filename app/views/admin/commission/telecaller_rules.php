    ...
    <div class="row">
        <div class="col-md-5">
            <div class="card aps-cp-card">
                <div class="card-header aps-cp-card-header style-3150"><i class="fas fa-plus"></i> Add Rule</div>
                <div class="card-body aps-cp-card-body">
                    <form method="post" action="<?= BASE_URL ?>/admin/commission/telecaller/rules/store">
                        ...
                        <button type="submit" class="btn style-3150"><i class="fas fa-save"></i> Save Rule</button>
                    </form>
                </div>
            </div>
        </div>
