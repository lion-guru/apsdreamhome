        ...
        <div class="row align-items-center">
            <div class="col">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="/admin/tasks/show/<?= $task['id'] ?? 0 ?>"><?= $task['title'] ?? 'Task' ?></a></li>
        ...
        <div class="card-body p-4">
            <form method="POST" action="/admin/tasks/update/<?= $task['id'] ?? 0 ?>">
                <div class="row g-3">
                    ...
                    <div class="col-12"><button type="submit" class="btn btn-primary"><i class="fas fa-save me-1"></i>Update Task</button> <a href="/admin/tasks" class="btn btn-secondary">Cancel</a></div>
                </div>
            </form>
        </div>
    </div>
