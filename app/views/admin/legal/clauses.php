                ...
                <div class="col-md-6">
                    <div class="aps-cp-card h-100">
                        <div class="aps-cp-card-body">
                            ...
                            <div class="small text-muted mb-2 border-start border-3 border-primary ps-2" style="max-height:80px;overflow-y:auto"><?= nl2br(htmlspecialchars(substr($cl['content'] ?? '', 0, 300))) ?></div>
