    ...
    <div class="row g-4">
        ...
        <div class="col-lg-4">
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body">
                    <?php foreach ($metrics as $key => $val): ?><div class="d-flex justify-content-between mb-2 pb-2 border-bottom"><span class="small text-capitalize"><?= str_replace('_', ' ', $key) ?></span><strong><?= $val ?></strong></div><?php endforeach; ?>
            ...
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body">
                    ...
                    <?php foreach ($data as $key => $val): ?><div class="d-flex justify-content-between small mb-1"><span class="text-capitalize"><?= str_replace('_', ' ', $key) ?></span><strong><?= $val ?></strong></div><?php endforeach; ?>
                    <hr>
                    <?php endforeach; ?>
