    ...
    <div class="col-md-6">
        <div class="card border-0 shadow-sm h-100">
            ...
            <div class="card-body aps-cp-card-body">
                ...
                <div id="tin26qResult" class="mt-3" style="display:none;"></div>
            </div>
        </div>
    </div>
    <div class="col-md-6">
        <div class="card border-0 shadow-sm h-100">
            ...
            <div class="card-body aps-cp-card-body">
                ...
                <div id="tin27qResult" class="mt-3" style="display:none;"></div>
            </div>
        </div>
    </div>
</div>
...
<div class="card border-0 shadow-sm mb-4">
    ...
    <div class="card-body aps-cp-card-body">
        ...
        <div id="form16aResult" class="mt-3" style="display:none;"></div>
    </div>
</div>
