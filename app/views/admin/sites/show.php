    ...
    <div class="row g-4">
        ...
        <div class="col-md-4">
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body aps-cp-card-body">
                    <div class="mb-3"><small class="text-muted d-block">Development Progress</small><div class="progress"><div class="progress-bar bg-success"></div></div><small class="text-muted"><?= ($site['total_area'] ?? 0) > 0 ? round(($site['developed_area'] ?? 0) / $site['total_area'] * 100) : 0 ?>% developed</small></div>
