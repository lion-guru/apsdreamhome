...
<div class="container-fluid">
    ...
    <div class="row g-4 mb-4">
        <div class="col-md-3"><div class="card bg-primary text-white border-0 shadow-sm"><div class="card-body"><h6>Total Members</h6><h3 class="mb-0"><?= number_format($totalMembers ?? 0) ?></h3></div></div></div>
        <div class="col-md-3"><div class="card bg-success text-white border-0 shadow-sm"><div class="card-body"><h6>Active Members</h6><h3 class="mb-0"><?= number_format($activeMembers ?? 0) ?></h3></div></div></div>
        <div class="col-md-3"><div class="card bg-info text-white border-0 shadow-sm"><div class="card-body"><h6>Total Teams</h6><h3 class="mb-0"><?= number_format($totalTeams ?? 0) ?></h3></div></div></div>
        <div class="col-md-3"><div class="card bg-warning text-white border-0 shadow-sm"><div class="card-body"><h6>Network Growth</h6><h3 class="mb-0">+<?= number_format($newMembers ?? 0) ?></h3><small>This month</small></div></div></div>
    </div>
