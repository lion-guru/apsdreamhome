<div class="container-fluid py-4">
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm"><div class="card-body"><div class="d-flex align-items-center"><div class="flex-shrink-0"><div class="rounded-circle bg-info bg-opacity-10 p-3"><i class="fas fa-upload fa-2x text-info"></i></div></div><div class="ms-3"><h6 class="mb-1 text-muted">Imports Today</h6><h3 class="mb-0"><?= (int)($stats['imports_today'] ?? 0) ?></h3></div></div></div></div>
        </div>
        <div class="col-md-3">
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm"><div class="card-body"><div class="d-flex align-items-center"><div class="flex-shrink-0"><div class="rounded-circle bg-danger bg-opacity-10 p-3"><i class="fas fa-times-circle fa-2x text-danger"></i></div></div><div class="ms-3"><h6 class="mb-1 text-muted">Failed</h6><h3 class="mb-0"><?= (int)($stats['failed'] ?? 0) ?></h3></div></div></div></div>
        </div>
    </div>
