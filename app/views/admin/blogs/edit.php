        ...
        <div class="col-12">
            <div class="card aps-cp-card">
                ...
                <div class="card-body aps-cp-card-body">
                    <form action="<?php echo BASE_URL; ?>/admin/blog/<?php echo e($blog['id']); ?>/update" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <img src="<?php echo BASE_URL;?>/assets/images/blogs/<?php echo htmlspecialchars($blog['image'] ?? ''); ?>" class="mt-2" alt="<?php echo htmlspecialchars($blog['title'] ?? 'Blog image'); ?>" loading="lazy">
                                    <?php endif; ?>
                                </div>
                                <div class="mb-3">
