...
<div class="container-fluid">
    ...
    <div class="row g-4 mb-4">
        <div class="col-md-3"><div class="card bg-primary text-white border-0 shadow-sm"><div class="card-body"><h6>Total Commission</h6><h3 class="mb-0">₹<?= number_format($totalCommission ?? 0, 2) ?></h3></div></div></div>
        <div class="col-md-3"><div class="card bg-success text-white border-0 shadow-sm"><div class="card-body"><h6>Paid</h6><h3 class="mb-0">₹<?= number_format($paidCommission ?? 0, 2) ?></h3></div></div></div>
        <div class="col-md-3"><div class="card bg-warning text-white border-0 shadow-sm"><div class="card-body"><h6>Pending</h6><h3 class="mb-0">₹<?= number_format($pendingCommission ?? 0, 2) ?></h3></div></div></div>
        <div class="col-md-3"><div class="card bg-info text-white border-0 shadow-sm"><div class="card-body"><h6>Recipients</h6><h3 class="mb-0"><?= number_format($recipientCount ?? 0) ?></h3></div></div></div>
    </div>
