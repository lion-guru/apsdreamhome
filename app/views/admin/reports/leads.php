...
<div class="container-fluid">
    ...
    <div class="row g-4 mb-4">
        <div class="col-md-3"><div class="card bg-primary text-white border-0 shadow-sm"><div class="card-body"><h6>Total Leads</h6><h3 class="mb-0"><?= number_format($totalLeads ?? 0) ?></h3></div></div></div>
        <div class="col-md-3"><div class="card bg-success text-white border-0 shadow-sm"><div class="card-body"><h6>Converted</h6><h3 class="mb-0"><?= number_format($convertedLeads ?? 0) ?></h3></div></div></div>
        <div class="col-md-3"><div class="card bg-warning text-white border-0 shadow-sm"><div class="card-body"><h6>Conversion Rate</h6><h3 class="mb-0"><?= number_format($conversionRate ?? 0, 1) ?>%</h3></div></div></div>
        <div class="col-md-3"><div class="card bg-info text-white border-0 shadow-sm"><div class="card-body"><h6>Avg. Score</h6><h3 class="mb-0"><?= number_format($avgScore ?? 0, 1) ?></h3></div></div></div>
    </div>
    <div class="row">
