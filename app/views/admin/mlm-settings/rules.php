            ...
            <tbody>
                ...
                <tr>
                    <td colspan="6" class="text-center py-5">
                        <i class="fas fa-cogs fa-3x text-muted mb-3 style-82835"></i>
                ...
                <tr>
                    ...
                    <td>
                        <form method="POST" action="<?php echo BASE_URL; ?>/admin/mlm-settings/rules/update/<?php echo e($r['id']); ?>" class="d-flex align-items-center gap-2">
                            ...
                            <input type="number" step="0.01" name="rate_percentage" value="<?php echo e($r['rate_percentage']); ?>" class="form-control form-control-sm style-31652">
                    </td>
