        ...
        <div class="col-md-3 col-6">
            <div class="aps-cp-card">
                <div class="aps-cp-card-body text-center">
                    <div ><?= (int)($stats['total_ranks'] ?? 0) ?></div>
            ...
            <div class="aps-cp-card">
                <div class="aps-cp-card-body text-center">
                    ...
                    <?php foreach ($recentPromotions as $rp): ?>
                        ...
                        <?php endif; ?>
                    <?php endforeach; ?>
                    <div ><?= $withTime > 0 ? round($totalDays / $withTime) . 'd' : '-' ?></div>
        ...
        <div class="col-md-3 col-6">
            <div class="aps-cp-card">
                <div class="aps-cp-card-body text-center">
                    ...
                    <div ><i class="fas fa-crown me-1"></i><?= htmlspecialchars($highestRank ?? '') ?></div>
                    ...
                    <div class="border-bottom px-3 py-2">
                        ...
                        <?php if (!empty($perks)): ?>
                            <?php foreach ($perks as $k => $v): ?>
                                <div class="text-muted"><i class="fas fa-check text-success me-1"></i><?= htmlspecialchars($v ?? '') ?></div>
                            <?php endforeach; ?>
                        <?php else: ?>
                    ...
                    <?php else: ?>
                        ...
                        <div class="d-flex align-items-center border-bottom px-3 py-2">
                            <div class="flex-grow-1">
                                ...
                                <div class="text-muted"><?= htmlspecialchars($rp['current_level'] ?? '') ?></div>
                            </div>
                            <div class="text-end">
                                <div class="badge bg-success"><i class="fas fa-arrow-up me-1"></i>Promoted</div>
                                <div class="text-muted"><?= htmlspecialchars($rp['rank_updated_at'] ?? '') ?></div>
                            </div>
                        </div>
                        <?php endforeach; ?>
                    <?php endif; ?>
