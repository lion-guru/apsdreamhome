...
function renderGenealogyNode($userId, $sponsorTree, $rankColors, $rankIcons, $base, $depth = 0) {
    ...
    $html = '';
    if ($depth > 0) $html .= '<ul class="genealogy-tree">';
    if ($depth === 0) $html .= '<ul class="genealogy-tree">';
    foreach ($children as $m) {
        ...
        $html .= '<li >';
        $html .= '<div class="d-inline-flex align-items-center border rounded px-3 py-2 genealogy-node">';
        $html .= '<span class="badge me-2"><i class="fas ' . $icon . '"></i></span>';
        $html .= '<span class="fw-bold small me-2">' . $name . '</span>';
        $html .= '<span class="text-muted">' . $email . '</span>';
        $html .= '</span></div>';
...
<div class="container-fluid py-4">
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-md-3 col-6">
            <div class="aps-cp-card">
                <div class="aps-cp-card-body text-center">
                    <div >&#8377;<?= number_format($totalVolume / 1000, 1) ?>K</div>
                ...
                <div class="aps-cp-card-body">
                    ...
                    <?php else: ?>
                        ...
                        <div class="mb-4 genealogy-root">
                            <div class="d-inline-flex align-items-center border rounded px-3 py-2 mb-2 genealogy-node">
                ...
                <div class="aps-cp-card-body p-0">
                    ...
                    <?php else: ?>
                        ...
                        <div class="d-flex align-items-center border-bottom px-3 py-2 genealogy-member-item">
                            ...
                            <div class="text-end">
                                <div class="small"><?= htmlspecialchars(ucfirst($level ?? '')) ?></div>
                                <div class="text-muted">&#8377;<?= number_format((float)$m['total_commission'] ?? 0) ?></div>
                            </div>
                        </div>
                        <?php endforeach; ?>
                    <?php endif; ?>
                ...
                <div class="aps-cp-card-body p-0">
                    ...
                    <div class="d-flex align-items-center justify-content-between border-bottom px-3 py-2">
                        <div class="d-flex align-items-center">
                            <span class="badge me-2"><i class="fas <?= $rankIcons[strtolower($rk)] ?? 'fa-user' ?>"></i></span>
