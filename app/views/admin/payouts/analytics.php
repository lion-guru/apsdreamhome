ï»¿<?php $pageTitle = 'Payout Analytics'; ?>
<div class="container-fluid">
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-md-3"><div class="card bg-success text-white border-0 shadow-sm"><div class="card-body aps-cp-card-body"><h6>Total Amount</h6><h3 class="mb-0">â‚¹<?= number_format($totalAmount ?? 0, 2) ?></h3></div></div></div>
        <div class="col-md-3"><div class="card bg-warning text-white border-0 shadow-sm"><div class="card-body aps-cp-card-body"><h6>Pending</h6><h3 class="mb-0">â‚¹<?= number_format($pendingAmount ?? 0, 2) ?></h3></div></div></div>
        <div class="col-md-3"><div class="card bg-info text-white border-0 shadow-sm"><div class="card-body aps-cp-card-body"><h6>Avg. Payout</h6><h3 class="mb-0">â‚¹<?= number_format($avgPayout ?? 0, 2) ?></h3></div></div></div>
    </div>
    <div class="row">
