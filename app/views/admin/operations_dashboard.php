...
if (!isAuthenticated() || !in_array(getAuthSubRole(), ['operations', 'super_admin', 'superadmin'])) {
    header('Location: login.php');
    exit();
}

$employee = getAuthFullName() ?: getAuthUsername() ?: 'Operations';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="dashboard-container">
    <div class="dashboard-header">
        <h2><i class="fa fa-cogs"></i> Welcome, <?php echo h($employee); ?>!</h2>
