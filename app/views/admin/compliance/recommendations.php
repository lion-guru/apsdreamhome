...
<div class="recs-header">
    <div class="container-fluid px-4">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
            <div>
                <a href="<?= $base ?>/admin/compliance-scorecard" class="text-white-50 text-decoration-none"><i class="fas fa-arrow-left me-1"></i>Back to Scorecard</a>
                <h2 class="mb-1 fw-bold mt-1"><i class="fas fa-list-check me-2"></i>All Recommendations</h2>
                <p class="mb-0 opacity-75">Sorted by impact — highest impact first</p>
            </div>
            <div class="d-flex gap-2 flex-wrap">
                ...
                ?>
                <span class="stat-pill"><i class="fas fa-circle"></i> <?= $critCount ?> Critical</span>
                <span class="stat-pill"><i class="fas fa-circle"></i> <?= $highCount ?> High</span>
                <span class="stat-pill"><i class="fas fa-circle"></i> <?= $medCount ?> Medium</span>
            </div>
        </div>
    </div>
</div>
...
<div class="container-fluid px-4">
    <div class="row g-4">
                ...
                <?php foreach ($grouped as $areaKey => $recs): ?>
                    ...
                    <div class="group-section">
                        <div class="group-title">
                            ...
                            <span class="badge bg-secondary"><?= count($recs) ?> items</span>
                        </div>
                            ...
                            <div class="rec-card">
                                ...
                                <div class="rec-body">
                                    ...
                                    <div class="rec-meta">
                                        ...
                                        <span class="badge <?= recBadgeClass($rec['priority']) ?>"><?= strtoupper($rec['priority']) ?></span>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; ?>
        ...
        <div class="col-lg-3">
            <div class="p-4 mb-3">
                <h6 class="fw-bold mb-3"><i class="fas fa-chart-pie me-2 text-muted"></i>Summary</h6>
                ...
                <div class="text-center">
                    <a href="<?= $base ?>/admin/compliance-scorecard" class="btn btn-sm btn-primary"><i class="fas fa-shield-alt me-1"></i>Re-check Now</a>
                </div>
            </div>

            <div class="p-4">
                <h6 class="fw-bold mb-3"><i class="fas fa-sort-amount-down me-2 text-muted"></i>By Area</h6>
                <?php foreach ($grouped as $areaKey => $recs): ?>
