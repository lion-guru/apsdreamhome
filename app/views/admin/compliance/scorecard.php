    ...
    <div class="container-fluid px-4">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
            <div>
                ...
                <p class="mb-0 opacity-75">Data security, KYC, payment compliance, and regulatory status</p>
            </div>
...
<div class="container-fluid px-4">
    ...
    <div class="row g-4 mb-4">
        <div class="col-md-4">
            <div class="text-center p-4">
                ...
                <div class="mt-3">
                    <span class="badge <?= complianceBadgeClass($areas[array_key_first($areas)]['status'] ?? '') ?>">
        ...
        <div class="col-md-8">
            <div class="p-4">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h6 class="fw-bold mb-0"><i class="fas fa-clock me-2 text-muted"></i>Last Checked</h6>
                    <span class="text-muted"><?= $last_checked ? date('d M Y, h:i A', strtotime($last_checked)) : 'Never' ?></span>
                </div>
                <div class="row g-2">
        ...
        <?php foreach ($areas as $key => $area): ?>
            ...
            <div class="col-md-4 col-lg-2">
                <a href="<?= $base ?>/admin/compliance-scorecard/area/<?= $key ?>" class="area-card">
                    ...
                    <div class="mt-2">
                        <span class="badge <?= complianceBadgeClass($area['status']) ?>"><?= complianceLabel($area['status']) ?></span>
                    </div>
                </a>
            </div>
        <?php endforeach; ?>
    ...
    <div class="row g-4">
        <div class="col-lg-8">
            <div class="p-4">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h6 class="fw-bold mb-0"><i class="fas fa-lightbulb me-2 text-warning"></i>Top Recommendations</h6>
                    <a href="<?= $base ?>/admin/compliance-scorecard/recommendations" >View All â†’</a>
                </div>
        ...
        <div class="col-lg-4">
            <div class="p-4">
                <h6 class="fw-bold mb-3"><i class="fas fa-chart-line me-2 text-info"></i>Compliance Trend</h6>
                <?php if (empty($trend)): ?>
                    <div class="text-center text-muted py-3">
                        <i class="fas fa-chart-area fa-2x mb-2"></i>
                        <p class="mb-0">Run compliance checks to see trend data</p>
                    </div>
                <?php else: ?>
            ...
            <div class="p-3 mt-3">
                <h6 class="fw-bold mb-2"><i class="fas fa-info-circle me-1 text-muted"></i>Scoring Weights</h6>
