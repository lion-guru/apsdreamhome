...
<div class="container-fluid">
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body p-4">
            <form method="POST" action="/admin/jobs/manage/<?= $job['id'] ?? 0 ?>/update">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12"><button type="submit" class="btn btn-primary"><i class="fas fa-save me-1"></i>Update Job</button> <a href="/admin/jobs" class="btn btn-secondary">Cancel</a></div>
                </div>
            </form>
        </div>
    </div>
