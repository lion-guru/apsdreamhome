ï»¿<?php $pageTitle = 'Application Details'; ?>
        ...
        <div class="row align-items-center">
            <div class="col">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?= BASE_URL ?>/admin/jobs/applications">Applications</a></li>
                    <li class="breadcrumb-item active">#<?= $application['id'] ?? 0 ?></li>
                </ul>
            </div>
            <div class="col-auto">
                <a href="<?= BASE_URL ?>/admin/jobs/applications" class="btn btn-secondary btn-sm"><i class="fas fa-arrow-left me-1"></i>Back</a>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-4">
            <div class="card shadow-sm border-0 text-center">
                <div class="card-body py-4">
                    <div class="avatar-lg mx-auto mb-3 bg-primary text-white rounded-circle d-flex align-items-center justify-content-center"><?= strtoupper(substr($application['name'], 0, 1)) ?></div>
