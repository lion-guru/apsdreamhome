        ...
        <div class="col-lg-6">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body aps-cp-card-body">
                    ...
                    <?php endif; ?>
                    <pre class="bg-light p-3 rounded mb-0"><?= htmlspecialchars($campaign['content'] ?? '') ?></pre>
                </div>
            </div>
        </div>
        <div class="col-lg-6">
                    ...
                    <?php else: ?>
                        <?php foreach ($status_breakdown as $s => $count): ?>
                            ...
                            <div class="progress mb-3">
                                <div class="progress-bar bg-<?= ['delivered' => 'success', 'sent' => 'info', 'opened' => 'info', 'clicked' => 'warning', 'failed' => 'danger', 'bounced' => 'danger', 'unsubscribed' => 'secondary'][$s] ?? 'secondary' ?>"></div>
                            </div>
                        <?php endforeach; ?>
                    <?php endif; ?>
                </div>
