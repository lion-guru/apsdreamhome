...
<div class="container-fluid">
    <div class="page-header mb-4">
        <div class="row align-items-center">
            ...
            <div class="col-auto">
                <a href="/admin/workflows/create" class="btn btn-primary btn-sm"><i class="fas fa-plus me-1"></i>New Workflow</a>
                <a href="/admin/workflows/pending" class="btn btn-warning btn-sm"><i class="fas fa-clock me-1"></i>Pending</a>
            </div>
        </div>
    </div>
