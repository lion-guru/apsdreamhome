...
<div class="container-fluid">
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body p-4">
            <form method="POST" action="<?= BASE_URL ?>/admin/sales/bookings/store">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12"><button type="submit" class="btn btn-primary"><i class="fas fa-save me-1"></i>Create Sale</button> <a href="<?= BASE_URL ?>/admin/sales" class="btn btn-secondary">Cancel</a></div>
                </div>
            </form>
        </div>
    </div>
