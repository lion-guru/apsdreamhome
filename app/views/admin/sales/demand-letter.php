...
<div class="aps-cp-card">
    <div class="aps-cp-card-header d-flex justify-content-between align-items-center">
        <h5 class="m-0"><i class="fas fa-envelope-open-text me-2"></i>Demand Letter</h5>
    ...
    <div class="aps-cp-card-body">
        ...
        <?php if ($letter): ?>
            <div class="aps-cp-card border">
                <div class="aps-cp-card-header">
                    <h6 class="m-0">Letter #<?= htmlspecialchars((string)($letter['letter_number'] ?? '')) ?> (<?= htmlspecialchars((string)($letter['letter_type'] ?? '')) ?>)</h6>
                </div>
                <div class="aps-cp-card-body">
        ...
        <?php else: ?>
            <div class="text-center text-muted py-3">
                <i class="fas fa-info-circle"></i> No demand letter on file for this installment.
            </div>
        <?php endif; ?>
    </div>
</div>
