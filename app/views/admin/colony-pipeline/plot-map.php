...
<div class="container-fluid py-3">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <div>
            <h4 class="mb-1"><i class="fas fa-map-marked-alt" style="color:#0d9488"></i> Plot Map &mdash; <?= htmlspecialchars($colony['name'] ?? '') ?></h4>
    ...
    <div class="map-filter-bar mb-3">
        ...
        <button class="btn btn-sm btn-light border btn-map-filter" data-filter="available" style="color:#16a34a">Available</button>
        <button class="btn btn-sm btn-light border btn-map-filter" data-filter="booked" style="color:#ca8a04">Booked</button>
        <button class="btn btn-sm btn-light border btn-map-filter" data-filter="sold" style="color:#dc2626">Sold</button>
        <button class="btn btn-sm btn-light border btn-map-filter" data-filter="hold" style="color:#4b5563">Hold</button>
    </div>
    <div id="plotMap"></div>
</div>
...
(function() {
    ...
    legend.onAdd = function() {
        ...
        div.innerHTML = '<div style="background:white;padding:8px 12px;border-radius:8px;box-shadow:0 2px 8px rgba(0,0,0,0.1);font-size:12px;line-height:2">' +
            '<div><span style="display:inline-block;width:12px;height:12px;border-radius:2px;background:#22c55e;margin-right:5px"></span>Available</div>' +
            '<div><span style="display:inline-block;width:12px;height:12px;border-radius:2px;background:#eab308;margin-right:5px"></span>Booked</div>' +
            '<div><span style="display:inline-block;width:12px;height:12px;border-radius:2px;background:#ef4444;margin-right:5px"></span>Sold</div>' +
            '<div><span style="display:inline-block;width:12px;height:12px;border-radius:2px;background:#6b7280;margin-right:5px"></span>Hold</div></div>';
        return div;
    };
    legend.addTo(map);
