<?php @@session_start(); if (!isset($_SESSION['admin_id']) && (!isset($_SESSION['role']) || $_SESSION['role'] !== 'admin')) { header("Location: " . BASE_URL . "/admin/login"); exit(); } $page_title = 'Ratings & Reviews'; ?>
