            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body text-center">
                    ...
                    <div class="position-relative d-inline-block">
                        ...
                        <div class="mt-3">
                            <div class="progress">
                                <div class="progress-bar bg-<?= $pct > 90 ? 'danger' : ($pct > 70 ? 'warning' : 'success') ?>" role="progressbar" aria-valuenow="<?= $pct ?>" aria-valuemin="0" aria-valuemax="100"><?= number_format($pct, 1) ?>%</div>
                            </div>
