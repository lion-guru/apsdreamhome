...
<div class="container-fluid">
        ...
        <div class="row align-items-center">
            <div class="col">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="/admin/careers/show/<?= $job['id'] ?? 0 ?>"><?= $job['title'] ?? 'Job' ?></a></li>
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body p-4">
            <form method="POST" action="/admin/careers/update/<?= $job['id'] ?? 0 ?>">
                <div class="row g-3">
                    ...
                    <div class="col-12"><button type="submit" class="btn btn-primary"><i class="fas fa-save me-1"></i>Update Job</button> <a href="/admin/careers" class="btn btn-secondary">Cancel</a></div>
                </div>
            </form>
        </div>
    </div>
