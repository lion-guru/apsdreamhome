...
$associate_id = $_GET['associate_id'] ?? $admin_id;
$associate_name = $_SESSION['auser'] ?? 'Admin';
$associate_level = $_SESSION['alevel'] ?? 1;
...
$pending_result = $db->fetch($pending_query, [$associate_id]);
...
$total_earned_result = $db->fetch($total_earned_query, [$associate_id]);
...
$recent_payouts = $db->fetchAll($recent_payouts_query, [$associate_id]);
...
$active_targets = $db->fetchAll($targets_query, [$associate_id]);
