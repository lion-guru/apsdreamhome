<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            ...
            <a href="<?= !empty($document['file_path']) ? BASE_URL . '/admin/documents/download/' . ($document['id'] ?? 0) : '#' ?>" class="btn btn-success <?= empty($document['file_path']) ? 'disabled' : '' ?>"><i class="fas fa-download me-1"></i>Download</a>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <table class="table table-bordered mt-3">
                            <tr><th style="width:200px;">Document Type</th><td><?= htmlspecialchars(ucfirst($document['type'] ?? 'N/A')) ?></td></tr>
