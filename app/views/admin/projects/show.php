    ...
    <div class="row g-4">
        ...
        <div class="col-md-4">
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body aps-cp-card-body">
                    <div class="mb-3"><small class="text-muted d-block">Sales Progress</small><div class="progress"><div class="progress-bar bg-success"></div></div><small class="text-muted"><?= ($project['total_units'] ?? 0) > 0 ? round((($project['total_units'] ?? 0) - ($project['available_units'] ?? 0)) / $project['total_units'] * 100) : 0 ?>% sold</small></div>
            ...
            <div class="card shadow-sm border-0">
                <div class="card-body p-0"><img src="<?= BASE_URL ?>/assets/images/placeholder/property.svg" class="img-fluid rounded" alt="<?= $project['name'] ?>" ></div>
            </div>
            <?php endif; ?>
        </div>
    </div>
