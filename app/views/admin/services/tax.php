<?php $page_title = 'Property Tax Services'; ?>
<div class="container-fluid py-4">
    <h2 class="mb-4"><i class="fas fa-file-invoice-dollar me-2"></i>Property Tax Services</h2>
    <div class="row mb-4">
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-white"><h6 class="mb-0"><i class="fas fa-list me-2"></i>Property Tax Inquiries</h6></div>
        <div class="card-body p-0">
            <?php if (empty($services)): ?>
                <p class="text-muted text-center py-4">No property tax inquiries yet</p>
            <?php else: ?>
