<?php $page_title = 'Legal Services'; ?>
<div class="container-fluid py-4">
    <h2 class="mb-4"><i class="fas fa-gavel me-2"></i>Legal Services</h2>
    <div class="row mb-4">
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-white"><h6 class="mb-0"><i class="fas fa-list me-2"></i>Legal Service Inquiries</h6></div>
        <div class="card-body p-0">
            <?php if (empty($services)): ?>
                <p class="text-muted text-center py-4">No legal service inquiries yet</p>
            <?php else: ?>
                <div class="table-responsive">
                    <table class="table table-hover mb-0">
                        <thead><tr><th>#</th><th>Customer</th><th>Phone</th><th>Type</th><th>Status</th><th>Notes</th><th>Date</th></tr></thead>
                        <tbody>
                        <?php foreach ($services as $s): ?>
                            <tr>
                                ...
                                <td><span class="badge bg-light text-dark"><?= ucfirst(str_replace('_',' ',$s['service_type'] ?? '')) ?></span></td>
