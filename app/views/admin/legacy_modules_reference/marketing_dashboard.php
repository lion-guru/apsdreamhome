...
if (!isAuthenticated() || !in_array(getAuthSubRole(), ['marketing', 'super_admin', 'superadmin'])) {
    header('Location: login.php');
    exit();
}

$employee = getAuthFullName() ?: getAuthUsername() ?: 'Marketing';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="dashboard-container">
    <div class="dashboard-header">
        <h2><i class="fa fa-bullhorn"></i> Welcome, <?php echo h($employee); ?>!</h2>
