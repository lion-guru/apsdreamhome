...
// Ensure only sales or admins can access this page
$userRole = getAuthRole();
$userSubRole = getAuthSubRole();

$allowedRoles = ['sales', 'admin', 'superadmin', 'super_admin'];
...
$employee = getAuthFullName() ?: getAuthUsername() ?: 'Sales';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Sales Dashboard | APS Dream Home</title>
...
<div class="dashboard-container">
    <div class="dashboard-header">
        <h2><i class="fa fa-briefcase"></i> Welcome, <?php echo h($employee); ?>!</h2>
        <span class="user-badge">Sales</span>
    </div>
    <div class="quick-links">
        <a href="leads.php" class="quick-link"><i class="fa fa-users"></i><span>Leads</span></a>
        <a href="bookings.php" class="quick-link"><i class="fa fa-calendar-check"></i><span>Bookings</span></a>
        <a href="analytics_dashboard.php" class="quick-link"><i class="fa fa-chart-line"></i><span>Sales Analytics</span></a>
        <a href="documents_dashboard.php" class="quick-link"><i class="fa fa-folder-open"></i><span>Documents</span></a>
    </div>
    <div class="dashboard-section">
        <h4>Today's Sales Tasks</h4>
        <ul class="task-list">
            <li>Follow up with new leads</li>
    ...
    <div class="dashboard-section">
        ...
        <button class="btn btn-success">Log Sale</button>
    </div>
</div>
</body>
</html>
