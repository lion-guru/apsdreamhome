...
if (!isAuthenticated() || !in_array(getAuthSubRole(), ['office_admin', 'super_admin', 'superadmin'])) {
    header('Location: login.php');
    exit();
}

$employee = getAuthUsername() ?? 'Office Admin';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="dashboard-container">
    <div class="dashboard-header">
        <h2><i class="fa fa-building"></i> Welcome, <?php echo h($employee); ?>!</h2>
