    ...
    if (isset($_POST['action'])) {
        switch ($_POST['action']) {
            case 'update_menu':
                ...
                $db->execute("UPDATE site_settings SET value = :value WHERE setting_name = 'header_menu_items'", [
                    'value' => $json_menu
                ]);
                ...
                if (isset($_FILES['logo']) && $_FILES['logo']['error'] === 0) {
                    ...
                    if (in_array($ext, $allowed)) {
                        ...
                        if (move_uploaded_file($_FILES['logo']['tmp_name'], $target_path)) {
                            ...
                            $db->execute("UPDATE site_settings SET value = :value WHERE setting_name = 'site_logo'", [
                                'value' => $logo_path
                            ]);
            ...
            case 'update_styles':
                ...
                $db->execute("UPDATE site_settings SET value = :value WHERE setting_name = 'header_styles'", [
                    'value' => $json_styles
                ]);
...
$results = $db->fetchAll("SELECT * FROM site_settings WHERE setting_name IN ('header_menu_items', 'site_logo', 'header_styles')");
$settings = [];
                ...
                <div class="card-body">
                    <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <img src="../<?php echo isset($settings['site_logo']) && $settings['site_logo'] ? h($settings['site_logo']) : h(get_asset_url('logo.png', 'images')); ?>"
