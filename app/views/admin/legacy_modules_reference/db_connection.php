...
// Include the unified initialization
require_once __DIR__ . '/core/init.php';

// For backward compatibility, make sure $con is available via ORM
try {
    ...
    error_log('Admin panel database connection established successfully via ORM');
} catch (Exception $e) {
