...
if (!isAuthenticated() || !in_array(getAuthSubRole(), ['it_head', 'super_admin', 'superadmin'])) {
    header('Location: login.php?error=unauthorized');
    exit();
}

$it_head = getAuthUsername() ?? 'IT Head';
?><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="container py-5">
        ...
        <h1 class="mb-4 text-center text-info">Welcome, <?php echo h($it_head); ?>!</h1>
