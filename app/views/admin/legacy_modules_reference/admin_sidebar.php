    ...
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li class="submenu">
                    <a href="#"><i class="fe fe-dollar-sign"></i> <span> Accounting</span> <span class="menu-arrow"></span></a>
                    <ul style="display: none;">
                        <li><a class="<?php echo (strpos($_SERVER['REQUEST_URI'], '/admin/accounting') !== false) ? 'active' : ''; ?>" href="<?php echo BASE_URL; ?>/admin/accounting">Dashboard</a></li>
                    </ul>
                </li>
