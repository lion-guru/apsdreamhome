...
require_once ABSPATH . '/app/views/admin/legacy_modules_reference/admin_header.php';
?>
...
<?php require_once ABSPATH . '/app/views/admin/advanced_modules/admin_footer.php'; ?>
