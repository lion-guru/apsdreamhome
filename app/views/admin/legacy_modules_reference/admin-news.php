...
<head>
    ...
    <?php if ($additional_css !== ''): ?>
        <link rel="stylesheet" href="<?php echo h($additional_css); ?>">
    <?php endif; ?>
</head>
<body>
...
<section class="admin-news-section py-5 bg-light position-relative">
    <div class="container position-relative" style="z-index:3;">
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <form method="get" action="" class="d-flex align-items-center">
                    <input type="text" name="q" class="form-control me-2" placeholder="Search news..." value="<?php echo isset($_GET['q']) ? h($_GET['q']) : ''; ?>">
        ...
        $total_news = 0;
        try {
            $count_sql = "SELECT COUNT(*) AS cnt FROM news $where";
        ...
        try {
            ...
            $results = $db->fetchAll($sql, $fetch_params);
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <?php foreach ($news_items as $news): ?>
                            <tr>
                                ...
                                <td><?php echo h($news['date']); ?></td>
                                <td><?php echo h($news['summary']); ?></td>
                                <td>
                                    <a href="<?php echo h($news['url']); ?>" class="btn btn-sm btn-secondary">Edit</a>
                        ...
                        <ul class="pagination justify-content-center mt-4">
                            <?php for ($p = 1; $p <= $total_pages; $p++): ?>
                                <li class="page-item<?php if ($p == $page) echo ' active'; ?>">
                                    <a class="page-link" href="?page=<?php echo h($p); ?><?php if (isset($_GET['q'])) echo '&q=' . h($_GET['q']); ?>"><?php echo h($p); ?></a>
                                </li>
                            <?php endfor; ?>
                        </ul>
                    </nav>
