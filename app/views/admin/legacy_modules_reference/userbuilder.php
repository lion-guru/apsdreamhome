                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="datatable table table-stripped">
                                ...
                                <tbody>
                                    <?php
                                    $builders = $db->fetchAll("SELECT * FROM user WHERE utype='builder' ORDER BY uid DESC");
                                    $cnt = 1;
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form method="post" action="delete.php" style="display:inline;" onsubmit="return confirm('Are you sure you want to delete this builder?');">
                                                <?php echo getCsrfField(); ?>
                                                <input type="hidden" name="type" value="userbuilder">
