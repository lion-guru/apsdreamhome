...
if (!isAuthenticated() || !in_array(getAuthSubRole(), ['official_employee', 'super_admin', 'superadmin'])) {
    header('Location: login.php');
    exit();
}

$employee = getAuthUsername() ?? 'Employee';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="dashboard-container">
    <div class="dashboard-header">
        <h2><i class="fa fa-gauge"></i> Welcome, <?php echo h($employee); ?>!</h2>
