...
<?php
$alerts = [];
if (($s['money_bounced_cheques'] ?? 0) > 0) $alerts[] = ['warning', '<strong>Bounced Cheques:</strong> ' . (int)$s['money_bounced_cheques'] . ' require attention.', BASE_URL . '/admin/finance/cheques'];
