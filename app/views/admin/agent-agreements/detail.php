...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 ><i class="fas fa-file-signature me-2"></i><?= htmlspecialchars($agreement['title'] ?? 'Agreement') ?></h4>
            <span class="aag-badge <?= $statusBadgeClass[$agreement['status']] ?? '' ?>">
    ...
    <div class="aag-info mb-4">
        <div class="aag-info-item">
            ...
            <div ><?= htmlspecialchars($agreement['agent_email'] ?? '') ?></div>
        </div>
        <div class="aag-info-item">
            <div class="label">Property</div>
            <div class="value"><?= htmlspecialchars($agreement['property_name'] ?? 'General') ?></div>
            <div ><?= htmlspecialchars($agreement['property_location'] ?? '') ?></div>
        </div>
        <div class="aag-info-item">
            <div class="label">Commission</div>
            <div class="value"><?= (float)$agreement['commission_pct'] ?>%</div>
        </div>
        <div class="aag-info-item">
        ...
        <div class="aag-info-item">
            ...
            <div class="value"><?= date('d M Y, h:i A', strtotime($agreement['created_at'])) ?></div>
        </div>
    </div>

    <!-- Agreement Content -->
    <div class="aag-card">
        <h5><i class="fas fa-file-alt me-2"></i>Agreement Content</h5>
    ...
    <div class="aag-card">
        <h5><i class="fas fa-check-circle me-2"></i>Signature Details</h5>
        <div class="aag-info">
            <div class="aag-info-item">
                <div class="label">Signed At</div>
                <div class="value"><?= date('d M Y, h:i A', strtotime($agreement['signed_at'])) ?></div>
            </div>
            <div class="aag-info-item">
                <div class="label">Signed By</div>
                <div class="value"><?= htmlspecialchars($agreement['signed_by_name'] ?? 'N/A') ?></div>
            </div>
            <div class="aag-info-item">
                <div class="label">IP Address</div>
                <div class="value"><?= htmlspecialchars($agreement['signed_ip'] ?? 'N/A') ?></div>
            </div>
        </div>
    </div>
    <?php endif; ?>
