        ...
        <div class="col-md-3 col-6">
            <div class="card border-0 shadow-sm">
                <div class="card-body py-3"><div class="d-flex align-items-center">
                    ...
                    <div><div ><?= number_format($totalCalls) ?></div><div class="small text-muted text-uppercase">Total Calls</div></div>
                </div></div>
            </div>
        </div>
        <div class="col-md-3 col-6">
            <div class="card border-0 shadow-sm">
                <div class="card-body py-3"><div class="d-flex align-items-center">
                    ...
                    <div><div class=" text-success"><?= number_format($completedCalls) ?></div><div class="small text-muted text-uppercase">Completed</div><div class="small text-muted"><?= $totalCalls > 0 ? round($completedCalls/$totalCalls*100) : 0 ?>% rate</div></div>
                </div></div>
            </div>
        </div>
        <div class="col-md-3 col-6">
            <div class="card border-0 shadow-sm">
                <div class="card-body py-3"><div class="d-flex align-items-center">
                    ...
                    <div><div class=" text-danger"><?= number_format($failedCalls) ?></div><div class="small text-muted text-uppercase">Failed</div></div>
                </div></div>
            </div>
        </div>
        <div class="col-md-3 col-6">
            <div class="card border-0 shadow-sm">
                <div class="card-body py-3"><div class="d-flex align-items-center">
                    ...
                    <div><div class=" text-warning"><?= number_format($interestedCount) ?></div><div class="small text-muted text-uppercase">Interested</div></div>
                </div></div>
            </div>
        </div>
    </div>
...
async function viewCallDetail(id) {
    ...
    try {
        ...
        if (c.call_transcript) { html += '<hr><h6>Transcript</h6><div >' + c.call_transcript + '</div>'; }
