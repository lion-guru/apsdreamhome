...
<div class="container-fluid">
    ...
    <div id="notificationPanel" class="card shadow-lg d-none position-fixed">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane" id="dev-tools">
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-4"><a href="<?= BASE_URL ?>/admin/ai-system/health" class="btn btn-outline-primary w-100 py-3"><i class="fas fa-heartbeat mb-2 d-block"></i>System Health Check</a></div>
                        <div class="col-md-4"><a href="<?= BASE_URL ?>/admin/ai-calling/call-logs" class="btn btn-outline-success w-100 py-3"><i class="fas fa-list mb-2 d-block"></i>Call Logs</a></div>
                        <div class="col-md-4"><a href="<?= BASE_URL ?>/admin/ai-calling/call-analytics" class="btn btn-outline-info w-100 py-3"><i class="fas fa-chart-pie mb-2 d-block"></i>Call Analytics</a></div>
                        <div class="col-md-4"><a href="<?= BASE_URL ?>/admin/crm/dedup" class="btn btn-outline-warning w-100 py-3"><i class="fas fa-clone mb-2 d-block"></i>Lead Deduplication</a></div>
                        <div class="col-md-4"><a href="<?= BASE_URL ?>/admin/crm/role-dashboard" class="btn btn-outline-secondary w-100 py-3"><i class="fas fa-users-cog mb-2 d-block"></i>CRM Role Dashboard</a></div>
                        <div class="col-md-4"><a href="<?= BASE_URL ?>/admin/ai/market_report" class="btn btn-outline-danger w-100 py-3"><i class="fas fa-chart-area mb-2 d-block"></i>Market Report</a></div>
                    </div>
                </div>
            </div>
        </div>
