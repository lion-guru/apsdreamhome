        ...
        <div class="col-md-3 col-6">
            <div class="card border-0 shadow-sm">
                <div class="card-body py-3"><div class="d-flex align-items-center">
                    ...
                    <div><div ><?= $totalCampaigns ?></div><div class="small text-muted text-uppercase">Total Campaigns</div></div>
                </div></div>
            </div>
        </div>
        <div class="col-md-3 col-6">
            <div class="card border-0 shadow-sm">
                <div class="card-body py-3"><div class="d-flex align-items-center">
                    ...
                    <div><div class=" text-success"><?= $activeCampaigns ?></div><div class="small text-muted text-uppercase">Active</div></div>
                </div></div>
            </div>
        </div>
        <div class="col-md-3 col-6">
            <div class="card border-0 shadow-sm">
                <div class="card-body py-3"><div class="d-flex align-items-center">
                    ...
                    <div><div class=" text-info"><?= number_format($totalScheduled) ?></div><div class="small text-muted text-uppercase">Total Scheduled</div></div>
                </div></div>
            </div>
        </div>
        <div class="col-md-3 col-6">
            <div class="card border-0 shadow-sm">
                <div class="card-body py-3"><div class="d-flex align-items-center">
                    <div class="flex-shrink-0 me-3"><span class="badge bg-purple rounded-pill p-2"><i class="fas fa-check-double"></i></span></div>
                    <div><div ><?= number_format($totalCompleted) ?></div><div class="small text-muted text-uppercase">Completed</div></div>
                </div></div>
            </div>
        </div>
    </div>
