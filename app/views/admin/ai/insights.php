...
<div class="container-fluid py-4">
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-md-6">
            <div class="alert alert-<?= $ins['type'] ?> d-flex align-items-start gap-3 mb-0" style="border-radius:10px">
    ...
    <div class="row g-3 mb-4">
        <div class="col-md-3 col-6">
            <div class="card border-0 shadow-sm text-center py-3" style="border-radius:10px">
                <div style="font-size:1.4rem;font-weight:700;color:#3b82f6"><?= number_format($totalLeads) ?></div>
                <div class="small text-muted">Total Leads</div>
            </div>
        </div>
        <div class="col-md-3 col-6">
            <div class="card border-0 shadow-sm text-center py-3" style="border-radius:10px">
                <div style="font-size:1.4rem;font-weight:700;color:#16a34a"><?= number_format($hotLeads) ?></div>
                <div class="small text-muted">Hot Leads (Score ≥70)</div>
            </div>
        </div>
        <div class="col-md-3 col-6">
            <div class="card border-0 shadow-sm text-center py-3" style="border-radius:10px">
                <div style="font-size:1.4rem;font-weight:700;color:#dc2626"><?= number_format($coldLeads) ?></div>
                <div class="small text-muted">Cold Leads (Score &lt;30)</div>
            </div>
        </div>
        <div class="col-md-3 col-6">
            <div class="card border-0 shadow-sm text-center py-3" style="border-radius:10px">
                <div style="font-size:1.4rem;font-weight:700;color:#f59e0b"><?= number_format($unassignedLeads) ?></div>
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="progress" style="height:8px"><div class="progress-bar bg-success" style="width:<?= $hotPct ?>%"></div></div>
                    </div>
                    <div class="mb-3">
                        <div class="d-flex justify-content-between small"><span class="text-danger">Cold</span><span><?= $coldPct ?>%</span></div>
                        <div class="progress" style="height:8px"><div class="progress-bar bg-danger" style="width:<?= $coldPct ?>%"></div></div>
                    </div>
                    <div>
                        <div class="d-flex justify-content-between small"><span class="text-warning">Unassigned</span><span><?= $unassignedPct ?>%</span></div>
                        <div class="progress" style="height:8px"><div class="progress-bar bg-warning" style="width:<?= $unassignedPct ?>%"></div></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body text-center py-4">
                    <div style="font-size:2.5rem;font-weight:700;color:#3b82f6"><?= number_format($newLeadsWeek) ?></div>
    ...
    <div class="card border-0 shadow-sm">
        ...
        <div class="card-body">
            ...
            <div class="d-flex align-items-center mb-3">
                <div class="flex-shrink-0 me-3" style="width:120px"><span class="small fw-semibold"><?= htmlspecialchars($src['source']) ?></span></div>
                <div class="flex-grow-1">
                    <div class="progress" style="height:20px">
                        <div class="progress-bar bg-<?= $src['win_rate'] > 10 ? 'success' : ($src['win_rate'] > 5 ? 'warning' : 'secondary') ?>" style="width:<?= min(100, $src['win_rate'] * 3) ?>%">
                            <?= $src['win_rate'] ?>%
                        </div>
                    </div>
                </div>
                <div class="flex-shrink-0 ms-2" style="width:80px"><small class="text-muted"><?= $src['total'] ?> leads</small></div>
            </div>
            <?php endforeach; ?>
        </div>
    </div>
