        ...
        <div class="col-md-8 col-lg-6">
            <div class="card shadow-lg border-0 mt-4">
                ...
                <div class="card-body">
                    ...
                    <!-- Voice Visualizer -->
                    <div id="voice-visualizer" class="text-center mb-2">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function addMessage(type, text) {
        ...
        const avatar = type === 'bot' 
            ? '<div class="avatar bg-primary text-white rounded-circle me-2"><i class="fas fa-robot"></i></div>'
            : '<div class="avatar bg-success text-white rounded-circle me-2"><i class="fas fa-user"></i></div>';
        
        div.innerHTML = `<div class="d-flex align-items-start">${avatar}<div class="message-content bg-white p-2 rounded shadow-sm"><p class="mb-0">${text}</p></div></div>`;
    ...
    function addTypingIndicator() {
        ...
        div.innerHTML = '<div class="d-flex align-items-start"><div class="avatar bg-primary text-white rounded-circle me-2"><i class="fas fa-robot"></i></div><div class="message-content bg-white p-2 rounded shadow-sm"><p class="mb-0"><i>Typing...</i></p></div></div>';
        chatContainer.appendChild(div);
        chatContainer.scrollTop = chatContainer.scrollHeight;
        return id;
    }
