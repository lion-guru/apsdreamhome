...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
        ...
        <div class="d-flex gap-2">
            <select id="daysFilter" class="form-select form-select-sm" onchange="window.location='?days='+this.value">
    ...
    <div class="row g-3 mb-4">
        <div class="col-md-2 col-4">
            <div class="card border-0 shadow-sm text-center py-3">
                <div ><?= number_format($totals['total']) ?></div>
                <div class="small text-muted">Total Calls</div>
            </div>
        </div>
        <div class="col-md-2 col-4">
            <div class="card border-0 shadow-sm text-center py-3">
                <div ><?= number_format($totals['completed']) ?></div>
                <div class="small text-muted">Completed</div>
            </div>
        </div>
        <div class="col-md-2 col-4">
            <div class="card border-0 shadow-sm text-center py-3">
                <div ><?= number_format($totals['failed']) ?></div>
                <div class="small text-muted">Failed</div>
            </div>
        </div>
        <div class="col-md-2 col-4">
            <div class="card border-0 shadow-sm text-center py-3">
                <div ><?= number_format($totals['interested']) ?></div>
                <div class="small text-muted">Interested</div>
            </div>
        </div>
        <div class="col-md-2 col-4">
            <div class="card border-0 shadow-sm text-center py-3">
                <div ><?= number_format($totals['not_interested']) ?></div>
                <div class="small text-muted">Not Interested</div>
            </div>
        </div>
        <div class="col-md-2 col-4">
            <div class="card border-0 shadow-sm text-center py-3">
                <div ><?= round($totals['avg_duration']) ?>s</div>
