...
<div class="settings-header">
    <div class="container-fluid px-4">
        ...
        <p class="mb-0 opacity-75">Configure free AI engines. Cost: ₹0 — all free tier.</p>
    </div>
</div>
...
<div class="container-fluid px-4">
    ...
    <?php echo CSRFProtection::csrfField(); ?>
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        <div class="d-flex align-items-center gap-2 mb-2">
                            <span class="engine-status <?= !empty($engine_status['groq']['available']) ? 'active' : 'inactive' ?>"></span>
                        ...
                        <div class="api-hint">Free: 30 RPM. <a href="https://console.groq.com/keys" target="_blank" >Get key â†’</a> Fastest inference (~500 tok/s)</div>
                    </div>

                    <!-- OpenRouter -->
                    <div class="col-md-6">
                        <div class="d-flex align-items-center gap-2 mb-2">
                            <span class="engine-status <?= !empty($engine_status['openrouter']['available']) ? 'active' : 'inactive' ?>"></span>
                        ...
                        <div class="api-hint">Free models: Llama 3, Mistral, Gemma. <a href="https://openrouter.ai/keys" target="_blank" >Get key â†’</a></div>
                    </div>

                    <!-- Gemini -->
                    <div class="col-md-6">
                        <div class="d-flex align-items-center gap-2 mb-2">
                            <span class="engine-status <?= !empty($engine_status['gemini']['available']) ? 'active' : 'inactive' ?>"></span>
                        ...
                        <div class="api-hint">Free: 15 RPM, 1M tokens/day. <a href="https://aistudio.google.com/apikey" target="_blank" >Get key â†’</a></div>
                    </div>

                    <!-- Ollama -->
                    <div class="col-md-6">
                        <div class="d-flex align-items-center gap-2 mb-2">
                            <span class="engine-status <?= !empty($engine_status['ollama']['available']) ? 'active' : 'inactive' ?>"></span>
                        ...
                        <div class="api-hint">Unlimited, free, private. <a href="https://ollama.com" target="_blank" >Install â†’</a> Run: <code>ollama pull llama3.1:8b</code></div>
                ...
                <div class="mt-4 d-flex gap-3">
                    ...
                    <a href="<?= BASE_URL ?>/admin/ai-system" class="btn btn-outline-secondary">Cancel</a>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="card mt-4">
        <div class="card-body p-4">
            ...
            <div class="row mt-3">
                <div class="col-md-4">
                    <h6 >Smart Routing</h6>
                    <p >AI Gateway tries engines in order: Ollama â†’ Groq â†’ OpenRouter â†’ Gemini. First successful response wins.</p>
                </div>
                <div class="col-md-4">
                    <h6 >All Free Forever</h6>
                    <p >Ollama: unlimited. Groq: 30 RPM. OpenRouter: free models. Gemini: 15 RPM. Total cost: ₹0.</p>
                </div>
                <div class="col-md-4">
                    <h6 >Zero Config Works</h6>
                    <p >Without any API keys, the system uses rule engine + SelfLearningAI + IntentDetector (all local). API keys make it smarter.</p>
                </div>
            </div>
        </div>
    </div>
