...
if (!isAuthenticated() || !in_array(getAuthSubRole(), ['director', 'super_admin', 'superadmin'])) {
    header('Location: login.php');
    exit();
}

$employee = getAuthUsername() ?? 'Director';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="dashboard-container">
    <div class="dashboard-header">
        <h2><i class="fa fa-user-tie"></i> Welcome, <?php echo h($employee); ?>!</h2>
