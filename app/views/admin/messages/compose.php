                ...
                <div class="card-body">
                    <form method="POST" action="<?= BASE_URL ?>/admin/messages/send">
                        ...
                        <div class="mb-3">
                            ...
                            <div id="selectedUser" class="text-muted">
            ...
            .then(function(users) {
                ...
                users.forEach(function(u) {
                    ...
                    html += '<a href="#" class="list-group-item list-group-item-action user-item"'
                        ...
                        + ' onclick="selectUser(this)">'
                        + '<div class="d-flex align-items-center">'
                        + '<div class="flex-shrink-0 me-3"><div class="d-flex align-items-center justify-content-center text-white fw-bold">' + initial + '</div></div>'
