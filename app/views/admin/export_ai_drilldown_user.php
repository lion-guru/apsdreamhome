<?php
/**
 * Export drilldown results for a specific user as CSV - Secured version
 */
...
$user_id = isset($_GET['user_id']) ? SecurityUtility::sanitizeInput($_GET['user_id'], 'int') : null;
...
header('Content-Disposition: attachment; filename="ai_user_drilldown_export_' . date('Ymd_His') . '.csv"');
