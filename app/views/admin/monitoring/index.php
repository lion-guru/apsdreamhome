                        ...
                        <table class="table table-sm mb-0">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="text-truncate" title="<?= htmlspecialchars((string)($e['message'] ?? '')) ?>">
                                    ...
                                    <td class="small text-muted">
                                        ...
                                        <?php if (!empty($e['file'])): ?>
                                            <div class="text-truncate"><?= htmlspecialchars((string)$e['file']) ?>:<?= (int)($e['line'] ?? 0) ?></div>
                                        <?php endif; ?>
                                    </td>
                            ...
                            ?>
                                <tr>
                                    <td class="ps-4">
                                        ...
                                        <div class="small text-muted mt-1 text-truncate" title="<?= htmlspecialchars((string)($a['message'] ?? '')) ?>">
