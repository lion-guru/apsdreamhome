        ...
        <div class="container-fluid px-4">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                <div>
                    ...
                    <p class="mb-0">Manage field extraction templates for each document type</p>
                </div>
        ...
        <?php if (empty($templates)): ?>
            <div class="ocr-card">
                <div class="ocr-empty">
                    ...
                    <p >Templates define which fields to extract from each document type</p>
                ...
                ?>
                    <div class="ocr-template-item">
                        ...
                        <div class="ocr-template-actions">
                            <a href="<?= BASE_URL ?>/admin/ocr/templates/edit/<?= $t['id'] ?>" class="ocr-btn ocr-btn-outline"><i class="fas fa-edit me-1"></i>Edit</a>
                            <form method="POST" action="<?= BASE_URL ?>/admin/ocr/templates/delete/<?= $t['id'] ?>" data-aps-confirm="Delete this template?">
                                <input type="hidden" name="csrf_token" value="<?= $csrf_token ?? '' ?>">
                                <button type="submit" class="ocr-btn ocr-btn-danger"><i class="fas fa-trash me-1"></i>Delete</button>
                            </form>
                        </div>
                    </div>
                <?php endforeach; ?>
