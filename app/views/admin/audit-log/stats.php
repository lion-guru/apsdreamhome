                ...
                <tbody>
                  <?php foreach ($stats['by_role'] as $item): ?>
                    <tr>
                      ...
                      <td class="text-end">
                        <div class="progress">
                          <div class="progress-bar bg-<?= in_array($item['user_role'] ?? '', ['admin', 'super_admin']) ? 'danger' : 'secondary' ?>"></div>
                        </div>
                      </td>
                    </tr>
                  <?php endforeach; ?>
                ...
                <tbody>
                  <?php foreach ($stats['by_status'] as $s): ?>
                    <tr>
                      ...
                      <td class="text-end">
                        <div class="progress">
                          <div class="progress-bar bg-<?= $s['status'] === 'success' ? 'success' : ($s['status'] === 'failed' ? 'danger' : 'warning') ?>"></div>
                        </div>
                      </td>
                    </tr>
                  <?php endforeach; ?>
