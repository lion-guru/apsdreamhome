<?php $page_title = $page_title ?? 'TDS Certificates'; $page_heading = $page_heading ?? 'TDS Certificates Issued'; $fy = $fy ?? '2025-26'; ?>
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="mb-0"><i class="fas fa-certificate me-2 text-primary"></i>TDS Certificates</h2>
    </div>
    ...
    <div class="aps-cp-card">
        <div class="aps-cp-card-body p-0">
            <table class="table table-hover align-middle mb-0">
                <thead class="table-light"><tr><th>Certificate #</th><th>Deductee</th><th>PAN</th><th>FY</th><th>Quarter</th><th class="text-end">TDS Amt</th><th>Issued</th></tr></thead>
                <tbody>
                <?php if (empty($certificates)): ?>
                    <tr><td colspan="7" class="text-center text-muted py-4">No certificates issued for <?= htmlspecialchars($fy) ?></td></tr>
