...
// require_role('Admin'); // Ensure this is handled by core/init.php or similar

$devs = $db->fetchAll("SELECT * FROM api_developers ORDER BY created_at DESC LIMIT 20");
?><!DOCTYPE html>
<html lang='en'>
