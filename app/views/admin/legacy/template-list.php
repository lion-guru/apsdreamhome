                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge <?php echo $template['is_active'] ? 'bg-success' : 'bg-secondary'; ?>">
                                        <?php echo h($template['is_active'] ? 'Active' : 'Inactive'); ?>
                                    </span>
                                </td>
                                <td><?php echo h(date('Y-m-d', strtotime($template['created_at']))); ?></td>
                                <td>
                                    <div class="btn-group">
                                        <a href="template-builder.php?id=<?php echo h($template['id']); ?>"
                                           class="btn btn-sm btn-outline-primary">Edit</a>
                                        <button type="button" class="btn btn-sm btn-outline-secondary"
                                                onclick="previewTemplate(<?php echo h($template['id']); ?>)">Preview</button>
