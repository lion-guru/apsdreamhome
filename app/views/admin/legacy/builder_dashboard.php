...
// enforceRole is part of role_helper.php which should be in includes/functions
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover" id="projectsTable">
                ...
                <tbody>
                    ...
                    $projects = $db->fetchAll("SELECT * FROM projects WHERE builder_id = :builder_id", ['builder_id' => $builder_id]);
                    foreach ($projects as $row): ?>
                        <tr>
                            ...
                            <td><?php echo h($row['budget']); ?></td>
                            <td>
                                <a href="project_details.php?id=<?php echo h($row['id']); ?>" class="btn btn-sm btn-info"><i class="fa-solid fa-eye"></i></a>
                                <a href="edit_project.php?id=<?php echo h($row['id']); ?>" class="btn btn-sm btn-warning"><i class="fa-solid fa-edit"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
