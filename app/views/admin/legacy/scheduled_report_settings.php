...
<div class="container my-4">
  ...
  <form method="post" class="mb-4">
    <div class="mb-3">
      ...
      <input type="email" name="admin_email" class="form-control" value="<?php echo h($cfg['admin_email']); ?>" required>
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
      ...
      <input type="url" name="slack_webhook" class="form-control mt-2" placeholder="Slack Incoming Webhook URL" value="<?php echo h($cfg['slack_webhook'] ?? ''); ?>">
    ...
    <div class="mb-3">
      ...
      <input type="text" name="twilio_sid" class="form-control mt-2" placeholder="Twilio Account SID" value="<?php echo h($cfg['twilio_sid'] ?? ''); ?>">
      <input type="text" name="twilio_token" class="form-control mt-2" placeholder="Twilio Auth Token" value="<?php echo h($cfg['twilio_token'] ?? ''); ?>">
      <input type="text" name="twilio_from" class="form-control mt-2" placeholder="Twilio From Number (e.g. +1234567890)" value="<?php echo h($cfg['twilio_from'] ?? ''); ?>">
      <input type="text" name="twilio_to" class="form-control mt-2" placeholder="Recipient Mobile Number (e.g. +19876543210)" value="<?php echo h($cfg['twilio_to'] ?? ''); ?>">
