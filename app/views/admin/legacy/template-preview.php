...
<head>
    ...
    <title>Preview: <?php echo h($template['name']); ?></title>
...
<body>
    ...
    <div class="preview-container">
        <iframe id="preview-frame" class="preview-frame" srcdoc="<?php
            echo h('<!DOCTYPE html><html><head><meta name="viewport" content="width=device-width, initial-scale=1.0"><link href="css/bootstrap.min.css" rel="stylesheet"></head><body>' . $previewContent . '</body></html>');
        ?>"></iframe>
        <div class="editor-panel">
            <h4>Edit Preview Content</h4>
            <div class="mb-3">
                <label for="title">Page Title</label>
                <input type="text" id="title" class="form-control" value="<?php echo h($previewData['title']); ?>">
            </div>
            <div class="mb-3">
                <label for="content">Main Content</label>
                <textarea id="content" class="form-control"><?php echo h($previewData['content']); ?></textarea>
            </div>
            <div class="mb-3">
                <label for="sidebar">Sidebar Content</label>
                <textarea id="sidebar" class="form-control"><?php echo h($previewData['sidebar']); ?></textarea>
            </div>
            <div class="mb-3">
                <label for="header">Header Content</label>
                <textarea id="header" class="form-control"><?php echo h($previewData['header']); ?></textarea>
            </div>
            <div class="mb-3">
                <label for="footer">Footer Content</label>
                <textarea id="footer" class="form-control"><?php echo h($previewData['footer']); ?></textarea>
            </div>
            <div class="mb-3">
                <label for="navigation">Navigation Content</label>
                <textarea id="navigation" class="form-control"><?php echo h($previewData['navigation']); ?></textarea>
            </div>
        </div>
    </div>
