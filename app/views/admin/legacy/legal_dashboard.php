...
if (!isAuthenticated() || !in_array(getAuthSubRole(), ['legal', 'super_admin', 'superadmin'])) {
    header('Location: login.php');
    exit();
}

$employee = getAuthUsername() ?? 'Legal';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="dashboard-container">
    <div class="dashboard-header">
        <h2><i class="fa fa-gavel"></i> Welcome, <?php echo h($employee); ?>!</h2>
