...
if (!isAuthenticated() || !in_array(getAuthSubRole(), ['cfo', 'super_admin', 'superadmin'])) {
    header('Location: login.php?error=unauthorized');
    exit();
}
$cfo = getAuthUsername() ?? 'CFO';
?><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="container py-5">
        ...
        <h1 class="mb-4 text-center text-warning">Welcome, <?php echo h($cfo); ?>!</h1>
