...
require_once __DIR__ . '/../includes/hybrid_commission_system.php';

// Authentication and role check
if (!isAuthenticated() || (getAuthRole() !== 'associate' && getAuthRole() !== 'admin' && getAuthRole() !== 'superadmin')) {
...
$hybrid_system = new HybridRealEstateCommission($db->getConnection());
...
function getPendingCommissions($associate_id) {
    ...
    try {
        ...
        return $db->fetch($query, [$associate_id]) ?: ['total_pending' => 0, 'total_count' => 0, 'avg_commission' => 0];
    } catch (Exception $e) {
                        ...
                        <div class="row mb-4">
                            <div class="col-md-3">
                                <div class="summary-card">
                                    <h3>₹<?php echo h(number_format($commission_summary[0]['total_commission'] ?? 0)); ?></h3>
                                    <p>Total Commission Earned</p>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="summary-card">
                                    <h3>₹<?php echo h(number_format($pending_commissions['total_pending'] ?? 0)); ?></h3>
                                    <p>Pending Commission</p>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="summary-card">
                                    <h3><?php echo h($commission_summary[0]['total_sales'] ?? 0); ?></h3>
                                    <p>Total Sales</p>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="summary-card">
                                    <h3>₹<?php echo h(number_format($commission_summary[0]['avg_commission'] ?? 0)); ?></h3>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                <div class="stats-card company">
                                    ...
                                    <div class="row text-center">
                                        <div class="col-6">
                                            <h4 class="text-success"><?php echo h($property_stats[0]['sold'] ?? 0); ?></h4>
                                            <small>Sold</small>
                                        </div>
                                        <div class="col-6">
                                            <h4 class="text-warning"><?php echo h($property_stats[0]['available'] ?? 0); ?></h4>
                                            <small>Available</small>
                                        </div>
                                    </div>
                                    <div class="mt-2">
                                        <small class="text-muted">
                                            Avg Value: ₹<?php echo h(number_format($property_stats[0]['avg_value'] ?? 0)); ?>
                                        </small>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="stats-card resell">
                                    ...
                                    <div class="row text-center">
                                        <div class="col-6">
                                            <h4 class="text-success"><?php echo h($property_stats[1]['sold'] ?? 0); ?></h4>
                                            <small>Sold</small>
                                        </div>
                                        <div class="col-6">
                                            <h4 class="text-warning"><?php echo h($property_stats[1]['available'] ?? 0); ?></h4>
                                            <small>Available</small>
                                        </div>
                                    </div>
                                    <div class="mt-2">
                                        <small class="text-muted">
                                            Avg Value: ₹<?php echo h(number_format($property_stats[1]['avg_value'] ?? 0)); ?>
                                        </small>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div>
                                                            <strong><?php echo h($sale['property_name']); ?></strong>
                                                            <br>
                                                            <small class="text-muted"><?php echo h($sale['location']); ?></small>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <span class="badge <?php echo $sale['property_type'] === 'company' ? 'badge-company' : 'badge-resell'; ?>">
                                                            <?php echo h(ucfirst($sale['property_type'])); ?>
                                                        </span>
                                                    </td>
                                                    <td>₹<?php echo h(number_format($sale['commission_amount'])); ?></td>
                                                    <td>
                                                        <span class="badge <?php echo $sale['payout_status'] === 'paid' ? 'badge-paid' : 'badge-pending'; ?>">
                                                            <?php echo h(ucfirst($sale['payout_status'])); ?>
                                                        </span>
                                                    </td>
                                                </tr>
                                                <?php endforeach; ?>
                                ...
                                <div class="stats-card">
                                    ...
                                    <div class="row text-center">
                                        <div class="col-md-3">
                                            ...
                                            <h4 class="mt-2">₹<?php echo h(number_format($monthly_summary[0]['total_commission'] ?? 0)); ?></h4>
                                            <small>This Month</small>
                                        </div>
                                        <div class="col-md-3">
                                            <h4 class="text-info"><?php echo h($monthly_summary[0]['total_sales'] ?? 0); ?></h4>
                                            <small>Sales This Month</small>
                                        </div>
                                        <div class="col-md-3">
                                            <h4 class="text-success">₹<?php echo h(number_format($monthly_summary[0]['avg_commission'] ?? 0)); ?></h4>
                                            <small>Avg Commission</small>
                                        </div>
                                        <div class="col-md-3">
                                            <h4 class="text-warning">₹<?php echo h(number_format($pending_commissions['total_pending'] ?? 0)); ?></h4>
