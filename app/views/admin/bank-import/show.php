            ...
            <div class="aps-cp-card h-100">
                <div class="aps-cp-card-body">
                    ...
                    <div class="progress mt-1" style="height:6px">
                        <div class="progress-bar bg-success" style="width:<?= (float)($summary['match_rate'] ?? 0) ?>%"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="aps-cp-card h-100">
                <div class="aps-cp-card-body">
                    ...
                    <div class="progress mt-1" style="height:6px">
                        <div class="progress-bar bg-primary" style="width:<?= (float)($summary['match_rate'] ?? 0) ?>%"></div>
                    </div>
                </div>
            </div>
        </div>
