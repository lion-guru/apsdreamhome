            ...
            <div class="d-flex align-items-center gap-4 flex-wrap">
                <div>
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <span class="badge bg-<?= $statusColor ?> text-uppercase"><?= ucfirst(str_replace('_',' ',$lead['status'] ?? 'new')) ?></span>
                        <span class="badge bg-<?= $pBadge ?>"><?= ucfirst($lead['priority'] ?? 'Medium') ?></span>
                    </div>
                    <div class="lead-meta">
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-body py-3">
            <div class="d-flex justify-content-between align-items-center mb-2">
                <small class="text-muted fw-bold text-uppercase">Pipeline Progress</small>
            ...
            <div class="col-md-3 col-6">
                <div class="card border-0 shadow-sm">
                    <div class="card-body py-2 px-3 d-flex align-items-center gap-2">
                        ...
                        <div><small class="fw-bold text-warning">No Activity</small><br><small class="text-muted">Never contacted</small></div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3 col-6">
                <div class="card border-0 shadow-sm">
                    <div class="card-body py-2 px-3 d-flex align-items-center gap-2">
                        ...
                        <div><small class="fw-bold text-danger">Stale Lead</small><br><small class="text-muted">No activity for <?= $daysSinceActivity ?>d</small></div>
                    </div>
                </div>
            </div>
        <?php else: ?>
            <div class="col-md-3 col-6">
                <div class="card border-0 shadow-sm">
                    <div class="card-body py-2 px-3 d-flex align-items-center gap-2">
                        ...
                        <div><small class="fw-bold text-success">Active</small><br><small class="text-muted">Last: <?= $daysSinceActivity ?>d ago</small></div>
                    </div>
                </div>
            </div>
        <?php endif; ?>
        ...
        <div class="col-md-3 col-6">
            <div class="card border-0 shadow-sm">
                <div class="card-body py-2 px-3 d-flex align-items-center gap-2">
                    ...
                    <div><small class="fw-bold text-primary"><?= $interactionCount ?> Interactions</small><br><small class="text-muted"><?= $daysSinceCreated ?>d since creation</small></div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-3 col-6">
                <div class="card border-0 shadow-sm">
                    <div class="card-body py-2 px-3 d-flex align-items-center gap-2">
                        ...
                        <div><small class="fw-bold text-danger"><?= $overdueTasks ?> Overdue</small><br><small class="text-muted"><?= $pendingTasks ?> tasks pending</small></div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3 col-6">
                <div class="card border-0 shadow-sm">
                    <div class="card-body py-2 px-3 d-flex align-items-center gap-2">
                        ...
                        <div><small class="fw-bold text-warning"><?= $pendingTasks ?> Tasks Due</small><br><small class="text-muted">Pending follow-ups</small></div>
                    </div>
                </div>
            </div>
        <?php endif; ?>
            ...
            <div class="col-md-3 col-6">
                <div class="card border-0 shadow-sm">
                    <div class="card-body py-2 px-3 d-flex align-items-center gap-2">
                        ...
                        <div><small class="fw-bold text-success">Hot Lead</small><br><small class="text-muted">Score <?= $leadScore ?>/100</small></div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3 col-6">
                <div class="card border-0 shadow-sm">
                    <div class="card-body py-2 px-3 d-flex align-items-center gap-2">
                        ...
                        <div><small class="fw-bold text-info">Cold Lead</small><br><small class="text-muted">Consider nurture</small></div>
                    </div>
                </div>
            </div>
        <?php endif; ?>
                        ...
                        <div class="card-body">
                            <?php foreach ($assignments as $a): ?>
                                <div class="d-flex justify-content-between align-items-center py-1">
                                    <div>
                                        <span class="fw-semibold"><?= htmlspecialchars($a['assigned_to_name'] ?? 'Unknown') ?></span>
                                    ...
                                    <div class="timeline-item type-<?= $tType ?>">
                                        <div class="d-flex justify-content-between align-items-start">
                                            <div>
                                                ...
                                                <span class="ms-2 fw-semibold"><?= htmlspecialchars($t['subject'] ?? $t['title'] ?? $t['description'] ?? '') ?></span>
                                                <?php if (!empty($t['body']) && ($t['body'] ?? '') !== ($t['subject'] ?? '')): ?>
                                                    <p class="mb-0 mt-1 text-muted"><?= htmlspecialchars(mb_strimwidth($t['body'], 0, 120, '...')) ?></p>
                                                <?php endif; ?>
                                            </div>
                                ...
                                <div class="d-flex justify-content-between align-items-start">
                                    <div>
                                        <div class="d-flex align-items-center gap-2 mb-1">
                                            ...
                                            <strong ><?= htmlspecialchars($t['subject'] ?? $t['title'] ?? $t['description'] ?? '') ?></strong>
                                        </div>
                                        <?php if (!empty($t['body'])): ?>
                                            <p class="mb-1 text-muted"><?= nl2br(htmlspecialchars($t['body'] ?? '')) ?></p>
                                        <?php endif; ?>
                                ...
                                <tbody>
                                    <?php foreach ($interactions as $i => $int): ?>
                                        <tr>
                                            ...
                                            <td class="fw-semibold"><?= htmlspecialchars(mb_strimwidth($int['subject'] ?? '', 0, 50, '...')) ?></td>
                            ...
                            <div class="deal-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <?php if (!empty($deal['notes'])): ?>
                                        <p class="mt-2 mb-0 text-muted"><?= htmlspecialchars(mb_strimwidth($deal['notes'], 0, 100, '...')) ?></p>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="d-flex align-items-start gap-2">
                                        ...
                                        <div>
                                            ...
                                            <?php if (!empty($task['description'])): ?>
                                                <p class="mb-0 text-muted"><?= htmlspecialchars(mb_strimwidth($task['description'], 0, 80, '...')) ?></p>
                                            <?php endif; ?>
                            ...
                            <?php if (!empty($score_breakdown) && is_array($score_breakdown)): ?>
                                <?php foreach ($score_breakdown as $factor => $data): ?>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="score-bar">
                                            <div class="score-fill bg-<?= $barColor ?>"></div>
                                        </div>
                                    </div>
                                <?php endforeach; ?>
                            <?php else: ?>
                    ...
                    <div class="card border-0 shadow-sm">
                        ...
                        <div class="card-body">
                            <div class="mb-3 p-3 bg-light rounded">
                                ...
                                <p class="mb-0 text-muted">How recently was the lead contacted or active. Leads contacted in the last 7 days score highest.</p>
                            </div>
                            <div class="mb-3 p-3 bg-light rounded">
                                <h6 class="fw-bold text-success"><i class="fas fa-comments me-1"></i> Engagement</h6>
                                <p class="mb-0 text-muted">Number of interactions, emails opened, calls answered. More engagement = higher score.</p>
                            </div>
                            <div class="mb-3 p-3 bg-light rounded">
                                <h6 class="fw-bold text-warning"><i class="fas fa-rupee-sign me-1"></i> Budget Fit</h6>
                                <p class="mb-0 text-muted">How well the lead's budget matches available inventory. Higher match = higher conversion probability.</p>
                            </div>
                            <div class="p-3 bg-light rounded">
                                <h6 class="fw-bold text-info"><i class="fas fa-user-check me-1"></i> Lead Quality</h6>
                                <p class="mb-0 text-muted">Verified contact info, complete profile, and valid requirements improve the score.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="commission-card">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 text-center mt-3 p-3 bg-white rounded">
                                ...
                                <div >₹<?= number_format($commission['total']) ?></div>
                            </div>
                            <?php endif; ?>
                        </div>
                    </div>
        ...
        <div class="modal-content">
            ...
            <form method="POST" action="<?= BASE_URL ?>/admin/leads/<?= $lead['id'] ?>/note">
                ...
                <div class="modal-body">
                    <textarea class="form-control" name="note" rows="5" placeholder="Type your note here..." required ></textarea>
                </div>
...
<div id="quickLogBar" >
    <div class="d-flex align-items-center gap-2 flex-grow-1 flex-wrap">
        <span class="text-white fw-bold"><i class="fas fa-bolt me-1"></i>Quick Log:</span>
        ...
        <input type="text" id="quickSubject" class="form-control form-control-sm" placeholder="Quick subject..." >
        <input type="text" id="quickBody" class="form-control form-control-sm" placeholder="Details (optional)..." >
        <button type="button" class="btn btn-sm btn-primary" id="quickLogBtn" onclick="submitQuickLog()" >
            <i class="fas fa-paper-plane me-1"></i> Log
        </button>
        <button type="button" class="btn btn-sm btn-outline-light" onclick="toggleQuickLog()" title="Minimize" aria-label="Send"><i class="fas fa-chevron-down"></i></button>
    </div>
</div>
