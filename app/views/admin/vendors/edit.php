                    ...
                    <form method="POST" action="<?= BASE_URL ?>/admin/vendors/update/<?= $vendor['id'] ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="pan_number" name="pan_number" value="<?= htmlspecialchars($vendor['pan_number'] ?? '') ?>" maxlength="10" >
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="gstin" class="form-label fw-semibold">GSTIN</label>
                                <input type="text" class="form-control" id="gstin" name="gstin" value="<?= htmlspecialchars($vendor['gstin'] ?? $vendor['gst_number'] ?? '') ?>" maxlength="15" >
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control" id="tds_section_display" value="<?= htmlspecialchars($vendor['tds_section'] ?? '194C') ?>" readonly >
                            </div>
                            <div class="col-md-3 mb-3">
                                ...
                                ?>
                                <input type="text" class="form-control" id="tds_rate_display" value="<?= $tdsRate ?>" readonly >
                            </div>
                            <div class="col-md-3 mb-3">
