...
<div class="container-fluid">
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body p-4">
            <form method="POST" action="/admin/land/store">
                <div class="row g-3">
                    ...
                    <div class="col-12"><button type="submit" class="btn btn-primary"><i class="fas fa-save me-1"></i>Save Land Record</button> <a href="/admin/land" class="btn btn-secondary">Cancel</a></div>
                </div>
            </form>
        </div>
    </div>
