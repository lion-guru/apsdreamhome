<div class="container-fluid py-4">
    <div class="mb-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active style-27277"><?= $template ? 'Edit' : 'Create' ?></li>
            </ol>
        </nav>
        <h1 class="h3 mb-1 fw-bold"><?= $template ? 'Edit Template' : 'Create Template' ?></h1>
        <p class="mb-0 style-54585"><?= $template ? 'Update template content and variables' : 'Design a reusable notification template' ?></p>
    </div>
    ...
    <div class="row g-4">
            ...
            <form method="POST" action="<?= BASE_URL ?>/admin/push-notifications/templates/store">
                ...
                <div class="card border-0 shadow-sm style-52634">
                    <div class="card-body p-4">
                        <div class="mb-3">
                            <label class="form-label fw-semibold style-96443">Template Name <span class="style-62247">*</span></label>
                        ...
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col-md-6">
                                <label class="form-label fw-semibold style-96443">Subject (Email/SMS)</label>
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-semibold style-96443">Title</label>
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-semibold style-96443">Body <span class="style-62247">*</span></label>
                        ...
                        <div class="mb-4">
                            <label class="form-label fw-semibold style-96443">Variables (comma-separated)</label>
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm style-52634">
                <div class="card-body">
                    <h6 class="fw-bold mb-3 style-96443">
                        <i class="fas fa-info-circle me-1 style-75937"></i> Template Tips
                    </h6>
            ...
            <?php if ($template): ?>
                <div class="card border-0 shadow-sm mt-3 style-52634">
                    <div class="card-body">
                        <h6 class="fw-bold mb-2 style-96443">Preview</h6>
                        <div class="p-3 rounded style-1278">
                            <div class="fw-semibold mb-1 style-72530">
