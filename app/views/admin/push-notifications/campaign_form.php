    ...
    <div class="mb-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><?= $campaign ? 'Edit' : 'Create' ?></li>
            </ol>
        </nav>
        <h1 class="h3 mb-1 fw-bold"><?= $campaign ? 'Edit Campaign' : 'Create Campaign' ?></h1>
        <p class="mb-0">Set up targeting, schedule, and message content</p>
    </div>
            ...
            <div class="col-lg-8">
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-header">
                        <h6 class="mb-0 fw-bold">Campaign Details</h6>
                    </div>
                    <div class="card-body p-4">
                        <div class="mb-3">
                            <label class="form-label fw-semibold">Campaign Name <span >*</span></label>
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-semibold">Notification Title <span >*</span></label>
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-semibold">Notification Body <span >*</span></label>
                            <textarea name="body" class="form-control" rows="4" required maxlength="300"
                                      placeholder="Notification message body"
                                      ><?= htmlspecialchars($campaign['body'] ?? '') ?></textarea>
                            <small >Max 300 characters for push notifications.</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-header">
                        <h6 class="mb-0 fw-bold">Targeting</h6>
                    </div>
                    <div class="card-body p-4">
                        <div class="row g-3">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <small >Leave empty for "All Users". Enter user ID for individual targeting.</small>
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="datetime-local" name="scheduled_at" class="form-control"
                                       ...
                                       >
                                <small >Leave empty for draft. Set a future time to schedule.</small>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label fw-semibold">Template (optional)</label>
                ...
                <div class="card border-0 shadow-sm mb-3">
                    <div class="card-body">
                        <h6 class="fw-bold mb-3">
                            <i class="fas fa-info-circle me-1"></i> How Campaigns Work
                        </h6>
                        <ul class="small mb-0">
