<div class="container-fluid py-4">
    <div class="mb-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active style-27277"><?= $campaign ? 'Edit' : 'Create' ?></li>
            </ol>
        </nav>
        <h1 class="h3 mb-1 fw-bold"><?= $campaign ? 'Edit Campaign' : 'Create Campaign' ?></h1>
        <p class="mb-0 style-54585">Set up targeting, schedule, and message content</p>
    </div>
    ...
    <form method="POST" action="<?= BASE_URL ?>/admin/push-notifications/campaigns/store">
        ...
        <div class="row g-4">
            <div class="col-lg-8">
                <div class="card border-0 shadow-sm mb-4 style-52634">
                    <div class="card-header style-52852">
                        <h6 class="mb-0 fw-bold style-96443">Campaign Details</h6>
                    </div>
                    <div class="card-body p-4">
                        <div class="mb-3">
                            <label class="form-label fw-semibold style-96443">Campaign Name <span class="style-62247">*</span></label>
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-semibold style-96443">Description</label>
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-semibold style-96443">Notification Title <span class="style-62247">*</span></label>
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-semibold style-96443">Notification Body <span class="style-62247">*</span></label>
                ...
                <div class="card border-0 shadow-sm style-52634">
                    <div class="card-header style-52852">
                        <h6 class="mb-0 fw-bold style-96443">Targeting</h6>
                    </div>
                    <div class="card-body p-4">
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label class="form-label fw-semibold style-96443">Channel</label>
                                <select name="channel" class="form-select style-30479">
                                    <?php
                            ...
                            <div class="col-md-6">
                                <label class="form-label fw-semibold style-96443">Target Type</label>
                                <select name="target_type" class="form-select style-30479">
                                    <?php
                            ...
                            <div class="col-md-6">
                                <label class="form-label fw-semibold style-96443">Target Value</label>
                                <div id="targetValueWrapper">
                                    <select name="target_value" id="target_value_select" class="form-select style-30479">
                            ...
                            <div class="col-md-6">
                                <label class="form-label fw-semibold style-96443">Schedule</label>
                            ...
                            <div class="col-md-6">
                                <label class="form-label fw-semibold style-96443">Template (optional)</label>
                                <select name="template_id" class="form-select style-30479">
            ...
            <div class="col-lg-4">
                <div class="card border-0 shadow-sm mb-3 style-52634">
                    <div class="card-body">
                        <h6 class="fw-bold mb-3 style-96443">
                            <i class="fas fa-info-circle me-1 style-75937"></i> How Campaigns Work
                        </h6>
                        <ul class="small mb-0 style-78105">
