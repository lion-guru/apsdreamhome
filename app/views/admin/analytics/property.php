...
<div class="container-fluid">
    ...
    <div class="row g-4 mb-4">
        <div class="col-md-3"><div class="card bg-primary text-white border-0 shadow-sm"><div class="card-body"><h6>Total Properties</h6><h3 class="mb-0"><?= number_format($totalProperties ?? 0) ?></h3></div></div></div>
        <div class="col-md-3"><div class="card bg-success text-white border-0 shadow-sm"><div class="card-body"><h6>Available</h6><h3 class="mb-0"><?= number_format($availableProperties ?? 0) ?></h3></div></div></div>
        <div class="col-md-3"><div class="card bg-warning text-white border-0 shadow-sm"><div class="card-body"><h6>Sold This Month</h6><h3 class="mb-0"><?= number_format($soldThisMonth ?? 0) ?></h3></div></div></div>
        <div class="col-md-3"><div class="card bg-info text-white border-0 shadow-sm"><div class="card-body"><h6>Avg. Price</h6><h3 class="mb-0">₹<?= number_format($avgPrice ?? 0, 2) ?></h3></div></div></div>
    </div>
    <div class="row">
