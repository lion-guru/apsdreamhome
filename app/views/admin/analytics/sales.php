...
<div class="container-fluid">
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-md-3"><div class="card bg-success text-white border-0 shadow-sm"><div class="card-body"><h6>Revenue</h6><h3 class="mb-0">₹<?= number_format($revenue ?? 0, 2) ?></h3></div></div></div>
        ...
        <div class="col-md-3"><div class="card bg-info text-white border-0 shadow-sm"><div class="card-body"><h6>Avg. Deal Size</h6><h3 class="mb-0">₹<?= number_format($avgDealSize ?? 0, 2) ?></h3></div></div></div>
    </div>
    <div class="row">
