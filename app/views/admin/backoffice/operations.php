...
<div class="container-fluid py-4">
  <div class="d-flex justify-content-between align-items-center mb-4">
    <h1 class="h3">Daily Operations Log</h1>
    <a href="<?= BASE_URL ?>/admin/backoffice/operations/create" class="btn btn-primary"><i class="fas fa-plus me-1"></i>New Entry</a>
  </div>
  ...
  <div class="card border-0 shadow-sm">
    <div class="table-responsive">
      <table class="table table-hover mb-0">
        <thead><tr><th>Type</th><th>Colony</th><th>Description</th><th>Amount</th><th>Party</th><th>Status</th><th>Priority</th><th>Date</th></tr></thead>
        <tbody>
          <?php if (empty($logs)): ?>
            <tr><td colspan="8" class="text-center text-muted py-4">No operations for this date</td></tr>
          <?php else: ?>
