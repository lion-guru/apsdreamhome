...
<div class="container-fluid py-4">
  <div class="d-flex justify-content-between align-items-center mb-4">
    <h1 class="h3">Employee Attendance</h1>
    <a href="<?= BASE_URL ?>/admin/backoffice/attendance/monthly" class="btn btn-outline-primary btn-sm"><i class="fas fa-calendar me-1"></i>Monthly View</a>
  </div>
    ...
    <div class="card-body">
      <form id="attendanceForm" class="row g-3">
        ...
        <div class="col-md-2 d-flex align-items-end">
          <button type="submit" class="btn btn-primary w-100"><i class="fas fa-check me-1"></i>Mark</button>
        </div>
      </form>
    </div>
  </div>
  ...
  <div class="card border-0 shadow-sm">
    <div class="card-header"><strong>Today's Records</strong></div>
    <div class="table-responsive">
      <table class="table table-hover mb-0">
        <thead><tr><th>Employee</th><th>Date</th><th>Status</th><th>Check In</th><th>Check Out</th><th>Hours</th><th>OT</th><th>Late(min)</th></tr></thead>
        <tbody>
          <?php if (empty($records)): ?>
            <tr><td colspan="8" class="text-center text-muted py-4">No records today</td></tr>
          <?php else: ?>
