                            ...
                            <div class="col-md-4">
                                <div class="card aps-cp-card">
                                    ...
                                    <a href="<?= BASE_URL . '/' . $r['pan_document'] ?>" target="_blank" class="d-block">
                                        <img src="<?= BASE_URL . '/' . $r['pan_document']?>" class="card-img-top" alt="PAN">
                                    </a>
                            ...
                            <div class="col-md-4">
                                <div class="card aps-cp-card">
                                    ...
                                    <a href="<?= BASE_URL . '/' . $r['aadhaar_front_document'] ?>" target="_blank" class="d-block">
                                        <img src="<?= BASE_URL . '/' . $r['aadhaar_front_document']?>" class="card-img-top" alt="Aadhaar Front">
                                    </a>
                                    <div class="card-body text-center p-2">
                            ...
                            <div class="col-md-4">
                                <div class="card aps-cp-card">
                                    ...
                                    <a href="<?= BASE_URL . '/' . $r['aadhaar_back_document'] ?>" target="_blank" class="d-block">
                                        <img src="<?= BASE_URL . '/' . $r['aadhaar_back_document']?>" class="card-img-top" alt="Aadhaar Back">
                                    </a>
                                    <div class="card-body text-center p-2">
