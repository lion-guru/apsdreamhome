...
<div class="container-fluid">
    ...
    <div class="row g-4 mb-4">
        <div class="col-md-3"><div class="card bg-primary text-white border-0 shadow-sm"><div class="card-body"><h6>Total Allocations</h6><h3 class="mb-0"><?= number_format($totalAllocations ?? 0) ?></h3></div></div></div>
        <div class="col-md-3"><div class="card bg-warning text-white border-0 shadow-sm"><div class="card-body"><h6>Pending</h6><h3 class="mb-0"><?= number_format($pendingAllocations ?? 0) ?></h3></div></div></div>
        <div class="col-md-3"><div class="card bg-success text-white border-0 shadow-sm"><div class="card-body"><h6>Approved</h6><h3 class="mb-0"><?= number_format($approvedAllocations ?? 0) ?></h3></div></div></div>
        <div class="col-md-3"><div class="card bg-info text-white border-0 shadow-sm"><div class="card-body"><h6>Total Area</h6><h3 class="mb-0"><?= number_format($totalArea ?? 0) ?> sqft</h3></div></div></div>
    </div>
