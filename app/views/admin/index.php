...
$login_error = getSessionget_flash('login_error') ?? '';
...
$num1 = \App\Helpers\SecurityHelper::secureRandomInt(1, 10);
$num2 = \App\Helpers\SecurityHelper::secureRandomInt(1, 10);
$_SESSION['captcha_num1_admin'] = $num1;
$_SESSION['captcha_num2_admin'] = $num2;
$_SESSION['captcha_answer'] = $num1 + $num2;
$captcha_question = "$num1 + $num2 = ?";

// Check if already logged in using unified helper
