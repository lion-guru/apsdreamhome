        ...
        <div class="d-flex align-items-center gap-2 flex-wrap">
            ...
            <?php else: ?>
                <div class="dropdown d-inline-block">
                    ...
                    <ul class="dropdown-menu shadow" aria-labelledby="savedSearchesDropdown" >
            ...
            <button type="button" class="btn btn-sm btn-success rounded-pill ms-auto" id="saveSearchBtnGlobal" onclick="triggerSaveSearch()" >
