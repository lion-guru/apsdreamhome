...
<div class="d-xl-none mobile-top-bar">
    <div class="container-fluid px-3 py-2 d-flex align-items-center justify-content-between style-54371">
        ...
        <a class="navbar-brand d-flex align-items-center m-0" href="<?php echo BASE_URL; ?>" class="style-38085">
            ...
            <img src="<?php echo BASE_URL . htmlspecialchars($logo ?? ''); ?>"
                 ...
                 class="logo style-55486"
                 loading="eager"
                 fetchpriority="high">
            <span class="brand-text d-inline ms-1 fw-bold style-49690">
