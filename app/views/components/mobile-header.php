...
<header class="bg-white shadow-sm sticky top-0 z-50">
    ...
    <div class="mobile-header d-lg-none">
        ...
        <a href="<?php echo BASE_URL; ?>" class="flex items-center space-x-2 mx-auto">
            <img /> class="img-fluid">assets/images/logo.png" alt="APS Dream Home" class="h-8" onerror="this.style.display='none'">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-3">
                    <a href="<?php echo BASE_URL; ?>" class="d-flex align-items-center text-decoration-none">
                        <img /> class="img-fluid">assets/images/logo.png" alt="APS Dream Home" class="me-2" style="height: 40px;" onerror="this.style.display='none'">
