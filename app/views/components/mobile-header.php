...
<header class="bg-white shadow-sm sticky top-0 z-50">
    ...
    <div class="mobile-header d-lg-none">
        ...
        <a href="<?php echo BASE_URL; ?>" class="flex items-center space-x-2 mx-auto">
            <img src="<?php echo BASE_URL; ?>assets/images/logo.png" alt="APS Dream Home" class="h-8" onerror="this.style.display='none'">
            ...
            <?php if ($isAuthenticated): ?>
                <div class="dropdown">
                    <button class="btn btn-link p-0 text-decoration-none" type="button" data-bs-toggle="dropdown">
                        <img src="<?php echo !empty($userAvatar) ? BASE_URL . $userAvatar : BASE_URL . 'assets/images/user/default-avatar.jpg'; ?>"
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-3">
                    <a href="<?php echo BASE_URL; ?>" class="d-flex align-items-center text-decoration-none">
                        <img src="<?php echo BASE_URL; ?>assets/images/logo.png" alt="APS Dream Home" class="me-2" style="height: 40px;" onerror="this.style.display='none'">
