...
<div id="lcw-root" class="lcw-root lcw-position-br" aria-live="polite">
    ...
    <button id="lcw-launcher" class="lcw-launcher" type="button" aria-label="Open live chat">
    ...
    <div id="lcw-window" class="lcw-window" hidden role="dialog" aria-modal="false" aria-labelledby="lcw-title">
        <header class="lcw-header" id="lcw-title">
            <div class="lcw-header-info">
                ...
                <div>
                    <div class="lcw-title" id="lcw-header-title">APS Dream Home Support</div>
                    <div class="lcw-subtitle" id="lcw-header-subtitle">
                        <span class="lcw-dot lcw-dot-online"></span> We typically reply in a few minutes
                    </div>
                </div>
            </div>
            <button id="lcw-close" class="lcw-close" type="button" aria-label="Close chat">
                <i class="fas fa-times"></i>
            </button>
        </header>
        ...
        <div id="lcw-messages" class="lcw-messages" role="log" aria-live="polite">
            ...
            <div id="lcw-prechat" class="lcw-prechat">
                <div class="lcw-welcome">
                    ...
                    <h6>Hi! How can we help you today?</h6>
                    <p class="text-muted small mb-0">Please share your details and we'll get back to you right away.</p>
                </div>
        ...
        <footer class="lcw-input-bar" id="lcw-input-bar" hidden>
            ...
            <button id="lcw-send" class="lcw-send" type="button" aria-label="Send message" disabled>
                <i class="fas fa-paper-plane"></i>
            </button>
        </footer>

        <div class="lcw-powered">
            <i class="fas fa-shield-halved me-1"></i> Secure live chat
        </div>
    </div>
</div>
