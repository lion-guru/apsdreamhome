...
class ApiDocService
{
    ...
    public function generateSpec(string $version = 'v2'): array
    {
        ...
        return [
            ...
            'servers' => [
                ['url' => defined('BASE_URL') ? BASE_URL : '/', 'description' => 'Current host'],
    ...
    {
        $files = [
            (defined('APS_ROOT') ? APS_ROOT : dirname(__DIR__, 2)) . '/routes/api.php',
            (defined('APS_ROOT') ? APS_ROOT : dirname(__DIR__, 2)) . '/routes/web.php',
        ];
        $routes = [];
        $seen   = [];
