...
class PasswordManager {
    ...
    public static function generateSalt() {
        return bin2hex(\App\Helpers\SecurityHelper::secureRandomBytes(16)); // 32 character salt
    }
    ...
    public static function generateSecurePassword($length = 16) {
        ...
        foreach ($charsets as $charset) {
            $password .= $charset[\App\Helpers\SecurityHelper::secureRandomInt(0, strlen($charset) - 1)];
        }
        ...
        for ($i = 0; $i < $remainingLength; $i++) {
            $password .= $allChars[\App\Helpers\SecurityHelper::secureRandomInt(0, strlen($allChars) - 1)];
        }

        // Shuffle the password
        $passwordArray = str_split($password);
        \App\Helpers\SecurityHelper::secureShuffle($passwordArray);
