...
// Merged from: C:\xampp\htdocs\apsdreamhome\app\Controllers/..\Services\Legacy\PaymentGateway.php
...
function create_order($amount, $currency, $receipt, $notes = []) {
        switch ($this->gateway) {
            case 'razorpay':
...
function create_razorpay_order($amount, $currency, $receipt, $notes) {
...
function create_payu_order($amount, $currency, $receipt, $notes) {
        $payuData = [
...
function create_stripe_order($amount, $currency, $receipt, $notes) {
