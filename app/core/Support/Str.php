...
class Str {
    ...
    public static function pluralStudly($value, $count = 2) {
        $parts = preg_split('/(.)(?=[A-Z])/u', $value, -1, PREG_SPLIT_DELIM_CAPTURE | PREG_SPLIT_NO_EMPTY);
    ...
    public static function slugify($title, $separator = '-') {
        return static::slug($title, $separator);
    }
     ...
     * Get the plural form of an English word.
     */
    protected static function pluralize($value) {
        $plural = [
            '/(quiz)$/i' => '\1zes',
            '/^(ox)$/i' => '\1en',
            '/([m|l])ouse$/i' => '\1ice',
    ...
    /**
     * Get the character array of a UTF-8 string.
     */
    ...
    /**
     * Get the language specific characters for the given language.
     */
