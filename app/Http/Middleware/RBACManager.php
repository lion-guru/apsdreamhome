...
class RBACManager
{
    ...
    private static $rolePermissions = [
        ...
        'ceo' => [
            ...
            'users.view.all', 'employee.view.all', 'leads.view.all',
            'sales.view.all', 'commission.view', 'mlm.tree.view',
            'financial.view', 'payroll.view',
            'employee.view.team', 'leads.view.team', 'sales.view.team',
            'property.view.all', 'marketing.view.all', 'analytics.view',
            'reports.view', 'reports.generate', 'reports.export',
        ],
        'cfo' => [
            'dashboard.view',
            'users.view.all', 'employee.view.all',
            'sales.view.all', 'commission.view',
            'financial.view.all', 'financial.view',
            'invoice.create', 'invoice.view',
            'payment.process', 'expense.create', 'expense.view',
            'emi.manage', 'payroll.view', 'payroll.manage',
            'tax.manage', 'reports.view', 'reports.generate', 'reports.export',
            'leads.view.team', 'sales.view.team',
        ],
        'coo' => [
            'dashboard.view',
            'users.view.all', 'employee.view.all', 'employee.view.team',
            'leads.view.all', 'leads.view.team', 'leads.create', 'leads.edit', 'leads.assign',
            'sales.view.all', 'sales.view.team',
            'financial.view', 'expense.create', 'expense.view',
            'property.view.all', 'property.create', 'property.edit',
            'marketing.view.all', 'analytics.view',
            'reports.view', 'reports.generate',
            'tasks.view', 'tasks.create', 'tasks.assign',
        ],
        'cto' => [
            'dashboard.view', 'dashboard.customize', 'dashboard.widgets',
            'users.view.all',
            'leads.view.all', 'sales.view.all',
            'marketing.view.all', 'analytics.view',
            'reports.view', 'reports.generate', 'reports.export', 'reports.schedule',
            'ai.dashboard', 'ai.settings', 'ai.property.valuation', 'ai.lead.scoring', 'chatbot.settings',
            'system.settings', 'backup.manage', 'security.settings',
            'api.manage', 'log.viewer', 'cache.manage',
            'tasks.view', 'tasks.create',
        ],
        'cmo' => [
            'dashboard.view',
            'users.view.all', 'employee.view.all',
            'leads.view.all', 'leads.create',
            'sales.view.all',
            'marketing.view.all', 'campaign.view', 'campaign.create', 'campaign.execute',
            'email.marketing', 'sms.marketing', 'social.media',
            'analytics.view', 'reports.view', 'reports.generate',
            'property.view.all', 'property.create', 'property.edit',
            'content.view', 'pages.manage', 'media.manage', 'blog.manage', 'faq.manage',
            'notifications.send', 'email.templates', 'sms.templates', 'whatsapp.templates',
        ],
        'chro' => [
            'dashboard.view',
            'users.view.all', 'employee.view.all', 'employee.view.team',
            'employee.add', 'employee.edit',
        ...
        'director' => [
            'dashboard.view',
            'users.view.team', 'employee.view.team',
            'leads.view.team', 'leads.create', 'leads.edit',
            'sales.view.team', 'commission.view', 'mlm.tree.view',
            'financial.view', 'expense.view',
            'marketing.view.all',
            'reports.view', 'reports.generate',
            'tasks.view', 'tasks.create', 'tasks.assign',
        ],
        'sales_director' => [
            'dashboard.view',
            'users.view.team', 'employee.view.team',
            'property.view.all', 'property.view',
            'leads.view.team', 'leads.create', 'leads.edit', 'leads.assign',
            'sales.view.all', 'sales.view.team', 'sales.create',
            'commission.view', 'commission.manage', 'mlm.tree.view',
            'reports.view', 'reports.generate',
            'tasks.view', 'tasks.create', 'tasks.assign',
        ],
        'marketing_director' => [
        ...
        'construction_director' => [
            ...
            'leads.view.team', 'leads.create',
            'sales.view.team',
            'financial.view', 'expense.view', 'expense.create',
            'reports.view', 'reports.generate',
            'tasks.view', 'tasks.create', 'tasks.assign',
        ],
        ...
        'marketing_manager' => [
            ...
            'content.view', 'pages.manage', 'media.manage', 'blog.manage', 'faq.manage',
            'notifications.send', 'email.templates', 'sms.templates',
            'tasks.view', 'tasks.create', 'tasks.assign',
        ],
        'finance_manager' => [
            'dashboard.view',
            'users.view.team',
            'sales.view.team',
            'financial.view', 'financial.view.all',
            'invoice.create', 'invoice.view',
            'expense.create', 'expense.view',
            'emi.manage', 'payroll.view',
            'reports.view', 'reports.generate',
            'tasks.view', 'tasks.create',
        ],
        'property_manager' => [
            'dashboard.view',
            'users.view.team', 'employee.view.team',
            'property.view.all', 'property.view', 'property.create', 'property.edit', 'property.delete',
            'property.pricing',
            'leads.view.team', 'leads.create', 'leads.edit',
            'sales.view.team',
            'reports.view',
        ...
        'it_manager' => [
            'dashboard.view', 'dashboard.customize', 'dashboard.widgets',
            'users.view.team', 'employee.view.team',
            'ai.dashboard', 'ai.settings', 'chatbot.settings',
            'analytics.view',
            'reports.view',
            'system.settings', 'backup.manage', 'security.settings',
            'api.manage', 'log.viewer', 'cache.manage',
        ...
        'content_writer' => [
            ...
            'property.view',
            'leads.view.own',
            'content.view', 'blog.manage',
            'tasks.view', 'tasks.complete',
        ],
        'graphic_designer' => [
            'dashboard.view',
            'property.view',
            'content.view', 'media.manage',
            'tasks.view', 'tasks.complete',
        ],
        'data_entry_operator' => [
            'dashboard.view',
        ...
        'senior_associate' => [
            ...
            'property.view',
            'leads.view.own', 'leads.create',
            'sales.create', 'commission.view',
            'mlm.tree.view', 'mlm.downline.view',
            'tasks.view', 'tasks.complete',
            'reports.view',
        ],
        'associate_team_lead' => [
            ...
            'property.view',
            'leads.view.own', 'leads.create',
            'sales.create', 'commission.view', 'commission.manage',
            'mlm.tree.view', 'mlm.downline.view',
            'tasks.view', 'tasks.complete',
            'reports.view',
        ],
        ...
        'senior_agent' => [
            ...
            'property.view',
            'leads.view.own', 'leads.create',
            'sales.create', 'sales.view', 'commission.view',
            'tasks.view', 'tasks.complete',
            'reports.view',
        ],
        'agent' => [
        ...
        'admin' => [
            'dashboard.view', 'dashboard.widgets',
            'users.view.all', 'users.create', 'users.edit',
            'property.view.all', 'property.create', 'property.edit', 'property.delete',
            'leads.view.all', 'leads.create', 'leads.edit', 'leads.delete', 'leads.assign',
            'sales.view.all', 'commission.view', 'commission.manage',
            'financial.view', 'invoice.create', 'invoice.view',
            'employee.view.all', 'employee.add', 'employee.edit',
            'attendance.view', 'attendance.manage', 'leave.approve',
            'marketing.view.all', 'campaign.view', 'campaign.create', 'campaign.execute',
            'content.view', 'pages.manage', 'media.manage', 'blog.manage',
            'ai.dashboard', 'ai.property.valuation', 'ai.lead.scoring',
            'reports.view', 'reports.generate', 'reports.export',
            'notifications.send', 'email.templates', 'sms.templates', 'whatsapp.templates',
            'support.view', 'support.reply', 'support.escalate',
            'tasks.view', 'tasks.create', 'tasks.assign',
        ...
        'manager' => [
            ...
            'property.view.all', 'property.view',
            'leads.view.team', 'leads.create', 'leads.edit', 'leads.assign',
            'sales.view.team', 'commission.view',
            'financial.view', 'expense.view',
            'attendance.view', 'leave.approve',
            'reports.view', 'reports.generate',
            'tasks.view', 'tasks.create', 'tasks.assign',
    ...
    public static function getUsersByRole(string $role): array
    {
        try {
            $db = Database::getInstance();
            return $db->fetchAll("SELECT * FROM users WHERE role = ?", [$role]);
        } catch (Exception $e) {
