...
class PropertyController extends BaseController
{
    ...
    public function store()
    {
        try {
            ...
            $featured = isset(Security::sanitize($_POST['featured'])) ? 1 : 0;
...
// Merged from: C:\xampp\htdocs\apsdreamhome\app\Controllers/..\Http\Controllers\Api\PropertyController.php
...
//
// This file contains 983 lines. Consider optimizations:
//
