...
class AIValuationController extends BaseController
{
    ...
    public function calculateValuation()
    {
        ...
        try {
            $propertyData = [
                ...
                'size' => Security::sanitize($_POST['size']) ?? 1000,
                'age' => Security::sanitize($_POST['age']) ?? 0,
                'condition' => Security::sanitize($_POST['condition']) ?? 'average',
    ...
    public function getInvestmentAnalysis()
    {
        ...
        try {
            $propertyData = json_decode(Security::sanitize($_POST['property_data']), true) ?? [];
