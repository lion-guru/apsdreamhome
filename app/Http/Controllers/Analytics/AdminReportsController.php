...
class AdminReportsController extends AdminController
{
    ...
    public function index()
    {
        ...
        $this->data['breadcrumbs'] = [
            ...
            ['title' => 'Reports', 'url' => $this->getBaseUrl() . 'admin/reports']
        ];
    ...
    public function properties()
    {
        ...
        $this->data['breadcrumbs'] = [
            ['title' => 'Admin', 'url' => $this->getBaseUrl() . 'admin'],
            ['title' => 'Reports', 'url' => $this->getBaseUrl() . 'admin/reports'],
            ['title' => 'Properties', 'url' => $this->getBaseUrl() . 'admin/reports/properties']
        ];
    ...
    public function users()
    {
        ...
        $this->data['breadcrumbs'] = [
            ['title' => 'Admin', 'url' => $this->getBaseUrl() . 'admin'],
            ['title' => 'Reports', 'url' => $this->getBaseUrl() . 'admin/reports'],
            ['title' => 'Users', 'url' => $this->getBaseUrl() . 'admin/reports/users']
        ];
    ...
    public function financial()
    {
        ...
        $this->data['breadcrumbs'] = [
            ['title' => 'Admin', 'url' => $this->getBaseUrl() . 'admin'],
            ['title' => 'Reports', 'url' => $this->getBaseUrl() . 'admin/reports'],
            ['title' => 'Financial', 'url' => $this->getBaseUrl() . 'admin/reports/financial']
        ];
    ...
    public function inquiries()
    {
        ...
        $this->data['breadcrumbs'] = [
            ['title' => 'Admin', 'url' => $this->getBaseUrl() . 'admin'],
            ['title' => 'Reports', 'url' => $this->getBaseUrl() . 'admin/reports'],
            ['title' => 'Inquiries', 'url' => $this->getBaseUrl() . 'admin/reports/inquiries']
        ];
    ...
    private function getTopPerformingProperties($filters = [])
    {
        ...
        // Default return for valid database connection
        return [];
    }
...
//
// This file contains 624 lines. Consider optimizations:
//
