...
class LandManagerController extends BaseController
{
    ...
    public function scheduleSiteVisit($propertyId, $visitData)
    {
        try {
            ...
            // Log activity
            $this->logLandActivity('site_visit_scheduled', 
                "Site visit scheduled for property: {$property['title']}", $visitId);
    ...
    public function updateAcquisition($acquisitionId, $acquisitionData)
    {
        try {
            ...
            // Log activity
            $this->logLandActivity('acquisition_updated', 
                "Land acquisition updated to status: {$acquisitionData['status']}", $acquisitionId);
    ...
    public function completeSiteVisit($visitId, $completionData)
    {
        try {
            ...
            // Log activity
            $this->logLandActivity('site_visit_completed', 
                "Site visit completed for property: {$visit['property_title']}", $visitId);
    ...
    public function updatePropertyDocumentation($propertyId, $documents)
    {
        try {
            ...
            // Log activity
            $this->logLandActivity('documentation_updated', 
                "Documentation updated for property: {$property['title']}", $propertyId);
