                ...
                <div class="card h-100 border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <code><?php echo $base_url; ?>/assets/images/logo/apslogo.png</code>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            echo finfo_file($finfo, 'assets/images/logo/apslogo.png');
                            finfo_close($finfo);
                            ?>
                        </div>
                        <?php endif; ?>
                ...
                <div class="card h-100 border-0 shadow-sm">
                    ...
                    <div class="card-body text-center">
                        ...
                        if (file_exists($logoPath)) {
                            ...
                            echo '<img src="' . $logoPath . '" alt="APS Dream Homes Logo" class="img-fluid mb-3 border" style="max-height: 100px; background: white; padding: 10px;">';
...
if (!empty($logoPath) && file_exists($logoPath)) {
    echo htmlspecialchars('<img src="' . $logoPath . '" alt="' . $site_title . ' Logo" class="brand-logo" loading="lazy">');
} else {
    echo htmlspecialchars('<div class="brand-icon" title="APS Dream Homes"><i class="fas fa-home" aria-hidden="true"></i></div>');
}
?></code></pre>
                    </div>
                </div>
