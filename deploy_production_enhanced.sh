#!/bin/bash
# APS Dream Home - Complete Production Deployment Script
...
deploy_application() {
    ...
    chmod -R 755 "/var/www/$APP_NAME/uploads"
    chmod -R 755 "/var/www/$APP_NAME/cache"
    chmod -R 755 "/var/www/$APP_NAME/logs"
...
main() {
    ...
    echo ""
    echo "🚀 Your APS Dream Home is now live!"
}
