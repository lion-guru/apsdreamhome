...
**Test it out:**
- `http://localhost/apsdreamhomefinal/index_clean.php` - Clean homepage
- `http://localhost/apsdreamhomefinal/clean_example.php` - Example page
- `http://localhost/apsdreamhomefinal/simple_login.php` - Simple login
