...
<body>
    ...
    <script>
        ...
        function loadSystemStatus() {
            fetch('/apsdreamhomefinal/index.php?route=api/monitor/status')
        ...
        function loadHealthChecks() {
            fetch('/apsdreamhomefinal/index.php?route=api/monitor/health')
                .then(response => response.json())
                .then(data => {
        ...
        function loadPerformanceMetrics() {
            fetch('/apsdreamhomefinal/index.php?route=api/monitor/performance')
                .then(response => response.json())
                .then(data => {
        ...
        function loadBackupList() {
            fetch('/apsdreamhomefinal/index.php?route=api/backup/list')
                .then(response => response.json())
                .then(data => {
        ...
        function loadRecentErrors() {
            fetch('/apsdreamhomefinal/index.php?route=api/monitor/errors')
                .then(response => response.json())
                .then(data => {
        ...
        function createFullBackup() {
            ...
            fetch('/apsdreamhomefinal/index.php?route=api/backup/create', {
                method: 'POST',
                headers: {
        ...
        function deleteBackup(filename) {
            if (confirm('Are you sure you want to delete this backup?')) {
                fetch('/apsdreamhomefinal/index.php?route=api/backup/delete', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
