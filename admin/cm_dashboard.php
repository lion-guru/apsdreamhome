...
initAdminSession();
if (!isset($_SESSION['admin_logged_in']) || $_SESSION['admin_logged_in'] !== true || $_SESSION['admin_role'] !== 'cm') {
    header('Location: login.php?error=unauthorized');
    exit();
}
$cm = $_SESSION['admin_username'] ?? 'CM';
?><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="container py-5">
        ...
        <h1 class="mb-4 text-center text-success">Welcome, <?php echo htmlspecialchars($cm); ?>!</h1>
