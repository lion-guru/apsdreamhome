...
initAdminSession();
if (!isset($_SESSION['admin_logged_in']) || $_SESSION['admin_logged_in'] !== true || $_SESSION['admin_role'] !== 'associate') {
    header('Location: login.php?error=unauthorized');
    exit();
}
$associate = $_SESSION['admin_username'] ?? 'Associate';
?><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="container py-5">
        ...
        <h1 class="mb-4 text-center text-info">Welcome, <?php echo htmlspecialchars($associate); ?>!</h1>
