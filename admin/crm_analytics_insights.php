...
function getCustomerAnalytics() {
    ...
    $analytics['acquisition_trends'] = $result ? $result->fetch_all(MYSQLI_ASSOC) : [];
    ...
    $result = $conn->query($query);
    $analytics['lifetime_value'] = $result ? $result->fetch_all(MYSQLI_ASSOC) : [];
    ...
    $result = $conn->query($query);
    $analytics['segmentation'] = $result ? $result->fetch_all(MYSQLI_ASSOC) : [];
...
function getLeadAnalytics() {
    ...
    $result = $conn->query($query);
    $analytics['conversion_funnel'] = $result ? $result->fetch_all(MYSQLI_ASSOC) : [];
    ...
    $result = $conn->query($query);
    $analytics['source_performance'] = $result ? $result->fetch_all(MYSQLI_ASSOC) : [];
    ...
    $result = $conn->query($query);
    $analytics['response_time'] = $result ? $result->fetch_assoc() : [];
...
function getSalesAnalytics() {
    ...
    $result = $conn->query($query);
    $analytics['monthly_trends'] = $result ? $result->fetch_all(MYSQLI_ASSOC) : [];
    ...
    $result = $conn->query($query);
    $analytics['property_type_sales'] = $result ? $result->fetch_all(MYSQLI_ASSOC) : [];
    ...
    $result = $conn->query($query);
    $analytics['sales_team_performance'] = $result ? $result->fetch_all(MYSQLI_ASSOC) : [];
...
function getCommunicationAnalytics() {
    ...
    $result = $conn->query($query);
    $analytics['email_campaigns'] = $result ? $result->fetch_all(MYSQLI_ASSOC) : [];
    ...
    $result = $conn->query($query);
    $analytics['communication_channels'] = $result ? $result->fetch_all(MYSQLI_ASSOC) : [];
