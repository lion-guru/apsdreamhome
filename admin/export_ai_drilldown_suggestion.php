<?php
// Export drilldown results for a specific suggestion as CSV
session_start();
...
$suggestion = isset($_GET['suggestion']) ? mysqli_real_escape_string($con, $_GET['suggestion']) : null;
$where = $date_sql . ' ' . $role_sql;
if ($suggestion) {
    $where .= " AND suggestion_text='$suggestion'";
}
