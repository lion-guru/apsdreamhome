...
<body class="admin-dashboard">
    ...
    <script>
        ...
        function refreshData() {
            fetch('/apsdreamhome/api/notification_debug.php')
        ...
        function clearLogs() {
            if (confirm('Are you sure you want to clear all logs?')) {
                fetch('/apsdreamhome/api/notification_debug.php?action=clear', {
                    method: 'POST'
                })
                .then(() => {
        ...
        function exportLogs() {
            window.location.href = '/apsdreamhome/api/notification_debug.php?action=export';
        }
        ...
        function setupTestForm() {
            document.getElementById('testForm').addEventListener('submit', function(e) {
                ...
                fetch('/apsdreamhome/api/notification_debug.php?action=test', {
                    method: 'POST',
                    headers: {
