...
<body class="admin-dashboard">
    ...
    <script>
        ...
        function loadStats() {
            fetch(`/apsdreamhomefinal/api/system_stats.php?range=${currentTimeRange}`)
        ...
        function loadLogs() {
            fetch(`/apsdreamhomefinal/api/system_logs.php?range=${currentTimeRange}`)
                .then(response => response.json())
                .then(data => {
        ...
        function exportStats() {
            window.location.href = `/apsdreamhomefinal/api/export_stats.php?range=${currentTimeRange}`;
        }
