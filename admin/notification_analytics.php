...
<body class="admin-dashboard">
    ...
    <script>
        ...
        function loadAnalytics() {
            fetch(`/apsdreamhomefinal/api/notification_analytics.php?range=${currentTimeRange}`)
        ...
        function exportAnalytics() {
            window.location.href = `/apsdreamhomefinal/api/export_notification_analytics.php?range=${currentTimeRange}`;
        }
