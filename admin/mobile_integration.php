...
include 'config.php';
require_role('Admin');
$devices = $conn->query("SELECT * FROM mobile_devices ORDER BY id DESC LIMIT 20");
?><!DOCTYPE html>
<html lang='en'>
