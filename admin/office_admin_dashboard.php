<?php
session_start();
if (!isset($_SESSION['admin_logged_in']) || $_SESSION['admin_logged_in'] !== true || !in_array($_SESSION['admin_role'], ['office_admin'])) {
    header('Location: login.php');
    exit();
}
$employee = $_SESSION['admin_username'] ?? 'Office Admin';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Office Admin Dashboard | APS Dream Home</title>
...
<div class="dashboard-container">
    <div class="dashboard-header">
        <h2><i class="fa fa-building"></i> Welcome, <?php echo htmlspecialchars($employee); ?>!</h2>
        <span class="user-badge">Office Admin</span>
    </div>
    ...
    <div class="dashboard-section">
        <h4>Today's Office Admin Tasks</h4>
        <ul class="task-list">
            <li>Manage office resources</li>
            <li>Schedule meetings</li>
            <li>Oversee facility maintenance</li>
        </ul>
    </div>
    <div class="dashboard-section">
        <h4>Quick Actions</h4>
