...
<body><div class='container py-4'><h2>API Analytics & Rate Limiting</h2><table class='table table-bordered'><thead><tr><th>Developer</th><th>API Key</th><th>Endpoint</th><th>Usage Count</th><th>Timestamp</th></tr></thead><tbody><?php while($u = $usage->fetch_assoc()): ?><tr><td><?= htmlspecialchars($u['dev_name']) ?></td><td><?= htmlspecialchars($u['// SECURITY: Sensitive information removed']) ?></td><td><?= htmlspecialchars($u['endpoint']) ?></td><td><?= htmlspecialchars($u['usage_count']) ?></td><td><?= $u['timestamp'] ?></td></tr><?php endwhile; ?></tbody></table><p class='mt-3'>*Monitor API usage, set quotas, and provide analytics to developers. Rate limiting integration ready.</p></div></body></html>
