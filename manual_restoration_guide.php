...
echo "<div style='background: #343a40; color: #28a745; padding: 15px; border-radius: 5px; font-family: monospace;'>";
echo "mysql -u root -e \"DROP DATABASE IF EXISTS apsdreamhomefinal; CREATE DATABASE apsdreamhomefinal CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;\"<br>";
echo "</div>";

echo "<h3>Step 4: Import Complete Database</h3>";
echo "<div style='background: #343a40; color: #28a745; padding: 15px; border-radius: 5px; font-family: monospace;'>";
echo "mysql -u root apsdreamhomefinal < C:\\xampp\\htdocs\\apsdreamhomefinal\\database\\apsdreamhomes.sql<br>";
echo "</div>";

echo "<h3>Step 5: Verify Restoration</h3>";
echo "<div style='background: #343a40; color: #28a745; padding: 15px; border-radius: 5px; font-family: monospace;'>";
echo "mysql -u root apsdreamhomefinal -e \"SELECT COUNT(*) as tables FROM information_schema.tables WHERE table_schema = 'apsdreamhomefinal';\"<br>";
echo "</div>";
echo "</div>";
