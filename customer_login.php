                ...
                if ($result->num_rows === 0) {
                    ...
                    if ($password_verified) {
                        ...
                        if (headers_sent($filename, $linenum)) {
                            ...
                            die("Redirect failed. Please click <a href='http://" . $_SERVER['HTTP_HOST'] . "/apsdreamhomefinal/customer_dashboard.php'>here</a> to continue.");
                        }
                        ...
                        $redirect_url = 'http://' . $_SERVER['HTTP_HOST'] . '/apsdreamhomefinal/customer_dashboard.php';
