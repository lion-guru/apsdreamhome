...
$db_user = 'root';
$db_pass = '';
$db_name = 'apsdreamhomefinal_merged';
...
// Database files
$file1 = __DIR__ . '/DATABASE FILE/apsdreamhomefinal.sql';      // Older, complete (96 tables)
$file2 = __DIR__ . '/DATABASE FILE/apsdreamhomefinal (2).sql';  // Newer, partial (23 tables)
