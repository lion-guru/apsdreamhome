(function () {
    ...
    function addMessage(text, isUser, options) {
        ...
        messageDiv.innerHTML = '<div class="ai-message-content">' + displayText + '</div><span class="ai-time">' + time + '</span>';
            ...
            setTimeout(function () {
                ...
                if (data.success) {
                    ...
                    if (data.quick_replies && data.quick_replies.length > 0) {
                        setTimeout(function () { addQuickReplies(data.quick_replies); }, 500);
                    }
                } else {
                    addMessage("Sorry, I'm having trouble understanding. Try calling us at <strong>+91 92771 21112</strong> or <a href='/contact'>Contact Form</a>", false, { animate: true });
                }
            }, typingDelay);
        })
        .catch(function () {
            hideTyping();
            addMessage("Connection issue! Please try again or call <strong>+91 92771 21112</strong> for instant help.", false, { animate: true });
        });
    }
    ...
    function addQuickReplies(replies) {
        ...
        replies.forEach(function (reply) {
            ...
            btn.onclick = function () { sendQuickMessage(reply); };
