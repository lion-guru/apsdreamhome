...
function setupGlobalEventListeners() {
    ...
    if (backToTopBtn) {
        ...
        window.addEventListener('scroll', apsUtils.throttle(function() {
    ...
    if (whatsappBtn) {
        whatsappBtn.addEventListener('click', function(e) {
            e.preventDefault();
            const message = encodeURIComponent('Hello! I\'m interested in APS Dream Home properties.');
    ...
    // Window resize
    window.addEventListener('resize', apsUtils.debounce(function() {
        handleWindowResize();
    }, 250));
