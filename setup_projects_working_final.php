...
try {
    ...
    // Sample data
    $projects = [
        ['Suryoday Heights Phase 1', 'Premium residential project in Suryoday Colony with modern amenities', 'residential', 'APS Developers', '+91-9876543210', 'Suryoday Colony', 'Gorakhpur', 'Uttar Pradesh', 50, 45, 5, 2000000, 8000000, 'under_construction', '2024-01-15', '2025-12-31', json_encode(['24/7 Security','Club House','Swimming Pool','Gym','Park']), '/uploads/brochure.pdf', json_encode(['suryoday_1.jpg','suryoday_2.jpg']), 1],
        ['Braj Radha Enclave', 'Spiritual residential project near Budhya Mata Mandir in Deoria', 'residential', 'Braj Properties', '+91-9876543220', 'Braj Radha Nagri', 'Deoria', 'Uttar Pradesh', 40, 35, 5, 1200000, 4500000, 'under_construction', '2024-02-01', '2025-09-30', json_encode(['24/7 Security','Temple View','Meditation Center','Community Hall']), '/uploads/brochure2.pdf', json_encode(['braj_1.jpg','braj_2.jpg']), 0],
        ['Raghunath City Center', 'Mixed-use commercial and residential project in Raghunath Nagri', 'mixed', 'Raghunath Developers', '+91-9876543330', 'Raghunath Nagri', 'Gorakhpur', 'Uttar Pradesh', 60, 25, 20, 1800000, 6000000, 'planning', '2024-03-01', '2026-06-30', json_encode(['24/7 Security','Commercial Complex','Shopping Area','Residential Blocks']), '/uploads/brochure3.pdf', json_encode(['raghunath_1.jpg','raghunath_2.jpg','raghunath_3.jpg']), 1]
    ];
    ...
    echo "✅ JSON support: Amenities & images\n";
