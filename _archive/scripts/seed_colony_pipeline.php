...
echo "[OK] 8 development costs inserted. Total: ₹" . number_format($totalCost) . " + GST ₹" . number_format($totalGst) . " = ₹" . number_format($totalCost + $totalGst) . "\n";
...
echo "  Development:     8 projects, ₹" . number_format($totalCost) . " + GST ₹" . number_format($totalGst) . " = ₹" . number_format($totalCost + $totalGst) . "\n";
