// Test script for Correct AI Chatbot (using official Google GenAI library)
import { generateAIResponse } from './ai-chatbot-correct.js';

async function testChatbot() {
  console.log('🤖 Testing Correct AI Chatbot (Official Google GenAI)...\n');
  ...
  try {
    ...
    console.log('🎉 All Google AI Chatbot tests completed successfully!');
