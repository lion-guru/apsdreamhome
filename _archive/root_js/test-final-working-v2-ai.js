// Test script for Final Working V2 AI Chatbot
import { generateAIResponse } from './ai-chatbot-final-working-v2.js';

async function testChatbot() {
  console.log('🤖 Testing Final Working V2 AI Chatbot...\n');
