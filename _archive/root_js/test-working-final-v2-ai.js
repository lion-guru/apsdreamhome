// Test script for Working Final V2 AI Chatbot
import { generateAIResponse } from './ai-chatbot-working-final-v2.js';

async function testChatbot() {
  console.log('🤖 Testing Working Final V2 AI Chatbot...\n');
