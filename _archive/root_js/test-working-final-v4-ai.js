// Test script for Working Final V4 AI Chatbot
import { generateAIResponse } from './ai-chatbot-working-final-v4.js';

async function testChatbot() {
  console.log('🤖 Testing Working Final V4 AI Chatbot...\n');
