...
class HomePage extends ConsumerWidget {
  ...
  void _makeQuickCall(BuildContext context) async {
    final phoneUri = Uri.parse('tel:${AppConstants.supportPhone}');
    if (await canLaunchUrl(phoneUri)) {
      ...
      if (context.mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              'Unable to make call. Please dial ${AppConstants.supportPhone}',
            ),
          ),
        );
      }
