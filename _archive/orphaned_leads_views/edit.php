        ...
        <div class="col-lg-8">
            <div class="card shadow mb-4">
                ...
                <div class="card-body aps-cp-card-body">
                    <form method="POST" action="<?= BASE_URL ?>/leads/<?= $lead['id'] ?>/update" id="editLeadForm">
                                    ...
                                    <div class="card-body aps-cp-card-body">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea class="form-control"
                                                ...
                                                name="notes"
                                                rows="2"
                                                placeholder="Any additional information"><?= h($lead['notes'] ?? '') ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Are you sure you want to delete <strong><?= h($lead['name']) ?></strong>?</p>
                <p class="text-danger">This action cannot be undone.</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                <a href="/leads/<?= $lead['id'] ?>/delete" class="btn btn-danger">Delete</a>
            </div>
        </div>
    </div>
</div>
