...
class SocialMediaController extends BaseController
{
    ...
    private function featureNotAvailable()
    {
        $this->requireAdmin();
    ...
    {
        if (!self::FEATURE_ENABLED) { $this->jsonResponse(['success' => false, 'error' => 'Feature not available'], 503); return; }
    ...
    {
        if (!self::FEATURE_ENABLED) { sendJsonResponse(['success' => false, 'error' => 'Feature not available'], 503); return; }
    ...
    {
        if (!self::FEATURE_ENABLED) { return; }
