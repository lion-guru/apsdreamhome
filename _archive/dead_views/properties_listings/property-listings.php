                    ...
                    <div class="row">
                        <?php if (empty($properties)): ?>
                            <div class="col-12 text-center py-5" data-aos="fade-up">
                                ...
                                <h3 class="text-muted fw-bold">No Properties Found</h3>
                                <p class="lead">Try adjusting your filters or search criteria to find what you're looking for.</p>
                                <a href="<?php echo defined('BASE_URL') ? BASE_URL : ''; ?>/properties" class="btn btn-primary mt-3 px-4 py-2 rounded-pill">Clear All Filters</a>
                            </div>
                        <?php else: ?>
                                ...
                                <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="<?php echo ($index % 3) * 100; ?>">
                                    <div class="property-card">
                                        <div class="property-image">
                                            ...
                                            ?>
                                             src="<?= htmlspecialchars($image) ? loading="lazy">" class="img-fluid" alt="<?php echo htmlspecialchars($property['title'] ?? 'Property'); ?>" loading="lazy">
                                            ...
                                            <?php elseif (!empty($property['source']) && $property['source'] == 'ai_fetched'): ?>
                                                <span class="property-badge" class="style-91659"><i class="fas fa-globe me-1"></i>Web Listing</span>
                                            <?php else: ?>
                                        ...
                                        <div class="property-content">
                                            ...
                                            <div class="property-location">
                                                ...
                                                <?php echo htmlspecialchars($property['location'] ?? 'Gorakhpur'); ?>
                                            </div>
                                            <div class="property-features">
                                                <?php if (!empty($property['bedrooms'])): ?>
                                                    <div class="property-feature">
                                                        <i class="fas fa-bed"></i>
                                                        <span><?php echo htmlspecialchars($property['bedrooms']); ?> BHK</span>
                                                    </div>
                                                <?php endif; ?>
                                                <?php if (!empty($property['bathrooms'])): ?>
                                                    <div class="property-feature">
                                                        <i class="fas fa-bath"></i>
                                                        <span><?php echo htmlspecialchars($property['bathrooms']); ?> Baths</span>
                                                    </div>
                                                <?php endif; ?>
                                            ...
                                            <p class="property-description">
                                                <?php echo htmlspecialchars(substr($property['description'] ?? 'Premium property available for viewing. Contact us for more details.', 0, 90)) . '...'; ?>
                                            </p>
                                            <div class="property-actions">
                                                <a href="<?php echo defined('BASE_URL') ? BASE_URL : ''; ?>/properties/<?php echo $property['id'] ?? 0; ?>" class="btn-property btn-primary-property">
                                                    <i class="fas fa-eye me-2"></i>View Details
                                                </a>
                                                <a href="<?php echo defined('BASE_URL') ? BASE_URL : ''; ?>/contact?property_id=<?php echo $property['id'] ?? 0; ?>" class="btn-property btn-outline-property">
