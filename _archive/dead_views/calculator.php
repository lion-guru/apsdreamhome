                            ...
                            <form action="<?= BASE_URL ?>calc" method="POST">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="amount" class="form-control bg-light border-0" placeholder="e.g. 500000" value="<?= htmlspecialchars($_REQUEST['amount'] ?? '', ENT_QUOTES, 'UTF-8') ?>" required>
                                    </div>
                                </div>
                                <div class="mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" step="0.01" name="interest" class="form-control bg-light border-0" placeholder="e.g. 8.5" value="<?= htmlspecialchars($_REQUEST['interest'] ?? '', ENT_QUOTES, 'UTF-8') ?>" required>
                                    </div>
                                </div>
                                <div class="mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="month" class="form-control bg-light border-0" placeholder="e.g. 12" value="<?= htmlspecialchars($_REQUEST['month'] ?? '', ENT_QUOTES, 'UTF-8') ?>" required>
                                    </div>
                                </div>
