    ...
    <div class="row g-3 mb-4">
        <div class="col-md-4">
            <div class="aps-cp-card"><div class="aps-cp-card-body">
                ...
                <div class="progress mb-1 style-44570"><div class="progress-bar bg-<?= $memPct > 80 ? 'danger' : ($memPct > 50 ? 'warning' : 'success') ?>" class="style-22963"></div></div>
        ...
        <div class="col-md-4">
            <div class="aps-cp-card"><div class="aps-cp-card-body">
                ...
                <div class="progress mb-1 style-44570"><div class="progress-bar bg-<?= $diskPct > 90 ? 'danger' : ($diskPct > 70 ? 'warning' : 'info') ?>" class="style-45310"></div></div>
