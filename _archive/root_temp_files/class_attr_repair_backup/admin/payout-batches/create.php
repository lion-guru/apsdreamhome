ï»¿<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-12">
            ...
            <h2 class="style-48283"><i class="fas fa-plus-circle me-2" class="style-56943"></i> Create Payout Batch</h2>
        </div>
    </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="batch_type" class="form-select" class="style-62452">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-6">
                                ...
                                <input type="date" name="period_from" class="form-control" class="style-62452">
                            </div>
                            <div class="col-md-6">
                                <label class="style-96386">Period To</label>
                                <input type="date" name="period_to" class="form-control" class="style-62452">
                            </div>
                        </div>
                        <div class="mt-3">
                    ...
                    <div class="card-body" id="populateOptions" class="style-2248">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <select name="populate_type" class="form-select" class="style-62452">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="date" name="populate_from" class="form-control" class="style-62452">
                            </div>
                            <div class="col-md-4">
                                <label class="style-96386">Date To (optional)</label>
                                <input type="date" name="populate_to" class="form-control" class="style-62452">
                            </div>
                        </div>
                        <small class="style-77712" class="mt-2 d-block">
