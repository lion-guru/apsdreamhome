      ...
      <table role="presentation" class="container" border="0" cellpadding="0" cellspacing="0" width="600" class="style-99000">
        ...
        <tr>
          <td bgcolor="#3b82f6" align="center" class="style-42381">
            ...
            <h1 class="h1-mobile" class="style-56865">Site Visit Confirmed</h1>
            <p class="style-9233">We look forward to meeting you</p>
          </td>
        </tr>
        <!-- Body -->
        <tr>
          <td class="px-mobile" class="style-68782">
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" class="style-74239">
              <tr>
                <td class="style-86314">
                  <strong class="style-92359">Visit Details</strong><br><br>
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" class="style-37025">
              <tr>
                <td class="style-90519">
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr>
                <td align="center" class="style-43583">
                  <a href="{{map_url}}" class="button-mobile" class="style-5019">View on Map</a>
                </td>
              </tr>
            </table>
            <p class="style-25661">
