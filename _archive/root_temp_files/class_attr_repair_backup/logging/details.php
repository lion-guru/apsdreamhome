            ...
            <div class="card border-0 shadow-sm mb-3">
                ...
                <div class="card-body aps-cp-card-body">
                    <div class="table-responsive"><table class="table table-sm table-borderless table-responsive">
                        <tr><td class="style-97126"><strong>Level</strong></td><td><span class="badge bg-<?= ($log['level'] ?? 'info') === 'error' ? 'danger' : (($log['level'] ?? 'info') === 'warning' ? 'warning' : 'info') ?>"><?= htmlspecialchars($log['level'] ?? 'info') ?></span></td></tr>
