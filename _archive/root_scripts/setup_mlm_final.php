...
try {
    ...
    $commissionLevels = [
        [$planId, 1, 'Associate', 10.00, 2, 10.00, 50000, 200000],
        [$planId, 2, 'Senior Associate', 12.00, 4, 12.00, 100000, 400000],
        [$planId, 3, 'Team Leader', 15.00, 6, 15.00, 200000, 800000],
        [$planId, 4, 'Senior Team Leader', 18.00, 8, 18.00, 350000, 1500000],
        [$planId, 5, 'Manager', 22.00, 10, 22.00, 500000, 2500000],
        [$planId, 6, 'Senior Manager', 25.00, 15, 25.00, 750000, 5000000],
        [$planId, 7, 'Director', 30.00, 20, 30.00, 1000000, 10000000]
    ];
