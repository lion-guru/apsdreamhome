<?php
/**
 * Marketplace Schema — Premium Packages + User Properties enhancements
...
$packages = [
    ...
    ['Premium Plus', 'premium_plus', 'Maximum visibility — 99acres Premium equivalent', 4999, 60, json_encode(['PREMIUM badge (gold)', '#1 position in search', 'Homepage featured slider', 'Push notification to buyers', 'Unlimited photos', 'Virtual tour link', 'Dedicated relationship manager', 'WhatsApp broadcast']), 'PREMIUM', '#f59e0b', 3],
];
