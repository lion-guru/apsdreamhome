...
// Check actual format
if (strpos($content, 'Front\\PageController@') !== false) {
    echo "Found with double backslash\n";
}
if (strpos($content, 'Front\PageController@') !== false) {
    echo "Found with single backslash\n";
}

// Count occurrences
echo 'PageController@ count: ' . substr_count($content, 'PageController@') . "\n";
