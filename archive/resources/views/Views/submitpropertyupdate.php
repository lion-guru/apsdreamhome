...
if(isset($_POST['add']))
{
	...
	$temp_name7 =$_FILES['fimage2']['tmp_name'];
	    ...
	    $uploadResult = handleFileUpload($_FILES['aimage'], ['jpg', 'jpeg', 'png'], 5242880);
    if (!$uploadResult['success']) {
        $msg = "<p class='alert alert-warning'>" . $uploadResult['error'] . "</p>";
        header("Location:feature.php?msg=$msg");
        exit();
    }
    $aimage = $uploadResult['filename'];
	    $uploadResult1 = handleFileUpload($_FILES['aimage1'], ['jpg', 'jpeg', 'png'], 5242880);
    if (!$uploadResult1['success']) {
        $msg = "<p class='alert alert-warning'>" . $uploadResult1['error'] . "</p>";
        header("Location:feature.php?msg=$msg");
        exit();
    }
    $aimage1 = $uploadResult1['filename'];
	    $uploadResult2 = handleFileUpload($_FILES['aimage2'], ['jpg', 'jpeg', 'png'], 5242880);
    if (!$uploadResult2['success']) {
        $msg = "<p class='alert alert-warning'>" . $uploadResult2['error'] . "</p>";
        header("Location:feature.php?msg=$msg");
        exit();
    }
    $aimage2 = $uploadResult2['filename'];
	    $uploadResult3 = handleFileUpload($_FILES['aimage3'], ['jpg', 'jpeg', 'png'], 5242880);
    if (!$uploadResult3['success']) {
        $msg = "<p class='alert alert-warning'>" . $uploadResult3['error'] . "</p>";
        header("Location:feature.php?msg=$msg");
        exit();
    }
    $aimage3 = $uploadResult3['filename'];
	    $uploadResult4 = handleFileUpload($_FILES['aimage4'], ['jpg', 'jpeg', 'png'], 5242880);
    if (!$uploadResult4['success']) {
        $msg = "<p class='alert alert-warning'>" . $uploadResult4['error'] . "</p>";
        header("Location:feature.php?msg=$msg");
        exit();
    }
    $aimage4 = $uploadResult4['filename'];
	
	    $uploadResult5 = handleFileUpload($_FILES['fimage'], ['jpg', 'jpeg', 'png'], 5242880);
    if (!$uploadResult5['success']) {
        $msg = "<p class='alert alert-warning'>" . $uploadResult5['error'] . "</p>";
        header("Location:feature.php?msg=$msg");
        exit();
    }
    $fimage = $uploadResult5['filename'];
	    $uploadResult6 = handleFileUpload($_FILES['fimage1'], ['jpg', 'jpeg', 'png'], 5242880);
    if (!$uploadResult6['success']) {
        $msg = "<p class='alert alert-warning'>" . $uploadResult6['error'] . "</p>";
        header("Location:feature.php?msg=$msg");
        exit();
    }
    $fimage1 = $uploadResult6['filename'];
	    $uploadResult7 = handleFileUpload($_FILES['fimage2'], ['jpg', 'jpeg', 'png'], 5242880);
    if (!$uploadResult7['success']) {
        $msg = "<p class='alert alert-warning'>" . $uploadResult7['error'] . "</p>";
        header("Location:feature.php?msg=$msg");
        exit();
    }
    $fimage2 = $uploadResult7['filename'];
	    $uploadResult8 = handleFileUpload($_FILES['fimage3'], ['jpg', 'jpeg', 'png'], 5242880);
    if (!$uploadResult8['success']) {
        $msg = "<p class='alert alert-warning'>" . $uploadResult8['error'] . "</p>";
        header("Location:feature.php?msg=$msg");
        exit();
    }
    $fimage3 = $uploadResult8['filename'];
...
<script src="<?php echo get_asset_url('js/tinymce/tinymce.min.js', 'js'); ?>"></script>
<script src="<?php echo get_asset_url('js/tinymce/init-tinymce.min.js', 'js'); ?>"></script>
<!--jQuery Layer Slider --> 
