      ...
      <div class="row">
        <div class="col-md-8">
          <ul class="top-contact list-text-white d-table">
            <li><a href="tel:7007444842"><i class="fas fa-phone-alt text-success mr-1"></i>7007444842</a></li>
            <li><a href="mailto:apsdreamhomes44@gmail.com"><i class="fas fa-envelope text-success mr-1"></i>apsdreamhomes44@gmail.com</a></li>
          </ul>
        </div>
      </div>
    </div>
                  ...
                  <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <li><a class="dropdown-item dropdown-toggle" href="#" id="navbarDropdownGorakhpur" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Gorakhpur</a>
                      <ul class="dropdown-menu" aria-labelledby="navbarDropdownGorakhpur">
                        ...
                        <li><a class="dropdown-item" href="gorakhpur-minua.php">Minua</a></li>
                        <li><a class="dropdown-item" href="gorakhpur-unaka.php">Unaka</a></li>
                        <li><a class="dropdown-item" href="gorakhpur-minuiwiti.php">Minuiwiti</a></li>
                        <li><a class="dropdown-item" href="gorakhpur-bohisawagar.php">Bohisawagar</a></li>
                        <li><a class="dropdown-item" href="gorakhpur-nayoga.php">Nayoga</a></li>
                        <li><a class="dropdown-item" href="gorakhpur-mother-managed.php">Mother Managed</a></li>
                        <li><a class="dropdown-item" href="gorakhpur-palebi.php">Palebi</a></li>
                        <li><a class="dropdown-item" href="gorakhpur-suryoha-kaloni.php">Suryoha Kaloni</a></li>
                        <li><a class="dropdown-item" href="gorakhpur-gora-purkisabi.php">Gora Purkisabi</a></li>
                        <li><a class="dropdown-item" href="gorakhpur-laknoki.php">Laknoki</a></li>
                      </ul>
                    </li>
