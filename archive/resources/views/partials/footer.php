...
// Laravel-style footer template - not referenced anywhere in codebase
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
                ...
                <form class="flex" method="POST" action="#">
                    ...
                    <button type="submit" class="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-r-md transition" aria-label="Subscribe">
...
<!-- Back to Top Button -->
<button id="back-to-top" class="fixed bottom-8 right-8 bg-indigo-600 text-white p-3 rounded-full shadow-lg opacity-0 invisible transition-all duration-300" aria-label="Back to top">
