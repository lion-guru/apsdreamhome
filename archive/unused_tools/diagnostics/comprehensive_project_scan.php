...
try {
    ...
    foreach ($core_files as $file => $description) {
        $path = 'c:\\xampp\\htdocs\\apsdreamhome/' . $file;
        if (file_exists($path)) {
...
try {
    ...
    $controllers_dir = 'c:\\xampp\\htdocs\\apsdreamhome' . '/app/controllers';
...
try {
    ...
    $models_dir = 'c:\\xampp\\htdocs\\apsdreamhome' . '/app/models';
...
try {
    ...
    $views_dir = 'c:\\xampp\\htdocs\\apsdreamhome' . '/app/views';
    if (is_dir($views_dir)) {
...
try {
    ...
    $env_file = 'c:\\xampp\\htdocs\\apsdreamhome' . '/.env';
...
try {
    ...
    $assets_dir = 'c:\\xampp\\htdocs\\apsdreamhome' . '/assets';
...
try {
    ...
    $api_dir = 'c:\\xampp\\htdocs\\apsdreamhome' . '/api';
    if (is_dir($api_dir)) {
...
try {
    ...
    $docs_dir = 'c:\\xampp\\htdocs\\apsdreamhome' . '/07_documentation';
    if (is_dir($docs_dir)) {
