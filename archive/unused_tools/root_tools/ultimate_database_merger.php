...
// Files to merge
$file1 = __DIR__ . '/DATABASE FILE/apsdreamhome.sql';      // Complete database (96 tables)
$file2 = __DIR__ . '/DATABASE FILE/apsdreamhome (2).sql';  // Recent updates (23 tables)
...
$backup_file = __DIR__ . '/DATABASE FILE/apsdreamhome_ultimate.sql';
