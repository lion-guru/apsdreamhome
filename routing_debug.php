...
listDirectoryContents($_SERVER['DOCUMENT_ROOT'] . '/apsdreamhomefinal/admin');

// .htaccess Diagnostic
coloredOutput("\n🔒 .htaccess Diagnostic:", 'green');
$htaccessPath = $_SERVER['DOCUMENT_ROOT'] . '/apsdreamhomefinal/admin/.htaccess';
...
$possibleRoutes = [
    '/admin/index.php',
    '/apsdreamhomefinal/admin/index.php',
    '/admin/login.php',
    '/apsdreamhomefinal/admin/login.php'
];
