...
foreach ($mainFiles as $file => $info) {
    ...
    echo "<p><strong>Import command:</strong> <code>mysql -u root -p apsdreamhomefinal < database/{$file}</code></p>";
    echo "</div>";
}
echo "</div>";
...
echo "<p><strong>Command:</strong> <code>mysql -u root -p apsdreamhomefinal < database/apsdreamhomes.sql</code></p>";

echo "<h4>🔧 If Database Has Issues:</h4>";
echo "<p><strong>Use:</strong> <code>database_fixes.sql</code> (Fix common problems)</p>";
echo "<p><strong>Command:</strong> <code>mysql -u root -p apsdreamhomefinal < database/database_fixes.sql</code></p>";

echo "<h4>🔧 If Need Sample Data:</h4>";
echo "<p><strong>Use:</strong> <code>insert_sample_data.sql</code> (Add test data)</p>";
echo "<p><strong>Command:</strong> <code>mysql -u root -p apsdreamhomefinal < database/insert_sample_data.sql</code></p>";
