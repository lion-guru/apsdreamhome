...
try {
    ...
    $pdo->exec("CREATE DATABASE IF NOT EXISTS apsdreamhomefinal CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci");
    echo "<div style='color: green; font-size: 16px;'>✅ Database 'apsdreamhomefinal' created/verified</div>";

    // Select the database
    $pdo->exec("USE apsdreamhomefinal");
    echo "<div style='color: green; font-size: 16px;'>✅ Using database 'apsdreamhomefinal'</div>";
