...
$responsiveHelperContent .= "    {\n";
$responsiveHelperContent .= "        \$baseUrl = '/apsdreamhome/public/assets/images';\n";
...
$responsiveHelperContent .= "        return '/apsdreamhome/public/assets/images/optimized/' . \$webpFilename;\n";
$responsiveHelperContent .= "    }\n";
$responsiveHelperContent .= "\n";
$responsiveHelperContent .= "    public static function getOptimizedUrl(\$filename)\n";
$responsiveHelperContent .= "    {\n";
$responsiveHelperContent .= "        return '/apsdreamhome/public/assets/images/optimized/' . \$filename;\n";
$responsiveHelperContent .= "    }\n";
$responsiveHelperContent .= "\n";
$responsiveHelperContent .= "    public static function getThumbnailUrl(\$filename)\n";
$responsiveHelperContent .= "    {\n";
$responsiveHelperContent .= "        return '/apsdreamhome/public/assets/images/thumbnails/' . \$filename;\n";
$responsiveHelperContent .= "    }\n";
$responsiveHelperContent .= "}\n";
