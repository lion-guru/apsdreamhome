...
function getGoogleLoginUrl($redirectUri = null) {
    ...
    $redirectUri = $redirectUri ?: (defined('GOOGLE_REDIRECT_URL') ? GOOGLE_REDIRECT_URL : 'http://localhost/apsdreamhomefinal/google_callback.php');
    $scope = 'email profile';
...
function getAssociateGoogleLoginUrl($redirectUri = null) {
    ...
    $defaultAssociateRedirect = (defined('GOOGLE_REDIRECT_URL') ? dirname(GOOGLE_REDIRECT_URL) . '/associate_google_callback.php' : 'http://localhost/apsdreamhomefinal/associate_google_callback.php');
