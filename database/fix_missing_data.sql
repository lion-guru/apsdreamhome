...
-- Add leads/inquiries if table is empty
...
(3, 3, 'referral', 'qualified', 'Referred by existing customer', NOW()),
(4, 4, 'direct', 'proposal', 'Direct inquiry at office', NOW()),
(5, 5, 'website', 'negotiation', 'Negotiating price', NOW()),
(6, 6, 'other', 'closed_won', 'Deal finalized', NOW()),
(7, 7, 'website', 'closed_lost', 'Chose competitor property', NOW()),
(8, 8, 'visit_schedule', 'new', 'Scheduled visit next week', NOW()),
(9, 9, 'referral', 'contacted', 'Following up on referral', NOW()),
(10, 10, 'direct', 'qualified', 'Qualified lead with budget approval', NOW());
