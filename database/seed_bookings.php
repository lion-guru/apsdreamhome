...
function getRandomPlotId($conn) {
    ...
    $conn->query("INSERT INTO projects (name, $cityField status) VALUES ('Sample Project', $cityValue 'active')");
    $projectId = $conn->insert_id;
    
    $conn->query("INSERT INTO plots (project_id, plot_no, size_sqft, status) VALUES ($projectId, 'A-101', 2000, 'available')");
