<?php
// generate_transactions_foreign_keys_migration.php
// Creates a safe migration to add FKs for transactions.customer_id and transactions.property_id
...
$specs = [
    [
        ...
        'ref_table' => 'customers',
        'ref_column' => 'id',
        'fk_name' => 'fk_transactions_customer_id',
        'index_name' => 'ix_transactions_customer_id',
        'on_delete' => 'CASCADE',
        'on_update' => 'CASCADE',
        'nullable' => true,
    ],
    [
        ...
        'ref_column' => 'id',
        'fk_name' => 'fk_transactions_property_id',
        'index_name' => 'ix_transactions_property_id',
        'on_delete' => 'SET NULL',
        'on_update' => 'CASCADE',
        'nullable' => true,
    ],
...
$outFile = $migrationDir . '/' . ($outArg ?: '010_add_transactions_foreign_keys.sql');

$sqlOut = [];
$sqlOut[] = sprintf('-- %s', basename($outFile));
$sqlOut[] = sprintf('-- Generated: %s', date('Y-m-d H:i:s'));
$sqlOut[] = '-- Add safe foreign keys for transactions relations';
$sqlOut[] = '';
