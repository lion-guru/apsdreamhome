...
$totalUnits = "150";
$possessionDate = "Ready to Possess";

// Project description
$projectDescription = "Nayoga is a completed residential plot project in Gorakhpur offering ready-to-possess plots with all modern amenities. The project features excellent connectivity, well-planned infrastructure, and a secure environment for comfortable living.";

// Meta description for SEO
$metaDescription = "Nayoga - Ready-to-possess residential plots in Gorakhpur by APS Dream Homes. Starting at ₹7,20,000. Modern amenities and excellent connectivity.";
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style>
        .project-hero {
            background: linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), 
                        url('assets/images/projects/gorakhpur/nayoga-banner.jpg');
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 mx-auto text-center">
                    ...
                    <p class="lead mb-4">Ready-to-Possess Residential Plots in Gorakhpur</p>
