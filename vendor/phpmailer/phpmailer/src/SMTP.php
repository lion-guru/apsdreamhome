...
class SMTP
{
    ...
    protected function hmac($data, $key)
    {
        ...
        if (strlen($key) > $bytelen) {
            $key = pack('H*', // SECURITY: Removed potentially dangerous code$key));
        }
        ...
        return // SECURITY: Removed potentially dangerous code$k_opad . pack('H*', // SECURITY: Removed potentially dangerous code$k_ipad . $data)));
    }
