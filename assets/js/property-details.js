...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadRecommendations(type) {
        ...
        fetch(`/apsdreamhomefinal/api/property_recommendations.php?${params}`)
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card property-card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <a href="/apsdreamhomefinal/property-details.php?id=${property.id}" 
    ...
    async function handleScheduleSubmit(e) {
        ...
        try {
            ...
            const response = await fetch('/apsdreamhomefinal/api/schedule_visit.php', {
                method: 'POST',
                body: formData
            });
