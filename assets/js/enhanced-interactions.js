...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (mobileNavToggler && navigation) {
    ...
    if (mobileMenuOverlay) {
      mobileMenuOverlay.addEventListener("click", function () {
        const bsCollapse = bootstrap.Collapse.getInstance(navigation);
        if (bsCollapse && navigation.classList.contains("show")) {
          bsCollapse.hide();
        }
      });
    }
    ...
    document.addEventListener("click", function (e) {
      if (
        ...
        !mobileNavToggler.contains(e.target)
      ) {
        const bsCollapse = bootstrap.Collapse.getInstance(navigation);
        if (bsCollapse && navigation.classList.contains("show")) {
          bsCollapse.hide();
  ...
  document.querySelectorAll(".property-card").forEach((card) => {
    card.addEventListener("click", function (e) {
      ...
      // Debug: console.log('Navigate to property details');
    });
  });
  ...
  document
    .querySelectorAll(
      ".property-card, .card, .hero-stats > *, .section-title, .section-subtitle",
    )
    .forEach((el) => {
      observer.observe(el);
    });
  ...
  // Debug: console.log('Enhanced UI Interactions loaded successfully! 🚀');
});
