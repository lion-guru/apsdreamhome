...
class PropertyAI {
  ...
  renderRecommendations(properties) {
    const container = this.recommendationSection.querySelector(
  ...
  displayPredictionResult(result) {
    if (!result || !result.predicted_price) {
      this.showError(
        "Could not generate prediction. Please try again.",
        this.predictionForm,
      );
      return;
    }
  ...
  toggleChat() {
    ...
    // Debug: console.log('AI Chat toggled');
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (
    document.querySelector(".ai-powered-search") ||
    document.getElementById("aiRecommendations") ||
    document.getElementById("pricePredictionBtn")
  ) {
