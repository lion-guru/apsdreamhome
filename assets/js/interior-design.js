...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const interiorDesignForm = document.getElementById('interiorDesignForm');
    if (interiorDesignForm) {
...
function initializeFormHandling() {
    const form = document.getElementById('interiorDesignForm');
    ...
    form.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            // Send data to API
            const response = await fetch('/api/interior-design/contact', {
                method: 'POST',
                headers: {
            ...
            Swal.fire({
                icon: 'success',
                title: 'Message Sent!',
                text: 'We will contact you shortly regarding your interior design project.',
...
function initializePortfolioLightbox() {
    const portfolioLinks = document.querySelectorAll('.portfolio-lightbox');
