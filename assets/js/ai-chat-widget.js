...
class AIChatWidget {
  ...
  constructor(config = {}) {
    ...
    this.config = {
      ...
      primaryColor: "#4f46e5",
      welcomeMessage:
        "Hello! I'm your AI assistant. How can I help you with your property search today?",
      ...config,
    };
  ...
  addMessage({ text, sender, timestamp }) {
    const messagesContainer =
      this.chatWindow.querySelector(".ai-chat-messages");
  ...
  showTypingIndicator(show) {
    const indicator = this.chatWindow.querySelector(
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (chatElement) {
    const config = {
      ...
      welcomeMessage:
        chatElement.dataset.welcomeMessage ||
