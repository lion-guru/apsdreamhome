...
const APSDreamHome = {
    ...
    if ("serviceWorker" in navigator) {
      window.addEventListener("load", () => {
        navigator.serviceWorker
          .register("/sw.js")
          .then((registration) => {
            // Debug: console.log('ServiceWorker registration successful with scope: ', registration.scope);
          })
          .catch((error) => {
  ...
  initScheduleVisitModal() {
    ...
    modal.addEventListener("show.bs.modal", (event) => {
      ...
      if (modalTitle)
        modalTitle.textContent = `Schedule Visit - ${propertyTitle}`;
  ...
  handleVisitForm(modal) {
    ...
    if (form.checkValidity()) {
      ...
      // Debug: console.log('Form submitted:', Object.fromEntries(formData));
