/**
 * Legal Services JavaScript - Updated to use shared utilities
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const legalServicesForm = document.getElementById('legalServicesForm');
    if (legalServicesForm) {
...
function initializeFormHandling() {
    const form = document.getElementById('legalServicesForm');
    ...
    form.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            // Send data to API
            const response = await fetch('/api/legal-services/contact', {
                method: 'POST',
                headers: {
            ...
            Swal.fire({
                icon: 'success',
                title: 'Message Sent!',
                text: 'We will contact you shortly regarding your legal inquiry.',
